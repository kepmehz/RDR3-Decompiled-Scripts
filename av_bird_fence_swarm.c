									...
									if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[iLocal_19 /*14*/]))
									{
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iLocal_19 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(Global_35))
										{
											if (*uParam0 == 80)
											{
												if (iLocal_19 < 7)
												{
													TASK::TASK_FLEE_COORD(uParam0->f_20[iLocal_19 /*14*/], uParam0->f_20[iLocal_19 /*14*/].f_5, 3, 256, -1082130432 /* Float: -1f */, -1, 0);
													PED::SET_PED_KEEP_TASK(uParam0->f_20[iLocal_19 /*14*/], true);
												}
												else if (iLocal_19 < 14)
												{
													TASK::OPEN_SEQUENCE_TASK(&iVar3);
													TASK::TASK_FLEE_COORD(0, uParam0->f_20[iLocal_19 /*14*/].f_5, 3, 256, -1082130432 /* Float: -1f */, -1, 0);
