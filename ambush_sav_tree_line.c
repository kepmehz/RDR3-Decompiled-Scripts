	...
	while (iVar0 < uLocal_15.f_216)
	{
		if (!func_131(&uLocal_15, iVar0, 16))
		{
			if (func_61(uLocal_15.f_40[iVar0], 0, 0))
			{
				if (func_187(iVar0))
				{
					TASK::TASK_FLEE_COORD(uLocal_15.f_40[iVar0], uLocal_15.f_209, 4, 0, -1082130432 /* Float: -1f */, -1, 0);
			...
			else
			{
				if (func_61(uLocal_15[iVar0], 0, 0))
				{
					...
					else if ((uLocal_15.f_215 == uLocal_15.f_216 && func_61(uLocal_15.f_40[iVar0], 0, 1)) && !PED::IS_PED_IN_ANY_VEHICLE(uLocal_15[iVar0], true))
					{
						...
						TASK::TASK_MOUNT_ANIMAL(0, uLocal_15.f_40[iVar0], 20000, -1, 1073741824 /* Float: 2f */, 1, 0, 0);
...
bool func_138()
{
	if (VOLUME::DOES_VOLUME_EXIST(Local_274.f_30[2]))
	{
...
void func_161()
{
	...
	if (VOLUME::IS_POINT_IN_VOLUME(Local_274.f_30[4], Global_36))
	{
		return;
	}
	iVar0 = 0;
...
bool func_169()
{
	...
	if (WEAPON::IS_PED_CARRYING_WEAPON(uLocal_15[Local_274.f_41], joaat("WEAPON_MELEE_KNIFE")))
	{
		iVar0 = joaat("WEAPON_MELEE_KNIFE");
	}
	else if (WEAPON::IS_PED_CARRYING_WEAPON(uLocal_15[Local_274.f_41], joaat("WEAPON_MELEE_HATCHET_MELEEONLY")))
	{
		...
		else
		{
			...
			else
			{
				...
				if (func_61(uParam0->f_40[iVar0], 0, 0))
				{
					...
					TASK::TASK_MOVE_IN_TRAFFIC_TO_DESTINATION(0, func_357(iParam1, 1), 40f, fParam2, 0, 0);
				}
				else if (iVar5 == 0)
				{
					if (!func_69(vVar7))
					...
					TASK::TASK_MOVE_IN_TRAFFIC_TO_DESTINATION(0, func_357(iParam1, 1), 40f, fParam2, 128, 0);
				}
				else if (PED::GET_SEAT_PED_IS_USING((*uParam0)[iVar0]) == -1)
				{
					...
					TASK::TASK_MOVE_IN_TRAFFIC_TO_DESTINATION(0, func_357(iParam1, 1), 40f, -1f, 0, 0);
				}
...
void func_383(var uParam0, var uParam1)
{
	...
	if (func_133(uParam1, 1))
	{
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(uParam1->f_30[3], -1542.637f, -1218.391f, 81.70453f, 0f, 0f, 0f, 81.558f, 50f, 20f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(uParam1->f_30[3], -1549.831f, -1192.118f, 81.70453f, 0f, 0f, 30f, 81.558f, 50f, 20f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(uParam1->f_30[3], -1548.659f, -1234.064f, 81.70453f, 0f, 0f, -43f, 81.558f, 50f, 20f);
		uParam1->f_30[1] = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("volKill");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(uParam1->f_30[1], -1573.147f, -1374.548f, 76.45531f, 0f, 0f, -93.5179f, 240f, 85.22054f, 100f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(uParam1->f_30[1], -1534.233f, -1054.369f, 61.73892f, 0f, 0f, -90.04591f, 240f, 30f, 100f);
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(uParam0->f_182[0], -1482.383f, -1228.075f, 80.66719f, 0f, 0f, -29.34534f, 50f, 42.33862f, 20f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(uParam0->f_182[0], -1521.568f, -1217.329f, 80.66719f, 0f, 0f, -7.414361f, 98.46413f, 58.40728f, 20f);
	...
	else if (func_133(uParam1, 2))
	{
		...
		uParam1->f_30[1] = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("volKill");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(uParam1->f_30[1], -1474.001f, -1324.089f, 76.45531f, 0f, 0f, -65.87521f, 240f, 159.1742f, 100f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(uParam1->f_30[1], -1584.504f, -1064.411f, 61.73892f, 0f, 0f, -72.43196f, 240f, 152.7547f, 100f);
		...
		uParam0->f_182[0] = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("volSlow");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(uParam0->f_182[0], -1612.589f, -1218.997f, 76.56673f, 0f, 0f, 179.5794f, 74.07483f, 88.18665f, 20f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(uParam0->f_182[0], -1565.211f, -1214.525f, 80.66719f, 0f, 0f, -178.4896f, 98.46413f, 58.40728f, 20f);
...
struct<4> func_466(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_556(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_570(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_382(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
int func_726(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	Var16.f_11 = iParam8;
	Var16.f_10 = bParam10;
	iVar33 = func_740(1168099063, &Var16, bParam9);
	if (iVar33 == -1)
	{
		return -1;
	}
...
int func_728(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	...
	if (bParam9)
	{
		...
		{
			if (func_741(iVar62, 1168099063, &Var28) && func_741(iVar62, 1168099063, &Var45))
			{
	...
	{
		iVar62 = func_740(1168099063, &Var28, 0);
		iVar62 = func_740(1168099063, &Var45, 0);
	}
	return iVar62;
}
...
int func_737(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	{
		Var45 = { func_747(Param0, 1) };
		Var45.f_10 = iParam4;
		iVar0 = func_748(joaat("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var63 = { func_739(&Var1) };
		Var63.f_10 = iParam4;
		iVar0 = func_740(joaat("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
struct<17> func_739(var uParam0)
{
	struct<17> Var0;
...
struct<29> func_745(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<29> Var0;
	struct<29> Var29;
	...
	Var29.f_9 = -1591664384;
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_556(bParam4), &uParam0, &Var29, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_739(&Var29) };
...
struct<18> func_747(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<18> Var0;
	struct<15> Var18;
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_556(bParam4), &uParam0, &Var18, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_739(&Var18) };
