...
bool func_93(var uParam0)
{
	...
	if (!bLocal_62)
	{
		...
		{
			iLocal_67 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_HUMAN_STAND_WAITING"), -145.589f, -32.978f, 94.615f, 30.935f, 0, 0, 0);
	...
	if (!bLocal_63)
	{
		...
		{
			iLocal_68 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_HUMAN_DRINKING"), -141.786f, -30.653f, 94.884f, 64.46f, 0, 0, 0);
