	...
	if (iLocal_145 < 13)
	{
		if (!func_47(Local_65[iLocal_145 /*6*/]))
		{
			...
			if (func_8(Local_65[iLocal_145 /*6*/].f_5, 0))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(Local_65[iLocal_145 /*6*/].f_5, joaat("WEAPON_REPEATER_CARBINE"), 100, true, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
...
bool func_23()
{
	...
	if (iLocal_145 < 3)
	{
		...
		else if ((iLocal_145 % 3) == 0)
		{
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(Local_44[iLocal_144 /*5*/][iLocal_145], joaat("WEAPON_MELEE_TORCH"), 100, true, false, 1, false, 0.5f, 1f, 752097756, false, 0f, false);
			}
		}
		else
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_44[iLocal_144 /*5*/][iLocal_145], joaat("WEAPON_REPEATER_CARBINE"), 100, true, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
		}
		iLocal_145++;
	}
	else
...
void func_69(int iParam0)
{
	...
	WEAPON::GIVE_WEAPON_TO_PED(iParam0, joaat("GROUP_REVOLVER"), 100, true, false, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
	WEAPON::GIVE_WEAPON_TO_PED(iParam0, joaat("GROUP_SNIPER"), 100, false, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
}
