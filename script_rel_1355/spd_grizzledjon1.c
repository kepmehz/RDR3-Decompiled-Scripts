		...
		if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_277))
		{
			switch (iLocal_176)
			{
				...
				case 0:
					if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_277))
					{
						iLocal_277 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("SPECIAL_PED_GJ02_STAND_BAR_DRINKING"), -313.1921f, 809.0455f, 117.978f, -170f, 0, 0, 1);
						TASK::_SET_SCENARIO_POINT_FLAG(iLocal_277, 16, true);
						TASK::_SET_SCENARIO_POINT_FLAG(iLocal_277, 18, true);
						bVar0 = true;
					}
...
void func_25()
{
	...
	if (!func_8(iLocal_182, 131072))
	{
		...
		iLocal_278 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_HUMAN_DRUNK_PASSED_OUT_FLOOR"), -316.4402f, 805.7891f, 116.855f, -170f, 0, 0, 0);
