	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], uLocal_15[0], 0, 0, false, true, 0, false, -1f, false);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[1 /*14*/], uLocal_15[1], 0, 0, false, true, 0, false, -1f, false);
...
int func_32(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_19)
	{
		if (TASK::DOES_SCENARIO_POINT_EXIST(uLocal_15[iVar0]))
		{
