...
void func_297()
{
	...
	while (iVar5 <= 4)
	{
		...
		PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_15[iVar5], vVar1, 3f, 1, false, 0);
		TASK::OPEN_SEQUENCE_TASK(&iVar0);
		TASK::TASK_COMBAT_PED(0, Global_35, 33554432, 0);
...
struct<17> func_732(var uParam0)
{
	struct<17> Var0;
...
struct<29> func_738(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<29> Var0;
	struct<29> Var29;
...
struct<18> func_740(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<18> Var0;
	struct<15> Var18;
