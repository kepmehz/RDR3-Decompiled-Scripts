...
void func_137(int iParam0, char* sParam1)
{
	...
	func_268(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_267(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
int func_267(int iParam0)
{
	...
	if (!func_402(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
{
	if (func_414(iParam0, joaat("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
