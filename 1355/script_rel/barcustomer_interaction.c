...
void func_6()
{
	...
	switch (iLocal_16)
	{
		case 0:
			...
			iLocal_29 = TASK::CREATE_SCENARIO_POINT_HASH(iVar4, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(TASK::_GET_SCENARIO_POINT_COORDS(iLocal_3, true), fVar5, func_21()), (fVar5 - 180f), 0, 0, 0);
