...
struct<4> func_221(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_231(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_228(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	Var16.f_11 = iParam8;
	Var16.f_10 = bParam10;
	iVar33 = func_256(1168099063, &Var16, bParam9);
	if (iVar33 == -1)
	{
		return -1;
	}
...
int func_232(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	...
	if (bParam9)
	{
		...
		{
			if (func_257(iVar62, 1168099063, &Var28) && func_257(iVar62, 1168099063, &Var45))
			{
	...
	{
		iVar62 = func_256(1168099063, &Var28, 0);
		iVar62 = func_256(1168099063, &Var45, 0);
	}
	return iVar62;
}
...
int func_251(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	iVar15 = func_263(Var1.f_4);
	if (iVar15 == joaat("HORSE"))
	{
		Var16 = { func_264(Param0, 1) };
		Var16.f_10 = iParam4;
		iVar0 = func_265(joaat("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		Var45 = { func_266(Param0, 1) };
		Var45.f_10 = iParam4;
		iVar0 = func_267(joaat("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var63 = { func_255(&Var1) };
		Var63.f_10 = iParam4;
		iVar0 = func_256(joaat("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
struct<17> func_255(var uParam0)
{
	struct<17> Var0;
...
struct<29> func_264(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<29> Var0;
	struct<29> Var29;
	...
	Var29.f_9 = -1591664384;
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_231(bParam4), &uParam0, &Var29, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_255(&Var29) };
...
struct<18> func_266(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<18> Var0;
	struct<15> Var18;
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_231(bParam4), &uParam0, &Var18, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_255(&Var18) };
...
bool func_269(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_273(&(Global_1109400.f_4), iVar0, 5);
	}
	if (iParam1 == func_274())
	{
		return func_273(&(Global_1109400.f_4), iVar0, 5);
	...
	{
		return func_273(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
