	...
	switch (iLocal_11)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
			{
				...
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[2 /*14*/], uLocal_12[2], 0, 0, false, true, 0, false, -1f, false);
...
bool func_73(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			if (PED::IS_PED_USING_THIS_SCENARIO(uParam0->f_20[iVar0 /*14*/], uLocal_12[iVar0]))
			{
				return false;
			}
		}
