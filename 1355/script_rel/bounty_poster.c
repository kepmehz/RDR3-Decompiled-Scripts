	...
	if (func_143(uParam0))
	{
		if (func_144(uParam0, uParam1))
		{
			if (!TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_9))
			{
				...
				if (*uParam1 == 12)
				{
					uParam0->f_9 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_HUMAN_SHOPKEEPER"), 2510.472f, -1308.54f, 47.954f, 275.9725f, 0, 0, 1);
				}
				...
				{
					uParam0->f_9 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("SC_BOUNTY_HUNTER_SHERIFF"), func_147(), func_148(), 0, 0, 0);
				}
...
bool func_165(var uParam0, var uParam1)
{
	...
	if (!TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_9))
	{
		...
		uParam0->f_9 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_HUMAN_SHOPKEEPER"), TASK::_GET_SCENARIO_POINT_COORDS(iVar0, true), TASK::_GET_SCENARIO_POINT_HEADING(iVar0, true), 0, -1f, 0);
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(uParam0->f_6, false, true);
	}
	if (TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_9))
	{
...
int func_201(int iParam0, bool bParam1)
{
	...
	if (!func_299(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_300(iVar14);
