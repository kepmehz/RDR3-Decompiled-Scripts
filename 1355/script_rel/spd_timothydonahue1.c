...
void func_304(int iParam0, char* sParam1)
{
	...
	func_394(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_508(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
int func_460()
{
	...
	while (iVar1 < 30)
	{
		if (func_674(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_508(int iParam0)
{
	...
	if (!func_728(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
{
	return func_433(joaat("CHARACTER"), func_773(), -1591664384, bParam0);
}
...
{
	if (func_774(iParam0, joaat("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
void func_837(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_210(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_761(iParam1))
		{
			...
			iParam1->f_6 = func_892(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_210(iParam1->f_6))
			{
				if (!bParam6)
				{
