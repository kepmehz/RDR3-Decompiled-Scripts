		...
		if (uParam0->f_4 == 2)
		{
			...
			while (iVar6 <= 4)
			{
				if (!ENTITY::IS_ENTITY_DEAD(uLocal_66[iVar6]))
				{
					...
					TASK::_MAKE_OBJECT_CARRIABLE(uLocal_66[iVar6]);
				}
				iVar6++;
			}
		}
	...
	else if (*uParam0 == -1061274876)
	{
		...
		while (iVar7 <= 4)
		{
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_66[iVar7]))
			{
				...
				TASK::_MAKE_OBJECT_CARRIABLE(uLocal_66[iVar7]);
			}
			iVar7++;
		}
	}
...
{
	return TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(iParam0, iParam1, vParam2, iParam5, iParam6, iParam7, iParam8);
}
...
int func_231(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_404(32768) && iParam1 != Global_1946054.f_57[func_400(iParam3, 1) /*11*/])
			{
				func_405();
...
bool func_265(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar39 < iVar19)
	{
		...
		{
			if (!func_410(&Var20, iVar39, iVar18, iVar19))
			{
			}
			else
			{
				Var34.f_4 = Var20.f_9;
				Var34 = { Var20.f_5 };
				if (func_359(iParam0, &Var20, &Var34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
bool func_320(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5, int iParam8, int iParam9, int iParam10)
{
...
struct<5> /*40*/ func_326(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_198(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_356(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_356(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_357(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
bool func_330(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_322(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_357(iParam0, &Var4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_473(iParam0, 1))
			{
				if (!func_356(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_357(iParam0, &Var4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
int func_381()
{
	...
	while (iVar1 < 30)
	{
		if (func_537(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_401(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_199(iParam0, 866047851) && func_530(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_404(32768) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
...
struct<4> /*32*/ func_438(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_358(923904168, func_472(bParam0), -740156546, 0) };
		}
...
{
	return func_358(joaat("CHARACTER"), func_593(), -1591664384, bParam0);
}
...
struct<4> /*32*/ func_474(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_358(271701509, func_472(bParam0), 12999093, 0) };
		}
...
int func_496()
{
	...
	while (iVar1 < 30)
	{
		if (func_606(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_530(var uParam0)
{
	...
	iVar0 = 0;
	iVar1 = 22;
	if (uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/] && func_199(uParam0->f_1[iVar1 /*3*/], 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_533(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_203(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
