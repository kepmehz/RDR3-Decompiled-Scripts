		...
		if (!func_5(iLocal_272, 1) && iLocal_14 > 2)
		{
			...
			else
			{
				...
				if (!func_5(iLocal_272, 1))
				{
					...
					else if (ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_260, true, 0) && iLocal_14 < 80)
					{
...
void func_1()
{
	...
	{
		func_177(&iLocal_306, bLocal_262, 0);
...
bool func_181(bool bParam0, bool bParam1, var uParam2, int iParam3, int iParam4, float fParam5)
{
	int iVar0;
...
bool func_321(var uParam0, vector3 vParam1, bool bParam4)
{
...
bool func_322(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_409(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_179(bVar0, bParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
