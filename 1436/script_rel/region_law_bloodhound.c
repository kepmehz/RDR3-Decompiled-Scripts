...
void func_4()
{
	...
	switch (iLocal_73)
	{
		...
		case 2:
			...
			if ((STREAMING::HAS_MODEL_LOADED(bLocal_74) && STREAMING::HAS_MODEL_LOADED(bLocal_75)) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
			{
				iLocal_73 = 4;
			}
			break;
...
void func_17(int iParam0)
{
	...
	{
		Local_41[iParam0 /*10*/].f_8 = MAP::_BLIP_ADD_FOR_VOLUME(-1282792512, Local_41[iParam0 /*10*/].f_9);
	}
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (func_5(Local_41[iParam0 /*10*/].f_1[iVar0], 0))
		{
			...
			func_6(Local_41[iParam0 /*10*/].f_1[iVar0]);
			TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(Local_41[iParam0 /*10*/].f_1[iVar0], Local_41[iParam0 /*10*/].f_6, vVar1, 2f, -1, 1036831949 /* Float: 0.1f */, 1, 1, 0, 0, 1, 0);
		}
		iVar0++;
	}
}
