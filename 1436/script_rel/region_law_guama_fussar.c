#region Local Variables
	...
	bool bLocal_123[10] = { false, false, false, false, false, false, false, false, false, false };
	int iLocal_134 = 0;
	int iLocal_135 = 0;
	int iLocal_136 = 0;
	int iLocal_137 = 0;
...
void func_2(bool bParam0)
{
	...
	iVar0 = 0;
	while (iVar0 < bLocal_123)
	{
		if (bParam0)
		{
			func_26(&(bLocal_123[iVar0]));
		}
		else
		{
			func_27(&(bLocal_123[iVar0]), 1, 0, 1);
		}
		bLocal_123[iVar0] = 0;
		iVar0++;
	}
...
int func_4()
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			while (iVar0 < bLocal_123)
			{
				if (func_30(bLocal_123[iVar0], 0) && func_31(Global_35, bLocal_123[iVar0], 1, 1) < 120f)
				{
					func_27(&(bLocal_123[iVar0]), 1, 0, 1);
				}
				else
...
void func_10()
{
	...
	while (iVar0 < bLocal_123)
	{
		...
		{
			if (Local_140[iVar2 /*15*/].f_1 != 0 && Local_140[iVar2 /*15*/].f_1 == bLocal_123[iVar0])
			{
				iVar1 = iVar2;
			}
			iVar2++;
		}
		if (!ENTITY::DOES_ENTITY_EXIST(bLocal_123[iVar0]))
		{
			if (iVar1 != -1)
			{
		...
		else if (ENTITY::DOES_ENTITY_EXIST(bLocal_123[iVar0]) && PED::IS_PED_INJURED(bLocal_123[iVar0]))
		{
			if (iVar1 != -1)
			{
				Local_140[iVar1 /*15*/].f_1 = 0;
		...
		else if (func_31(Global_35, bLocal_123[iVar0], 1, 1) > 200f)
		{
			if (iVar1 != -1)
			{
				Local_140[iVar1 /*15*/].f_1 = 0;
		...
		if (!func_30(bLocal_123[iVar0], 0))
		{
			switch (iLocal_90)
			{
				case 1:
					...
					while (iVar4 < Local_140)
					{
						if (!MISC::IS_STRING_NULL_OR_EMPTY(Local_140[iVar4 /*15*/]) && func_38(&(Local_140[iVar4 /*15*/])))
						{
							...
							{
								bLocal_123[iVar0] = func_40(joaat("S_M_M_FUSSARHENCHMAN_01"), vVar1, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
								if (ENTITY::DOES_ENTITY_EXIST(bLocal_123[iVar0]))
								{
									func_41(bLocal_123[iVar0]);
									PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_123[iVar0], 27, true);
									PED::_0x712B2C2B2471B493(bLocal_123[iVar0], joaat("DISABLED"));
									PED::SET_PED_ID_RANGE(bLocal_123[iVar0], (PED::_GET_PED_ID_RANGE(bLocal_123[iVar0]) + 20f));
									TASK::TASK_POLICE(bLocal_123[iVar0], true);
									TASK::_TASK_PATROL_2(bLocal_123[iVar0], Local_140[iVar4 /*15*/], 1, vVar1, 0, 1);
								}
								iLocal_134++;
								Local_140[iVar4 /*15*/].f_1 = bLocal_123[iVar0];
								return -1;
							}
						}
						iVar4++;
				...
				case 2:
					...
					{
						bLocal_123[iVar0] = func_40(joaat("S_M_M_FUSSARHENCHMAN_01"), vLocal_92[iVar0 /*3*/], 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
						func_41(bLocal_123[iVar0]);
						PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_123[iVar0], 27, true);
						PED::_0x712B2C2B2471B493(bLocal_123[iVar0], joaat("DISABLED"));
						iLocal_134++;
...
int func_14()
{
	...
	iVar1 = 0;
	iVar2 = 0;
	while (iVar2 < bLocal_123)
	{
		if (func_30(bLocal_123[iVar2], 0))
		{
			switch (iLocal_90)
			{
				case 1:
					func_42(&Local_140, bLocal_123[iVar2]);
					break;
				case 2:
					...
					{
						if ((!func_43(bLocal_123[iVar2], 242628503) && !func_43(bLocal_123[iVar2], 780511057)) && !func_43(bLocal_123[iVar2], joaat("SCRIPT_TASK_POLICE")))
						{
							vVar6 = { func_44(vVar3, 15f, 10f) };
							TASK::CLEAR_SEQUENCE_TASK(&iVar0);
							TASK::OPEN_SEQUENCE_TASK(&iVar0);
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar6, 3f, 20000, 0.25f, 7602180, 40000f);
							TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, Global_35, Global_35, 1f, 1, 10f, 4f, 1, 0, joaat("FIRING_PATTERN_BURST_FIRE"), 7602180);
							TASK::CLOSE_SEQUENCE_TASK(iVar0);
							TASK::TASK_POLICE(bLocal_123[iVar2], true);
							TASK::TASK_PERFORM_SEQUENCE(bLocal_123[iVar2], iVar0);
						}
					}
					else if (!func_43(bLocal_123[iVar2], 780511057) && !func_43(bLocal_123[iVar2], joaat("SCRIPT_TASK_POLICE")))
					{
						TASK::TASK_POLICE(bLocal_123[iVar2], true);
						TASK::TASK_COMBAT_PED(bLocal_123[iVar2], Global_35, 0, 0);
					}
					break;
			}
		}
...
void func_41(bool bParam0)
{
	...
	WEAPON::GIVE_WEAPON_TO_PED(bParam0, joaat("GROUP_REVOLVER"), 100, true, false, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
	WEAPON::GIVE_WEAPON_TO_PED(bParam0, joaat("GROUP_SNIPER"), 100, false, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
}
