...
int func_31(var uParam0)
{
	...
	if (!bLocal_43)
	{
		if (func_61(uParam0, &uLocal_15, 0))
		{
			...
			{
				TASK::TASK_FLEE_PED(uParam0->f_20[1 /*14*/], Global_35, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
			}
			if (!bLocal_44)
			{
...
int func_64(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_108(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
struct<5> /*40*/ func_179(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_189(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_181(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_181(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_182(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_183(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_255(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_217(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_74(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
struct<4> /*32*/ func_247(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_183(923904168, func_246(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_183(923904168, func_246(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_249(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_183(271701509, func_246(bParam0), 12999093, 0) };
		}
...
int func_263(int iParam0, bool bParam1)
{
	...
	if (!func_281(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_262(iVar18);
