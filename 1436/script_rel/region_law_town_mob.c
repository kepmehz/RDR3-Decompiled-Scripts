#region Local Variables
	...
	int iLocal_45 = 0;
	bool bLocal_46[9] = { false, false, false, false, false, false, false, false, false };
...
void func_1()
{
	...
	iVar1 = 0;
	while (iVar1 < bLocal_46)
	{
		if (func_6(bLocal_46[iVar1], 0))
		{
			if (!bVar0)
			{
				if (iVar1 == 0)
				{
					PED::SET_PED_CONFIG_FLAG(bLocal_46[iVar1], 155, false);
				}
				else
				{
					PED::SET_PED_CONFIG_FLAG(bLocal_46[iVar1], 156, false);
				}
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_46[iVar1], joaat("REL_CIVMALE"));
			}
			func_7(&(bLocal_46[iVar1]), 1, 0, 1);
		}
		iVar1++;
	}
...
void func_2()
{
	...
	switch (iLocal_41)
	{
		case 76:
			...
			VOLUME::_0x6E0D3C3F828DA773(bLocal_56, iVar0);
			VOLUME::_0x6E0D3C3F828DA773(bLocal_56, iVar1);
			break;
		case 26:
...
void func_4()
{
	...
	switch (iLocal_42)
	{
		...
		case 2:
			...
			if ((STREAMING::HAS_MODEL_LOADED(bLocal_44) && STREAMING::HAS_MODEL_LOADED(bLocal_43)) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
			{
				iLocal_42 = 4;
			}
			break;
		...
		case 5:
			...
			fVar0 = 150f;
			iVar3 = 0;
			while (iVar3 < bLocal_46)
			{
				if (func_6(bLocal_46[iVar3], 0))
				{
					iVar2++;
					fVar1 = func_14(bLocal_46[iVar3], Global_36, 1);
					if (fVar1 < fVar0)
					{
						fVar0 = fVar1;
					}
		...
		case 6:
			iVar4 = 0;
			while (iVar4 < bLocal_46)
			{
				if (func_6(bLocal_46[iVar4], 0))
				{
					func_7(&(bLocal_46[iVar4]), 1, 1, 1);
				}
				iVar4++;
			}
			LAW::_0x7EF2A2FE38D74456(func_19(1), 0);
...
void func_17()
{
	...
	iVar0 = 0;
	while (iVar0 < bLocal_46)
	{
		vVar1 = { func_29(vLocal_63, 3f, 1f) };
		if (iVar0 == 0)
		{
			bLocal_46[iVar0] = func_30(bLocal_43, vVar1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 180f), 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_46[iVar0], 1, false);
			PED::SET_COMBAT_FLOAT(bLocal_46[iVar0], 48, 8f);
			if (UNLOCK::UNLOCK_IS_UNLOCKED(joaat("WEAPON_SHOTGUN_DOUBLEBARREL")))
			{
				WEAPON::GIVE_WEAPON_TO_PED(bLocal_46[iVar0], joaat("WEAPON_SHOTGUN_DOUBLEBARREL"), 999, true, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
			}
			else
			{
				WEAPON::GIVE_WEAPON_TO_PED(bLocal_46[iVar0], joaat("WEAPON_REPEATER_CARBINE"), 999, true, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
			}
		}
		else
		{
			bLocal_46[iVar0] = func_30(bLocal_44, vVar1, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 180f), 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			if (func_6(bLocal_46[iVar0], 0))
			{
				if ((iVar0 % 4) == 0 && (func_32(func_31()) >= 22 || func_32(func_31()) <= 4))
				{
					WEAPON::GIVE_WEAPON_TO_PED(bLocal_46[iVar0], joaat("WEAPON_REVOLVER_CATTLEMAN"), 999, true, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
					WEAPON::GIVE_WEAPON_TO_PED(bLocal_46[iVar0], joaat("WEAPON_MELEE_TORCH"), 999, true, false, 1, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
				}
				else
				{
					WEAPON::GIVE_WEAPON_TO_PED(bLocal_46[iVar0], joaat("WEAPON_REPEATER_CARBINE"), 999, true, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
		...
		if (func_6(bLocal_46[iVar0], 0))
		{
			PED::SET_PED_DEFENSIVE_AREA_VOLUME(bLocal_46[iVar0], bLocal_56, 0, false, 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_46[iVar0], 0, true);
			PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_46[iVar0], 58, true);
			PED::_0x815C0074A1BC0D93(bLocal_46[iVar0], 0);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_46[iVar0], joaat("REL_TOWN_MOB"));
			PED::REGISTER_TARGET(bLocal_46[iVar0], Global_35, 1);
			PED::SET_PED_ACCURACY(bLocal_46[iVar0], 60);
			PED::SET_PED_CONFIG_FLAG(bLocal_46[iVar0], 279, true);
			if (iVar0 == 0)
			{
				PED::SET_PED_AS_GROUP_LEADER(bLocal_46[iVar0], iLocal_45, false);
				PED::SET_PED_CONFIG_FLAG(bLocal_46[iVar0], 155, true);
				COMPANION::_0xCBD9EC60495C728C(iLocal_45);
				COMPANION::_0x0F1CD8CA9E65D5F6(iLocal_45, joaat("CA_SEARCH"));
			}
			else
			{
				PED::SET_PED_AS_GROUP_MEMBER(bLocal_46[iVar0], iLocal_45);
				PED::SET_PED_CONFIG_FLAG(bLocal_46[iVar0], 156, true);
				PED::SET_PED_CONFIG_FLAG(bLocal_46[iVar0], 152, true);
			}
			iVar4 = MAP::BLIP_ADD_FOR_ENTITY(joaat("BLIP_STYLE_ENEMY"), bLocal_46[iVar0]);
			MAP::BLIP_ADD_MODIFIER(iVar4, joaat("BLIP_MODIFIER_ENEMY_DISAPPEARING"));
			MAP::BLIP_ADD_MODIFIER(iVar4, 1086257954);
			PED::_0x1E017404784AA6A3(bLocal_46[iVar0], joaat("TOWN_MOB"));
			PED::SET_PED_COMBAT_MOVEMENT(bLocal_46[iVar0], 2);
			PED::SET_PED_COMBAT_RANGE(bLocal_46[iVar0], 1);
			PED::_0x9238A3D970BBB0A9(bLocal_46[iVar0], 2018638702);
			iVar5 = 0;
			func_33(&iVar5, 15);
			func_33(&iVar5, 16);
			COMPANION::_0xDEB369F6AD168C58(bLocal_46[iVar0], iVar5);
		}
		iVar0++;
	}
}
...
void func_20(int iParam0)
{
	...
	TASK::TASK_SMART_FLEE_PED(iParam0, Global_35, 500f, -1, 0, 3f, false);
	func_35(iParam0);
...
bool func_26(int iParam0, var uParam1, bool bParam2)
{
	vector3 vVar0[4];
	bool bVar13;
	float fVar14;
