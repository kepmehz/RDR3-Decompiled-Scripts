...
bool func_27(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_43(iParam0) == joaat("EMOTE"))
	{
		...
		Var0.f_1 = iParam0;
		Var0.f_2 = 0;
		Var0 = func_99(Global_1058888.f_49051.f_4.f_31);
		Var10 = { Var0 };
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_223(32768) && iParam1 != Global_1946054.f_57[func_231(iParam3, 1) /*11*/])
			{
				func_224();
...
int func_139(int iParam0, bool bParam1)
{
	...
	if (!func_339(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_138(iVar18);
...
struct<5> /*40*/ func_160(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_43(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_348(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_348(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_349(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
bool func_166(var uParam0, bool bParam1, bool bParam2, int iParam3)
{
	func_368(bParam1);
	if (!uParam0->f_1)
	{
...
bool func_232(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_91(iParam0, 866047851) && func_427(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_223(32768) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
	...
	if (!bParam17)
	{
		if (Param0.f_15)
		{
			if (bParam18)
			{
				...
				func_442(&(Global_1058888.f_43130), Var0);
				return;
			}
		}
	}
...
bool func_255(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar39 < iVar19)
	{
		...
		{
			if (!func_136(&Var20, iVar39, iVar18, iVar19))
			{
			}
			else
			{
				Var34.f_4 = Var20.f_9;
				Var34 = { Var20.f_5 };
				if (func_163(iParam0, &Var20, &Var34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
struct<4> /*32*/ func_337(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_162(923904168, func_346(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_350(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_162(271701509, func_346(bParam0), 12999093, 0) };
		}
...
bool func_398(bool bParam0)
{
	...
	if (func_598(Global_35, bParam0, 0, 1) < 2f && PED::IS_ANIMAL_INTERACTION_POSSIBLE(Global_35, bParam0))
	{
		return true;
	}
	return false;
...
int func_427(var uParam0)
{
	...
	iVar0 = 0;
	iVar1 = 22;
	if (uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/] && func_91(uParam0->f_1[iVar1 /*3*/], 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_613(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_100(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
bool func_464(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_457(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_349(iParam0, &Var4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_347(iParam0, 1))
			{
				if (!func_348(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_349(iParam0, &Var4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
bool func_548(bool bParam0, bool bParam1)
{
	bool bVar0;
	bool bVar1;
...
float func_702(bool bParam0, bool bParam1, bool bParam2)
{
