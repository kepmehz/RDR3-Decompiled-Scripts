...
void main()
{
	...
	fLocal_396 = 0.5f;
	iLocal_398 = 4;
	iLocal_399 = joaat("MINIGAMES/MINIGAMES_PRELOADER_FLOW");
	...
	while (bLocal_102)
	{
		...
		if (func_13(Local_103.f_1[2], 1) || func_13(Local_103.f_1[7], 1))
		{
			...
			{
				func_15(&Local_103, 15);
			}
			else if (func_14(&Local_103) == 6)
			{
				func_16();
						...
						if (func_27(iLocal_31, iLocal_22))
						{
							if (func_28())
							{
								...
								if (func_30())
								{
									...
									func_31();
									func_15(&Local_103, 14);
								}
								else
								{
									func_15(&Local_103, 12);
								}
...
void func_5()
{
	Local_103.f_106 = GRAPHICS::GET_STATUS_OF_SORTED_LIST_OPERATION();
...
void func_62(var uParam0)
{
	...
	IK::_0x66F9EB44342BB4C5(Global_35, &(uParam0->f_43));
	if (bLocal_394 == 0)
	{
...
void func_66()
{
	...
	if ((func_49(Local_103.f_1[18]) && !func_50(&Local_103, 32)) && (MISC::GET_SYSTEM_TIME() - iLocal_22) > 1000)
	{
		BUILTIN::SETTIMERB(0);
		if (AUDIO::PREPARE_SOUNDSET("Photo_Mode_Sounds", false))
		{
...
void func_112()
{
	...
	{
		StringCopy(&cLocal_77, MISC::_GET_STRING_FROM_FLOAT(fLocal_15, 1), 64);
	}
...
void func_113()
{
	...
	StringConCat(&cLocal_77, ": ", 64);
	StringConCat(&cLocal_77, MISC::_GET_STRING_FROM_FLOAT(fLocal_19, 1), 64);
	...
	{
		StringConCat(&cLocal_77, MISC::_GET_STRING_FROM_FLOAT(fLocal_17, 1), 64);
	}
	...
	if (bParam1)
	{
		if (!func_78(Local_103.f_1[iParam0]))
		{
			...
			else if (iParam0 == 28)
			{
				...
				HUD::_UIPROMPT_SET_ALLOWED_ACTION(Global_1945188[Local_103.f_1[iParam0] /*18*/].f_3, joaat("INPUT_PHOTO_MODE_DOF_UP_ONLY"));
				HUD::_UIPROMPT_SET_ALLOWED_ACTION(Global_1945188[Local_103.f_1[iParam0] /*18*/].f_3, joaat("INPUT_PHOTO_MODE_DOF_DOWN_ONLY"));
			}
			else if (iParam0 == 3)
			{
		...
		{
			HUD::_UIPROMPT_SET_VISIBLE(Global_1945188[Local_103.f_1[iParam0] /*18*/].f_3, true);
		}
		HUD::_0xF4A5C4509BF923B1(Global_1945188[Local_103.f_1[iParam0] /*18*/].f_3, 6);
		HUD::_UIPROMPT_ENABLE_PROMPT_TYPE_THIS_FRAME(6);
	}
...
void func_122(var uParam0)
{
	...
	else if ((MISC::GET_GAME_TIMER() - iLocal_99) > 300 && iLocal_100 == 0)
	{
		if (uParam0->f_110 == 0)
		{
			...
			HUD::_UIPROMPT_SET_TEXT(Global_1945188[iVar0 /*18*/].f_3, "CAM_FOCUS_LOCKD");
		}
		else
		{
			uParam0->f_110 = 0;
			iVar1 = func_79(Local_103.f_1[3]);
			HUD::_UIPROMPT_SET_TEXT(Global_1945188[iVar1 /*18*/].f_3, "CAM_FOCUS_LOCKE");
		}
...
int func_146(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_173(bParam2), iParam0, 0);
	return iVar2;
}
...
int func_156(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, int iParam10, bool bParam11)
{
	int iVar0;
	int iVar1;
	...
	if (iVar1 != 0)
	{
		func_124(iVar1, iParam1, sParam0, 1, iParam2, iParam3, 0f, 0f, 0f, 0f, 0, 0, 0, iParam4, iParam5, iParam6, bParam7, iParam8, bParam9, 0, 1065353216 /* Float: 1f */, 0, 0, 0, iParam10, bParam11);
		return iVar1;
	}
	return 0;
}
...
{
	iLocal_397 = TASK::CREATE_SCENARIO_POINT_HASH(iParam0, vLocal_220, fLocal_395, 0f, 0, 1);
	TASK::_SET_SCENARIO_POINT_FLAG(iLocal_397, 25, true);
	TASK::_SET_SCENARIO_POINT_FLAG(iLocal_397, 23, true);
	TASK::TASK_USE_SCENARIO_POINT(Global_35, iLocal_397, sParam1, -1, false, true, 0, false, 0f, false);
}
...
int func_172(int iParam0, bool bParam1)
{
	...
	if (!func_190(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_171(iVar18);
...
struct<4> /*32*/ func_188(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_194(923904168, func_193(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_194(923904168, func_193(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_194(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_173(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
