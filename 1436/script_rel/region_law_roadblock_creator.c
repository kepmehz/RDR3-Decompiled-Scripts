#region Local Variables
	...
	var uLocal_35 = 0;
	var uLocal_36 = 0;
	bool bLocal_37[5] = { false, false, false, false, false };
	int iLocal_43 = 0;
	int iLocal_44 = 0;
...
void func_1()
{
	...
	func_8(&uLocal_36, 1);
	iVar1 = 0;
	while (iVar1 < bLocal_37)
	{
		if (func_9(bLocal_37[iVar1], 0))
		{
			if (iVar1 == 0)
			{
				iVar2 = -1;
			...
			TASK::TASK_PERFORM_SEQUENCE(bLocal_37[iVar1], iVar0);
			func_10(&(bLocal_37[iVar1]), 1, 1, 1);
		}
		iVar1++;
	}
...
void func_6()
{
	...
	switch (iLocal_14)
	{
		...
		case 2:
			...
			if (((STREAMING::HAS_MODEL_LOADED(bLocal_28) && STREAMING::HAS_MODEL_LOADED(iLocal_29)) && STREAMING::HAS_MODEL_LOADED(iLocal_30)) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
			{
				iLocal_14 = 3;
			}
			break;
		...
		case 4:
			...
			else
			{
				...
				iVar2 = 0;
				while (iVar2 < bLocal_37)
				{
					if (func_9(bLocal_37[iVar2], 0))
					{
						if (iVar2 <= 1)
						{
						...
						TASK::TASK_USE_SCENARIO_POINT(bLocal_37[iVar2], iVar3, 0, 0, false, true, 0, false, -1f, false);
					}
					iVar2++;
				}
				iLocal_14 = 5;
		...
		case 5:
			iVar4 = 0;
			while (iVar4 < bLocal_37)
			{
				if (ENTITY::DOES_ENTITY_EXIST(bLocal_37[iVar4]))
				{
					PED::SET_PED_RESET_FLAG(bLocal_37[iVar4], 116, true);
					if (func_34(Global_35, bLocal_37[iVar4], 1, 1) > 200f)
					{
						iLocal_14 = 6;
						return;
					}
...
void func_30()
{
	...
	bLocal_37[iLocal_26] = func_60(bLocal_28, vVar0, (fLocal_34 + MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 60f)), 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
	LAW::_0x819ADD5EF1742F47(bLocal_37[iLocal_26], 2);
	LAW::_0x819ADD5EF1742F47(bLocal_37[iLocal_26], 16384);
	PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_37[iLocal_26], 39, true);
	PED::SET_PED_CONFIG_FLAG(bLocal_37[iLocal_26], 188, true);
	func_61(bLocal_37[iLocal_26], iLocal_126);
	iLocal_26++;
