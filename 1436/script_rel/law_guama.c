...
bool func_42(var uParam0, var uParam1, bool bParam2)
{
	...
	while (iVar16 < 5)
	{
		...
		if (!bVar14)
		{
			...
			bVar9 = func_65(bVar12, vVar6, fVar5, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			if (MISC::GET_RANDOM_INT_IN_RANGE(0, 100) <= 50)
			{
				...
				PED::SET_PED_ONTO_MOUNT(bVar9, uParam0->f_5[iVar16], -1, true);
			}
			func_67(uParam0->f_3, bVar9);
			PED::SET_PED_CONFIG_FLAG(bVar9, 279, true);
			if (iVar16 == 0 && !bVar15)
			{
			...
			PED::SET_PED_COMBAT_ATTRIBUTES(bVar9, 58, true);
			PED::SET_PED_COMBAT_ATTRIBUTES(bVar9, 5, true);
			PED::SET_PED_CONFIG_FLAG(bVar9, 49, false);
			PED::SET_PED_COMBAT_ATTRIBUTES(bVar9, 39, false);
			PED::SET_PED_COMBAT_ATTRIBUTES(bVar9, 14, true);
			PED::SET_PED_SEEING_RANGE(bVar9, 17f);
			PED::SET_PED_ID_RANGE(bVar9, 17f);
		}
		iVar16++;
	}
	if (!bParam2)
...
void func_67(struct<2> /*16*/ sParam0, bool bParam2)
{
	if (!func_21(Param0))
	{
		return;
...
bool func_84(struct<2> /*16*/ sParam0, bool bParam2)
{
	if (!func_21(Param0))
	{
		return false;
