		...
		switch (iVar0)
		{
			...
			case 18:
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					...
					{
						iVar31 = TASK::FIND_SCENARIO_OF_TYPE_HASH(-2519.942f, 420.925f, 146.9122f, joaat("WORLD_HUMAN_LEAN_POST_RIGHT"), 2f, 1, false);
					}
					ENTITY::FREEZE_ENTITY_POSITION(Global_35, false);
					if (TASK::DOES_SCENARIO_POINT_EXIST(iVar31))
					{
						TASK::TASK_USE_SCENARIO_POINT(Global_35, iVar31, 0, 1300, false, true, 0, false, -1f, false);
						func_22(&uLocal_19, 0);
						func_5(&iVar0, 19);
					}
					else
...
bool func_16(int iParam0)
{
	switch (iParam0)
	{
		case 2:
			...
			{
				bLocal_2 = func_44(joaat("A_C_HORSE_AMERICANPAINT_TOBIANO"), 2552.5f, 424.8f, 148.7f, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			}
			break;
		case 4:
		...
		case 1:
			...
			{
				bLocal_4 = func_44(joaat("A_C_COW"), -2513.196f, 414.9384f, 146.8074f, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
				if (ENTITY::DOES_ENTITY_EXIST(bLocal_4))
				{
					PED::_SET_PED_SCALE(bLocal_4, 1f);
				}
				return false;
			}
			break;
...
void func_17(int iParam0, int iParam1)
{
	switch (iParam1)
	{
		...
		case 2:
			...
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iParam0, "Horse_01", bLocal_2, 0);
		...
		case 1:
			...
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iParam0, "cow", bLocal_4, 0);
...
int func_19(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	...
	if ((bParam3 && func_49(iParam1, 4096)) && Global_1946054.f_1497 == iParam4)
	{
		return 1;
	}
...
bool func_50(int iParam0, int iParam1)
{
	...
	func_91(&(Global_1946054.f_964), iVar0, iParam0, -897569541, 1, iParam1);
...
void func_57(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	{
		func_102(&(Global_1946054.f_1497), bParam1, 1, -1, 1, 1, 1);
	}
}
...
int func_159(int iParam0)
{
	...
	func_91(&(Global_1946054.f_964), iVar0, -367421157, 1409451727, 1, iParam0);
	DATAFILE::_0x91DED5DD64BB2691(&(Global_1946054.f_964));
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_182(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_179(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
