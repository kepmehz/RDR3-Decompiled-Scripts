...
bool func_11()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_335, 2986.668f, 572.391f, 44.68746f, 0f, 0f, 80f, 6.513f, 5.709f, 2.553f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_335, 2985.922f, 568.154f, 44.68746f, 0f, 0f, 80f, 2.17f, 2.622f, 2.553f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_335, 2987.423f, 576.661f, 44.68746f, 0f, 0f, 80f, 2.509f, 2.264f, 2.553f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_335, 2982.536f, 570.44f, 44.68746f, 0f, 0f, 80f, 2.957f, 1.909f, 2.553f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_350, 2979.276f, 779.6296f, 52.62945f, 0f, 0f, 0f, 40.47127f, 19.50671f, 7.453903f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_350, 2985.944f, 797.0881f, 52.62945f, 0f, 0f, 0f, 23.67008f, 19.46324f, 7.453903f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_348, 2967.159f, 798.5253f, 51.745f, 0f, 0f, 0f, 14.3611f, 10.48136f, 4.225f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_348, 2970.102f, 792.5105f, 51.65219f, 0f, 0f, 0f, 8.344481f, 5.59843f, 2.959558f);
...
{
	func_60(4, 444, bLocal_333, iParam0, iLocal_334, 0, 44, -1082130432 /* Float: -1f */, 0, 0);
	func_61(4, -919742804, 0, 0);
	func_61(4, -1653762302, 0, 0);
	func_61(4, 877945562, 0, 0);
	func_62(4, 3023.046f, 563.0334f, 43.7167f, 242.849f);
	func_60(2, 470, bLocal_335, iParam0, iLocal_336, iLocal_337, 229376, -1082130432 /* Float: -1f */, 0, 0);
...
void func_46()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_339, 2946.662f, 523.323f, 46.02f, 0f, 0f, 180f, 9.627f, 13.43f, 3.143f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_339, 2939.048f, 523.346f, 45.61858f, 0f, 0f, -180f, 6.016271f, 9.883f, 3.143f);
...
void func_60(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void func_72()
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(bLocal_346))
	{
		return;
	}
...
void func_73()
{
	...
	{
		if (((!bLocal_351 && AUDIO::_0xBE28DB99556FF8D9(bVar1) != 0) && !func_162(iVar0, 0)) && PED::IS_PED_USING_SCENARIO_HASH(bVar1, joaat("PROP_HUMAN_PIANO_SKETCHY")))
		{
		...
		else if (bLocal_351 && !PED::IS_PED_USING_SCENARIO_HASH(bVar1, joaat("PROP_HUMAN_PIANO_SKETCHY")))
		{
			bLocal_351 = false;
		}
	}
						...
						else
						{
							...
							else
							{
								...
								if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1))
								{
									...
									if (!func_273(1))
									{
										iVar1 = TASK::FIND_SCENARIO_OF_TYPE_HASH(func_275(), joaat("WORLD_HUMAN_LEAN_BACK_WALL_SMOKING_BAR_CA"), 3f, 1, false);
										TASK::OPEN_SEQUENCE_TASK(&iVar0);
...
bool func_342(var uParam0, vector3 vParam1, bool bParam4, bool bParam5, float fParam6)
{
