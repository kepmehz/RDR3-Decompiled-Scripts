...
bool func_58(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, var uParam4)
{
	...
	switch (func_105(uParam4))
	{
		...
		case 3:
			...
			if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam4->f_156) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam4->f_156, false)) && (ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam4->f_156) || func_83(uParam4, 512)))
			{
			...
			else
			{
				...
				else if ((((!func_83(uParam4, 16384) && !ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam4->f_156)) && CAM::IS_SCREEN_FADED_OUT()) && func_117(uParam4) <= 5000) && func_117(uParam4) >= 0)
				{
					CAM::DO_SCREEN_FADE_IN(1000);
				}
...
void func_106(var uParam0)
{
	...
	if (((!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_156) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_156, false)) || ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam0->f_156)) || func_83(uParam0, 512))
	{
		if (!func_128(uParam0->f_213, 128))
		{
			func_130();
...
int func_145(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	func_193(&(Global_1946054.f_1497), bParam0, 1, iParam1, 1, bParam3, 1);
	return 1;
}
...
int func_198(bool bParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != Global_1946054.f_57[func_273(iParam3, 1) /*11*/])
			{
				func_212(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_262(32768) && iParam1 != Global_1946054.f_57[func_273(iParam3, 1) /*11*/])
			{
				func_276();
...
int func_228(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	int iVar0;
	int iVar1;
	...
	if (iVar1 != 0)
	{
		func_290(iVar1, iParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, bParam4, iParam5, bParam6, iParam7, iParam8, iParam9, 0, 0, iParam11, bParam12);
		return iVar1;
	}
	return 0;
}
...
{
	Global_1946054.f_57[func_273(iParam0, 1) /*11*/].f_10 = (Global_1946054.f_57[func_273(iParam0, 1) /*11*/].f_10 - (Global_1946054.f_57[func_273(iParam0, 1) /*11*/].f_10 && iParam1));
}
...
struct<5> /*40*/ func_271(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_313(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_316(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_316(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_317(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
bool func_274(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_322(iParam0, 866047851) && func_323(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_262(32768) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
	...
	Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1 = func_328(iParam0, iParam2, iParam1, func_207() != -1);
	if (bParam4)
	{
...
struct<4> /*32*/ func_279(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
int func_280(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	var uVar4;
...
int func_301(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	if (iParam0 == Global_35)
	{
		func_337(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
struct<4> /*32*/ func_314(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_279(923904168, func_312(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_279(923904168, func_312(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_318(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_279(271701509, func_312(bParam0), 12999093, 0) };
		}
...
int func_323(var uParam0)
{
	...
	iVar0 = 0;
	iVar1 = 22;
	if (uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/] && func_322(uParam0->f_1[iVar1 /*3*/], 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_348(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_240(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
int func_340(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_367("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_366(iParam1, 512) && func_344(Var4.f_4, &uVar19, &Var23, joaat("SLOTID_WEAPON_0"))) && !Var23.f_21)
			{
			}
...
int func_352(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam0 == Global_1946054.f_57[func_273(iParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
