...
void func_64()
{
	...
	{
		iLocal_16 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_PLAYER_INSPECT_LETTER_80CM_PAPER_W15_1_H24_FOLDVERTICAL_P_CS_LETTER03X"), 1320.37f, -2274.06f, 49.53f, 7.859f, 0f, 0, 0);
	}
	else
	{
		func_61(4);
...
int func_193(int iParam0, bool bParam1)
{
	...
	if (!func_235(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_192(iVar18);
...
struct<4> /*32*/ func_233(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_262(923904168, func_261(bParam0), -740156546, 0) };
		}
