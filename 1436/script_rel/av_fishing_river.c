	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], joaat("WEAPON_FISHINGROD"), 1, true, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), true, 0f, false);
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				if (*uParam0 == 44)
				{
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
					{
						TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0, 0, 2f, 0f, 32, 2f, 0f, 1069547520 /* Float: 1.5f */, 1073741824 /* Float: 2f */);
					}
				}
				iLocal_10 = 4;
			}
