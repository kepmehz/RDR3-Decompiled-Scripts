...
void func_35()
{
	...
	if (!bLocal_87 && func_70(bLocal_71, 0, &uLocal_42, &uLocal_70, 0, 0))
	{
		...
		TASK::TASK_FLEE_PED(false, Global_35, 4, 0, -1082130432 /* Float: -1f */, -1, false);
		func_45(bLocal_71, &iVar0, 0, 0, 1, 1);
		bLocal_87 = true;
		func_39(6);
	}
...
int func_72(var uParam0, var uParam1, int iParam2, vector3 vParam3, bool bParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)
{
	bool bVar0;
	int iVar1;
	...
	iVar1 = func_125(uParam0, uParam1, iParam2, bVar0, bParam7, bParam8, bParam9, iParam10, bParam11, bParam12, bParam14, bParam15);
	func_126(bVar0);
	return iVar1;
}
...
bool func_98(bool bParam0, bool bParam1, var uParam2)
{
	float fVar0;
	float fVar1;
...
bool func_102(var uParam0, bool bParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_103(var uParam0, bool bParam1, var uParam2)
{
	var uVar0;
...
bool func_148(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_44(bVar0, bParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_152(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
...
bool func_166(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_177(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
...
bool func_199(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
	if (bParam3 || !ENTITY::IS_ENTITY_DEAD(bParam0))
	{
...
int func_224(int iParam0, bool bParam1)
{
	...
	if (!func_236(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_223(iVar18);
...
struct<18> /*144*/ func_233(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
struct<4> /*32*/ func_234(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_239(923904168, func_238(bParam0), -740156546, 0) };
		}
