...
bool func_44()
{
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(Local_5[iVar0 /*6*/]) && !func_62(Local_5[iVar0 /*6*/].f_5, 1))
		{
			...
			ENTITY::_SET_ENTITY_CARRYING_FLAG(Local_5[iVar0 /*6*/], 0, false);
			PED::SET_PED_LASSO_HOGTIE_FLAG(Local_5[iVar0 /*6*/], 0, false);
			ENTITY::_SET_ENTITY_CARRYING_FLAG(Local_5[iVar0 /*6*/], 1, false);
			ENTITY::_SET_ENTITY_CARRYING_FLAG(Local_5[iVar0 /*6*/], 2, false);
...
bool func_45()
{
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_5[iVar0 /*6*/]))
		{
			...
			{
				Local_5[iVar0 /*6*/].f_1 = MAP::BLIP_ADD_FOR_ENTITY(joaat("BLIP_STYLE_ENEMY"), Local_5[iVar0 /*6*/]);
				MAP::BLIP_ADD_MODIFIER(Local_5[iVar0 /*6*/].f_1, -1034486097);
			}
...
int func_64(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_86(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
bool func_95(bool bParam0, bool bParam1, var uParam2)
{
	float fVar0;
	float fVar1;
...
bool func_99(var uParam0, bool bParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_100(var uParam0, bool bParam1, var uParam2)
{
	var uVar0;
...
bool func_101(var uParam0, bool bParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
bool func_103(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_107(var uParam0, bool bParam1)
{
	if (func_172(uParam0))
	{
		return true;
...
struct<5> /*40*/ func_135(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_194(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_137(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_137(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_138(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_139(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_204(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_174(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_180(bool bParam0, var uParam1, bool bParam2)
{
	bool bVar0;
	bool bVar1;
...
struct<4> /*32*/ func_195(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_139(923904168, func_193(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_197(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_139(271701509, func_193(bParam0), 12999093, 0) };
		}
...
bool func_215(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
...
bool func_218(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
