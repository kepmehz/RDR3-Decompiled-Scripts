...
bool func_5(var uParam0)
{
	...
	if (uParam0->f_11 > 0)
	{
		...
		if ((SCRIPTS::IS_THREAD_EXIT_REQUESTED() && SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("HUNTING1")) == 0) && !func_37(15))
		{
			bVar0 = true;
		}
...
void func_53(var uParam0)
{
	...
	if (uParam0->f_12.f_2 != 1)
	{
		if (((func_110(uParam0->f_12, uParam0->f_12.f_16, 1) >= 2500f && func_111(Global_35, uParam0->f_12, 1) > 400f) && !PED::IS_PED_INJURED(uParam0->f_12)) && !func_119(uParam0->f_12, 242628503))
		{
			...
			TASK::TASK_WANDER_IN_AREA(0, uParam0->f_12.f_16, 15f, 1.5f, 3f, true);
...
bool func_79(int iParam0, int iParam1, int iParam2)
{
	...
	Var1 = { func_133(0) };
	if (!func_142(iParam0, &uVar6, &Var1, iParam2, joaat("ADD_REASON_DEFAULT"), 1))
	{
		return false;
	}
	return true;
...
struct<4> /*32*/ func_135(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
void func_171(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_208(bParam1))
		{
			func_209(bParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_187(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_223(bParam0))
	{
		if (func_224(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
...
bool func_198(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_229(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			Var0 = { func_230(0) };
			Var4.f_9 = -1591664384;
			if (!func_231(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
			{
				return false;
			}
			else if (func_232(iParam0, &Var4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_233(iParam0, 1))
			{
				if (!func_231(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_232(iParam0, &Var4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
{
	return func_246(iParam0) == joaat("WEAPON");
}
...
struct<4> /*32*/ func_230(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_135(923904168, func_133(bParam0), -740156546, 0) };
		}
...
int func_235(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	var uVar4;
...
struct<5> /*40*/ func_249(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_246(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_233(iParam0, 1))
			{
				...
				else if (!func_231(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_232(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_253(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_135(271701509, func_133(bParam0), 12999093, 0) };
		}
