		...
		if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
		{
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
			{
				...
				if (bVar1)
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
					{
						TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 3, 32832, -1082130432 /* Float: -1f */, -1, 0);
					}
					func_68(uParam0);
					if (!uParam0->f_469[6])
					{
...
bool func_175(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_192(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
