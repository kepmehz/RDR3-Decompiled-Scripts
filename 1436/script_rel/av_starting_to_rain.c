...
bool func_28(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_20[0 /*14*/], 1) && !func_59(uParam0->f_20[0 /*14*/], 993674639))
		{
			...
			TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[0 /*14*/], iLocal_37, 0, false, iLocal_38, -1f, false);
		}
	...
	if (!uParam0->f_469[3])
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
		{
			if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
			{
				...
				TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[0 /*14*/], iLocal_37, 15000, false, iLocal_38, -1f, false);
