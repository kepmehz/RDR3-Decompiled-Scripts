...
bool func_97(var uParam0)
{
	...
	{
		PED::GIVE_PED_HASH_SCENARIO_PROP(func_9(uParam0, iLocal_14), iLocal_30, "p_mortarPestle02x_PH_L_HAND", joaat("PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE"), "PROP_HUMAN_SEAT_CHAIR_MORTAR_PESTLE_MALE_A_MORTAR", 1);
	}
	return true;
}
...
void func_488(bool bParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_237(iParam1), bParam0, false);
