			...
			else
			{
				...
				if (iLocal_14 > 3 && iLocal_14 < 47)
				{
					if (func_8(fLocal_155, &iVar1, &iVar2, 1104674816 /* Float: 27f */, 1102053376 /* Float: 22f */))
					{
						...
						TASK::TASK_FLEE_PED(bLocal_163, Global_35, 3, 1, 6000f, -1, false);
			...
			else
			{
				...
				switch (iLocal_14)
				{
					...
					case 1:
						...
						if (((((((HUD::TEXT_BLOCK_IS_LOADED("SPDEF") && HUD::TEXT_BLOCK_IS_LOADED("SPDWAU")) && STREAMING::HAS_MODEL_LOADED(bLocal_158)) && STREAMING::HAS_MODEL_LOADED(iLocal_159)) && STREAMING::HAS_MODEL_LOADED(bLocal_160)) && STREAMING::HAS_MODEL_LOADED(bLocal_162)) && STREAMING::HAS_MODEL_LOADED(bLocal_161)) && PED::_GET_NUM_RESERVED_AMBIENT_PEDS_READY() == 4)
						{
							func_65(2);
						}
						break;
...
void func_27(bool bParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	*iParam2 = { 0f, 0f, 0f };
	...
	iParam2->f_13 = 3;
	iParam2->f_7 = iParam3;
	IK::_0x66F9EB44342BB4C5(*bParam1, iParam2);
}
...
void func_31()
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(bLocal_170))
	{
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_170, 2543.417f, -1213.348f, 52.70186f, 0f, 0f, 0f, 6.149397f, 6.646178f, 5.845132f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_170, 2545.63f, -1218.448f, 52.70186f, 0f, 0f, 0f, 1.699921f, 3.769435f, 5.845132f);
	}
	if (!VOLUME::DOES_VOLUME_EXIST(bLocal_171))
	{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(bLocal_176))
	{
...
bool func_66(bool bParam0, bool bParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8)
{
...
int func_71(var uParam0, bool bParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, bool bParam9)
{
	if (*iParam2)
	{
		return 0;
	...
	if (!bParam8)
	{
		*uParam0 = func_201(bParam1, vParam3, fParam6, 0, 1, bParam7, 1, 1, 1, 0, 0, 0, 0);
	}
	else
	{
		*uParam0 = func_201(bParam1, vParam3, fParam6, 0, 1, bParam7, 1, 1, bParam9, 1, 1, 0, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		*iParam2 = 1;
...
bool func_150(bool bParam0, bool bParam1, var uParam2, int iParam3, int iParam4, float fParam5)
{
	int iVar0;
...
bool func_256(bool bParam0, bool bParam1, var uParam2)
{
	float fVar0;
	float fVar1;
...
bool func_260(var uParam0, bool bParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_261(var uParam0, bool bParam1, var uParam2)
{
	var uVar0;
...
bool func_282(int iParam0, vector3 vParam1, bool bParam4)
{
...
bool func_283(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_368(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
...
bool func_382(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_453(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
