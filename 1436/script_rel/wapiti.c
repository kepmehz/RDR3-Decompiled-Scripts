	...
	if (func_128(Global_35, bLocal_14, 1, 0))
	{
		...
		if (!func_129(iLocal_116, 2))
		{
			if (PED::IS_PED_ON_MOUNT(Global_35))
			{
				...
				if (func_128(iVar1, bLocal_14, 1, 0))
				{
...
int func_107()
{
	...
	while (iVar1 < iVar0)
	{
		bVar2 = MISC::_GET_PED_FROM_INDEXED_ITEM(ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(iVar1, Local_47));
		if (ENTITY::IS_ENTITY_DEAD(bVar2))
		{
		}
		else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Global_35, bVar2, 1, 1))
		{
			ENTITY::SET_ENTITY_HEALTH(Global_35, 0, bVar2);
			return -1;
		}
		iVar1++;
	}
...
int func_116(bool bParam0, bool bParam1, bool bParam2)
{
	...
	else if (VOLUME::IS_POINT_IN_VOLUME(bParam0, Global_36))
	{
...
bool func_128(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
