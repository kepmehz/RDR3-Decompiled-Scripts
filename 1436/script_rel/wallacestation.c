...
bool func_11()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_208, -1301.045f, 400.748f, 95.8015f, 0f, 0f, 61.99999f, 2.173f, 5f, 3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_208, -1301.309f, 398.458f, 95.8015f, 0f, 0f, 61.99999f, 2.173f, 2.006f, 3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_208, -1298.877f, 402.661f, 95.8015f, 0f, 0f, 61.99999f, 3.035f, 2.644f, 3f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_211, -1302.8f, 395.115f, 95.824f, 0f, 0f, 61.99999f, 13.80803f, 7.2f, 3f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_211, -1296.613f, 397.2601f, 95.824f, 0f, 0f, 61.99999f, 3.88245f, 2.262934f, 3f);
...
{
	func_51(2, 802, bLocal_208, iParam0, iLocal_209, iLocal_210, 491520, (12.5f * 2f), 0, 0);
	func_52(2, 96424206, 0, 0);
	func_52(2, 381066979, 0, 0);
	func_53(2, -1301.726f, 401.6754f, 94.3517f, 241.9753f);
	func_51(3, 803, bLocal_211, iParam0, iLocal_212, iLocal_214, 12, -1082130432 /* Float: -1f */, 0, 0);
...
void func_51(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
