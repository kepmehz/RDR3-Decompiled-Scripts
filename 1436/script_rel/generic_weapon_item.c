...
void func_7()
{
	...
	iVar0 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Global_35, 0));
	if (func_20(joaat("KIT_GUN_OIL"), 1, 0) && (WEAPON::GET_WEAPON_DEGRADATION(iVar0) != 0f && WEAPON::GET_WEAPON_DEGRADATION(iVar0) > WEAPON::GET_WEAPON_PERMANENT_DEGRADATION(iVar0)))
	{
...
struct<5> /*40*/ func_14(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_30(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_38(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_38(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_39(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
bool func_31(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar39 < iVar19)
	{
		...
		{
			if (!func_67(&Var20, iVar39, iVar18, iVar19))
			{
			}
			else
			{
				Var34.f_4 = Var20.f_9;
				Var34 = { Var20.f_5 };
				if (func_68(iParam0, &Var20, &Var34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
struct<4> /*32*/ func_36(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_15(923904168, func_35(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_40(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_15(271701509, func_35(bParam0), 12999093, 0) };
		}
