...
void func_30(int iParam0, char* sParam1, char* sParam2)
{
	...
	HUD::_UIPROMPT_SET_TEXT(Global_1945188[iVar0 /*18*/].f_3, MISC::VAR_STRING(10, sParam1, sParam2));
}
...
bool func_49(int iParam0, bool bParam1)
{
	...
	iVar0 = func_77(iParam0);
	return HUD::_UIPROMPT_IS_RELEASED(Global_1945188[iVar0 /*18*/].f_3);
}
...
struct<2> /*16*/ func_108(int iParam0)
{
	struct<2> /*16*/ sVar0;
	struct<2> /*16*/ sVar2;
...
bool func_111(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if (!func_170(&Var0, &iVar18, &iVar19, 0))
	{
		return false;
	}
	...
	while (iVar39 < iVar19)
	{
		...
		{
			if (!func_132(&Var20, iVar39, iVar18, iVar19))
			{
			}
			else
			{
				Var34.f_4 = Var20.f_9;
				Var34 = { Var20.f_5 };
				if (func_154(iParam0, &Var20, &Var34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
struct<5> /*40*/ func_151(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_110(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_212(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_212(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_213(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<18> /*144*/ func_167(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
struct<4> /*32*/ func_168(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_153(923904168, func_210(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_214(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_153(271701509, func_210(bParam0), 12999093, 0) };
		}
...
struct<4> /*32*/ func_253(int iParam0, int iParam1)
{
	struct<5> /*40*/ sVar0;
...
struct<4> /*32*/ func_289(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> /*32*/ sVar0;
...
void func_331(int iParam0, int iParam1)
{
	...
	{
		func_336(bVar0, &(iParam1->f_5), &(iParam1->f_6), &(iParam1->f_7), &(iParam1->f_4));
		if (func_337(&(iParam1->f_1), bVar0, iParam1->f_7, iParam1->f_5))
		{
		}
	}
}
...
void func_336(bool bParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
...
bool func_337(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
