...
void func_3()
{
	Local_47.f_106 = GRAPHICS::GET_STATUS_OF_SORTED_LIST_OPERATION();
	if (Local_47.f_106 == 1)
	{
	}
	if (Local_47.f_106 == 0)
...
int func_46(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, bool bParam10, int iParam11, bool bParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_102(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_103(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, bParam10, iParam11, bParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_53(var uParam0)
{
	...
	uParam0->f_43 = { func_110(PLAYER::GET_PLAYER_INDEX()) + ENTITY::GET_ENTITY_FORWARD_VECTOR(Global_35) * Vector(2f, 2f, 2f) + Vector(1f, 0f, 0f) };
...
void func_96(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		{
			HUD::_UIPROMPT_SET_VISIBLE(Global_1945188[Local_47.f_1[iParam0] /*18*/].f_3, true);
		}
	}
...
int func_132(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, int iParam10, bool bParam11)
{
	int iVar0;
	int iVar1;
	...
	if (iVar1 != 0)
	{
		func_103(iVar1, iParam1, sParam0, 1, iParam2, iParam3, 0f, 0f, 0f, 0f, 0, 0, 0, iParam4, iParam5, iParam6, bParam7, iParam8, bParam9, 0, 1065353216 /* Float: 1f */, 0, 0, 0, iParam10, bParam11);
		return iVar1;
	}
	return 0;
}
...
{
	iLocal_219 = TASK::CREATE_SCENARIO_POINT_HASH(iParam0, vLocal_164, fLocal_217, 0f, 0, 1);
	TASK::_SET_SCENARIO_POINT_FLAG(iLocal_219, 25, true);
	TASK::_SET_SCENARIO_POINT_FLAG(iLocal_219, 23, true);
	TASK::TASK_USE_SCENARIO_POINT(Global_35, iLocal_219, sParam1, -1, false, true, 0, false, 0f, false);
}
...
struct<4> /*32*/ func_162(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_168(923904168, func_167(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_168(923904168, func_167(bParam0), -740156546, 0) };
		}
