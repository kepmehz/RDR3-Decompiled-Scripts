...
void main()
{
	...
	while (true)
	{
		...
		if (!bLocal_16)
		{
			if ((bLocal_15 && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, Local_73.f_162)) && func_19(func_18(iLocal_62), 1, 0))
			{
				bLocal_16 = true;
			}
		}
...
void func_1()
{
	...
	if (TASK::DOES_SCENARIO_POINT_EXIST(Local_73.f_168))
	{
	...
	if (!bLocal_30)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_73.f_159))
		{
			...
			else if (TXD::HAS_STREAMED_TXD_LOADED(func_37()))
			{
				...
				OBJECT::SET_CUSTOM_TEXTURES_ON_OBJECT(ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(Local_73.f_159), func_37(), 0, 0);
				bLocal_30 = true;
			}
		}
	}
...
void func_12()
{
	if (!ANIMSCENE::DOES_ANIM_SCENE_EXIST(Local_73.f_162))
	{
		return;
	}
	if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(Local_73.f_162, false))
	{
		return;
	}
	if (iLocal_62 != 0)
...
void func_13()
{
	...
	switch (iLocal_66)
	{
		...
		case 2:
			...
			HUD::TEXT_BLOCK_REQUEST(Local_73.f_127);
			if (iLocal_62 == 0)
			{
		...
		case 3:
			...
			if (!HUD::TEXT_BLOCK_IS_LOADED(Local_73.f_127))
			{
				bVar0 = false;
			}
			if (iLocal_62 == 0)
		...
		case 4:
			if (func_79())
			{
				...
				if (!func_95(Local_73.f_23))
				{
					...
					if (func_95(Local_73.f_23))
					{
						HUD::_UIPROMPT_SET_GROUP(Global_1945188[func_99(Local_73.f_23) /*18*/].f_3, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(Local_73), 0);
...
bool func_43(bool bParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	char cVar0[32];
	bool bVar4;
	int iVar5;
...
bool func_47(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool func_55(bool bParam0, int* iParam1, float fParam2, bool bParam3)
{
	if (iParam1->f_9)
	{
...
bool func_63(int iParam0)
{
	...
	if (func_6(bVar1, 0))
	{
		if (PED::GET_PED_BLACKBOARD_SCRIPT_BOOL(bVar1, func_182()) || func_183(bVar1, 0, &uLocal_32, &uLocal_60, 0, 0))
		{
			PED::_SET_PED_BLACKBOARD_BOOL(bVar1, func_182(), true, -1);
			return true;
		}
	}
	return false;
	...
	if (func_70(Local_73.f_1))
	{
		...
		if (bParam1)
		{
			...
			if (bParam2)
			{
				...
				PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(Local_73);
		...
		{
			PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, PLAYER::GET_DISCOVERABLE_NAME_HASH_AND_TYPE_FOR_ENTITY(Local_73, &uVar0));
		}
		if (bParam0 || bParam1)
		{
			func_21(1);
...
bool func_80(bool bParam0, int iParam1, bool bParam2, float fParam3, bool bParam4)
{
	if (bParam2)
	{
		if (!func_209(bParam0, iParam1, 0f))
		{
			return false;
		}
	}
	if (!func_210(bParam0, iParam1, fParam3, 1))
	{
		return false;
	}
...
void func_87()
{
	if (bLocal_26)
	{
		if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_73, func_74(), "base", 1))
		{
			...
			TASK::TASK_PLAY_ANIM(Local_73, func_74(), "base", 8f, -8f, -1, 5, 0f, false, 0, false, 0, false);
			TASK::TASK_LOOK_AT_ENTITY(Local_73, Global_35, -1, 0, 51, 0);
			PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_73, false, false);
		}
	}
}
	...
	switch (iLocal_72)
	{
		...
		case 2:
			if (ENTITY::_GET_ENTITY_ANIM_CURRENT_TIME(Local_73, sVar5, "action_pt01_hector") > 0.99f)
			{
				...
				PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, PLAYER::GET_DISCOVERABLE_NAME_HASH_AND_TYPE_FOR_ENTITY(Local_73, &uVar6));
				TASK::TASK_PLAY_ANIM(Local_73, func_75(), "base", 4f, -4f, -1, 8193, 0f, false, 0, false, 0, false);
				TASK::TASK_LOOK_AT_ENTITY(Local_73, Global_35, -1, 0, 51, 0);
				PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(Local_73, true, false);
...
bool func_96(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
bool func_117()
{
	...
	switch (iLocal_70)
	{
		...
		case 1:
			func_242();
			if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Global_35, Local_73.f_162))
			{
				if (bLocal_20)
				{
		...
		case 8:
			...
			if (iLocal_62 == 0)
			{
				...
				if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(Local_73.f_162, false))
				{
					if (ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(Local_73, Local_73.f_162))
					{
						if (ANIMSCENE::GET_ANIM_SCENE_PHASE(Local_73.f_162) > 0.98f)
						{
			...
			if (!ANIMSCENE::IS_ANIM_SCENE_RUNNING(Local_73.f_162, false) || ANIMSCENE::IS_ANIM_SCENE_EXITING_THIS_FRAME(Local_73.f_162))
			{
				if (ENTITY::DOES_ENTITY_EXIST(Local_73.f_160))
				{
...
bool func_119(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam0))
	{
		return false;
...
bool func_183(bool bParam0, bool bParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
int func_195(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
		...
		else if (func_344(iParam0, 1192444843))
		{
			switch (iParam0)
			{
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_LAKE"):
					...
					{
						func_195(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_RIVER"):
					if (!func_19(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
						func_195(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP"):
					if (!func_19(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
						func_195(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_LAKE"):
					if (!func_19(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1, 0))
					{
						func_195(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_RIVER"):
					if (!func_19(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1, 0))
					{
						func_195(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_SWAMP"):
					if (!func_19(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1, 0))
					{
						func_195(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
			}
		}
	...
	else if (iVar2 != 0)
	{
		if (func_351(0))
		{
			...
			while (iVar34 < Var11)
			{
				func_195(Var11.f_1[iVar34], Var11.f_12[iVar34], 0, 0, 0, joaat("ADD_REASON_LOOTED"), 0, 0, 0, 0);
				iVar34++;
			}
		}
		else
...
int func_198(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_352(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
bool func_209(bool bParam0, int iParam1, float fParam2)
{
	return func_411(bParam0, ENTITY::GET_ENTITY_COORDS(iParam1, false, false), fParam2);
}

bool func_210(bool bParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam0))
	{
		return false;
...
void func_242()
{
	...
	switch (iLocal_71)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (ANIMSCENE::IS_ANIM_SCENE_LOADED(Local_73.f_162, true, false) && func_426())
			{
				...
				ANIMSCENE::REQUEST_ANIM_SCENE_PLAY_LIST(Local_73.f_162, sVar1);
				iLocal_71 = 3;
			}
			break;
		case 3:
			if (ANIMSCENE::_0x23E33CB9F4A3F547(Local_73.f_162, sVar1))
			{
				...
				ANIMSCENE::SET_ANIM_SCENE_PLAY_LIST(Local_73.f_162, sVar1, true);
				func_427();
				...
				TASK::TASK_ENTER_ANIM_SCENE(Global_35, Local_73.f_162, sVar6, sVar1, 1069379748 /* Float: 1.48f */, true, 0, 20000, -1082130432 /* Float: -1f */);
				iLocal_71 = 4;
			}
			break;
		case 4:
		...
		case 5:
			...
			if (ANIMSCENE::IS_ANIM_SCENE_RUNNING(Local_73.f_162, false))
			{
				if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -2049568183) || ANIMSCENE::HAS_ENTITY_EXITED_ANIM_SCENE(Local_73.f_162, sVar6))
				{
					if (func_8())
					{
...
int func_252(int iParam0, bool bParam1)
{
	...
	if (!func_433(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_251(iVar18);
...
bool func_281(bool bParam0, bool bParam1, var uParam2)
{
	float fVar0;
	float fVar1;
...
bool func_282(bool bParam0, var uParam1)
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
bool func_284(var uParam0, bool bParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_285(var uParam0, bool bParam1, var uParam2)
{
	var uVar0;
...
bool func_286(var uParam0, bool bParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
bool func_287(bool bParam0, var uParam1)
{
	int iVar0;
	float fVar1;
	vector3 vVar2[2];
...
bool func_295(var uParam0, bool bParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_476(iVar0, bParam1, vVar1))
		{
...
bool func_300(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_376(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_599(32768) && iParam1 != Global_1946054.f_57[func_595(iParam3, 1) /*11*/])
			{
				func_600();
...
bool func_416(bool bParam0, float fParam1, float fParam2)
{
	float fVar0;
	float fVar1;
...
struct<4> /*32*/ func_431(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_552(923904168, func_631(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_552(923904168, func_631(bParam0), -740156546, 0) };
		}
...
bool func_452(bool bParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_458(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_475(bVar0, bParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_460(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_462(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
...
bool func_466(bool bParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_469(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_470(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_471(var uParam0, bool bParam1, float fParam2, int iParam3)
{
	float fVar0;
...
bool func_476(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_514(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar39 < iVar19)
	{
		...
		{
			if (!func_250(&Var20, iVar39, iVar18, iVar19))
			{
			}
			else
			{
				Var34.f_4 = Var20.f_9;
				Var34 = { Var20.f_5 };
				if (func_553(iParam0, &Var20, &Var34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
struct<5> /*40*/ func_521(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_121(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_550(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_550(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_551(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
bool func_525(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_517(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_551(iParam0, &Var4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_671(iParam0, 1))
			{
				if (!func_550(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_551(iParam0, &Var4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
bool func_532(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1898164.f_163 && !func_607(iParam0, 1)) || func_690(32768))
	{
...
bool func_540(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		...
		{
			if (func_705(COLLECTION::_0x126CBEBBA46693CF(iVar0, 1995362678, 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_706(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0))), func_706(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0)), bVar1, true, false);
		}
...
int func_576()
{
	...
	while (iVar1 < 30)
	{
		if (func_735(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_581()
{
	...
	while (iVar1 < 5)
	{
		if (func_740(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_596(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_344(iParam0, 866047851) && func_726(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_599(32768) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
...
{
	return func_552(joaat("CHARACTER"), func_787(), -1591664384, bParam0);
}
...
bool func_640(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
...
bool func_642(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
...
struct<4> /*32*/ func_672(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_552(271701509, func_631(bParam0), 12999093, 0) };
		}
...
void func_683(int iParam0, float fParam1, bool bParam2)
{
	...
	if (func_802(iParam0) && func_803(iParam0))
	{
		if (!bParam2)
		{
			...
			if (fParam1 > IntToFloat(func_805(iParam0)) && (iVar2 > iVar0 || iVar3 != 0))
			{
...
int func_695()
{
	...
	while (iVar1 < 30)
	{
		if (func_811(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_696()
{
	...
	while (iVar1 < 14)
	{
		if (func_705(COLLECTION::_0x126CBEBBA46693CF(iVar1, 1995362678, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_726(var uParam0)
{
	...
	iVar0 = 0;
	iVar1 = 22;
	if (uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/] && func_344(uParam0->f_1[iVar1 /*3*/], 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
void func_750(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_821(iParam2, 65536) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
	...
	if (func_617(-1586649372) && func_821(iParam2, 524288))
	{
		iVar1 = 33;
		uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
		uParam0->f_1[iVar1 /*3*/].f_1 = 0;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_729(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_347(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
{
	Global_1946054.f_57[func_595(iParam0, 1) /*11*/].f_10 = (Global_1946054.f_57[func_595(iParam0, 1) /*11*/].f_10 - (Global_1946054.f_57[func_595(iParam0, 1) /*11*/].f_10 && iParam1));
}
...
void func_867(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (iParam0 == func_898(0))
	{
		...
		if (func_614() == 1160113249)
		{
			func_899(func_898(-2125499975), 0);
		}
		else
		{
			func_899(func_898(1160113249), 0);
		}
	}
	func_900();
	if (func_901(iVar0))
