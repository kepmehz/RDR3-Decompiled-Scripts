...
bool func_405(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	bool bVar0;
...
int func_427(int iParam0, bool bParam1)
{
	...
	if (!func_478(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_479(iVar18);
...
void func_493(bool bParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_242(iParam1), bParam0, false);
