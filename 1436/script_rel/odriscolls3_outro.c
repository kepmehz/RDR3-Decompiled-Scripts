...
bool func_26(var uParam0)
{
	...
	switch (iLocal_16)
	{
		case 0:
			...
			break;
		case 1:
			if (PED::_GET_NUM_RESERVED_AMBIENT_PEDS_READY() >= 1 + 1 || func_59(&uLocal_21) >= 10f)
			{
				iLocal_16 = 2;
			}
			break;
		...
		case 5:
			...
			if (func_63())
			{
				MISC::SET_WEATHER_TYPE(joaat("MISTY"), true, true, false, 0f, false);
				CLOCK::SET_CLOCK_TIME(7, 0, 0);
			}
			else
			{
				MISC::SET_WEATHER_TYPE(joaat("THUNDER"), true, true, false, 0f, false);
...
int func_67(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, var uParam4)
{
	...
	switch (func_183(uParam4))
	{
		...
		case 3:
			...
			if ((ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam4->f_156) && ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam4->f_156, false)) && (ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam4->f_156) || func_113(uParam4, 512)))
			{
			...
			else
			{
				...
				else if ((((!func_113(uParam4, 16384) && !ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam4->f_156)) && CAM::IS_SCREEN_FADED_OUT()) && func_194(uParam4) <= 5000) && func_194(uParam4) >= 0)
				{
					CAM::DO_SCREEN_FADE_IN(1000);
				}
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != Global_1946054.f_57[func_208(iParam3, 1) /*11*/])
			{
				func_211(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_212(32768) && iParam1 != Global_1946054.f_57[func_208(iParam3, 1) /*11*/])
			{
				func_213();
...
void func_184(var uParam0)
{
	...
	if (((!ANIMSCENE::DOES_ANIM_SCENE_EXIST(uParam0->f_156) || !ANIMSCENE::IS_ANIM_SCENE_RUNNING(uParam0->f_156, false)) || ANIMSCENE::WAS_ANIM_SCENE_SKIPPED(uParam0->f_156)) || func_113(uParam0, 512))
	{
...
struct<5> /*40*/ func_206(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_372(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_375(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_375(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_376(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
bool func_209(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_382(iParam0, 866047851) && func_383(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_212(32768) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
	...
	func_388(&(Global_1946054.f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946054.f_1378.f_1[iParam2 /*3*/] = iParam0;
	Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1 = func_389(iParam0, iParam2, iParam1, func_175() != -1);
	if (bParam4)
	{
...
struct<4> /*32*/ func_216(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
int func_217(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	var uVar4;
...
{
	Global_1946054.f_57[func_208(iParam0, 1) /*11*/].f_10 = (Global_1946054.f_57[func_208(iParam0, 1) /*11*/].f_10 - (Global_1946054.f_57[func_208(iParam0, 1) /*11*/].f_10 && iParam1));
}
...
struct<4> /*32*/ func_373(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_216(923904168, func_371(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_216(923904168, func_371(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_377(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_216(271701509, func_371(bParam0), 12999093, 0) };
		}
...
int func_383(var uParam0)
{
	...
	iVar0 = 0;
	iVar1 = 22;
	if (uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/] && func_382(uParam0->f_1[iVar1 /*3*/], 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_531(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_378(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
int func_404(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_548("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_547(iParam1, 512) && func_526(Var4.f_4, &uVar19, &Var23, joaat("SLOTID_WEAPON_0"))) && !Var23.f_21)
			{
			}
...
int func_508(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	int iVar0;
	int iVar1;
...
int func_535(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam0 == Global_1946054.f_57[func_208(iParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
...
bool func_557(struct<4> /*32*/ sParam0, int iParam4)
{
	struct<11> /*88*/ sVar0;
...
void func_565(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME_FROM_PLAYER_STRING(*uParam0, func_652(func_651(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_246())
	{
...
int func_645(struct<4> /*32*/ sParam0, int iParam4, bool bParam5)
{
	int iVar0;
	struct<11> /*88*/ sVar1;
	int iVar15;
	...
	if (iVar15 == joaat("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_674(joaat("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == joaat("CLOTHING"))
	{
		...
		Var45.f_10 = iParam4;
		iVar0 = func_676(joaat("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var63 = { func_647(&Var1) };
		Var63.f_10 = iParam4;
		iVar0 = func_648(joaat("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
