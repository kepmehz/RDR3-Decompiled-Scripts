...
bool func_97(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_IN_PLACE_HASH(func_9(uParam0, iLocal_15), joaat("STAND"), 25000, false, 0, -1f, false);
	}
	return true;
}
...
int func_428(int iParam0, bool bParam1)
{
	...
	if (!func_479(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_480(iVar18);
...
struct<4> /*32*/ func_477(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_521(923904168, func_520(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_558(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_521(271701509, func_520(bParam0), 12999093, 0) };
		}
