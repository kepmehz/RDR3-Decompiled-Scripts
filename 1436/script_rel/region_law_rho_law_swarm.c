...
void func_4()
{
	switch (iLocal_44)
	{
		...
		case 2:
			...
			if (STREAMING::HAS_MODEL_LOADED(bLocal_45) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
			{
				iLocal_44 = 4;
			}
			break;
...
bool func_11()
{
	...
	iLocal_46++;
	bVar0 = func_15(bLocal_45, vLocal_41, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
	PED::SET_PED_AS_COP(bVar0, true);
	func_16(&bVar0, 1, 0, 1);
