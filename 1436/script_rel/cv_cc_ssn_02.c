...
bool func_93(var uParam0)
{
	...
	if (bLocal_41)
	{
		...
		{
			iLocal_42 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(uParam0->f_1711[iLocal_19 /*15*/].f_10, joaat("PROP_HUMAN_SEAT_BENCH"), 0f, 0f, 0.5f, 160f, 0, 0, 0);
...
void func_429(bool bParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_231(iParam1), bParam0, false);
