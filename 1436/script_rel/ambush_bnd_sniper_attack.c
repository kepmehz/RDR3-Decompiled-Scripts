...
int func_164()
{
	...
	while (iVar0 <= 1)
	{
		if (func_61(iLocal_15[iVar0], 0, 0))
		{
			...
			TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, Global_35, 0f, 0f, 0f, 3f, -1, 72f, 1, 1, 0, 0, 1, 0);
...
void func_372(var uParam0, int iParam1)
{
	if (func_270(iParam1, 1))
	{
		...
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iParam1->f_23[0], -5379.791f, -2789.541f, -44.46426f, 0f, 0f, -80.44685f, 190.6763f, 335.8115f, 240.5904f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iParam1->f_23[0], -5308.527f, -3060.64f, 8.75246f, 0f, 0f, -69.9966f, 227.4959f, 341.2541f, 107.3552f);
		iParam1->f_23[3] = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("volMainArea");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iParam1->f_23[3], -5268.049f, -2932.338f, 3.422212f, 0f, 0f, 32f, 15f, 29.04267f, 16f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iParam1->f_23[3], -5236.606f, -2903.367f, 5.742976f, 0f, 0f, 39.69689f, 87.08837f, 25f, 10.78486f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iParam1->f_23[3], -5257.652f, -2934.396f, 2.317132f, 0f, 0f, 57.00001f, 40f, 10f, 16f);
	...
	else
	{
		...
		iParam1->f_23[0] = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("volKill");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iParam1->f_23[0], -5214.194f, -2804.46f, -44.46426f, 0f, 0f, -90.76098f, 220.1892f, 335.8115f, 240.5904f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iParam1->f_23[0], -5176.354f, -3019.191f, 8.75246f, 0f, 0f, -69.9966f, 227.4959f, 341.2541f, 107.3552f);
		iParam1->f_23[3] = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("volMainArea");
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iParam1->f_23[3], -5278.532f, -2944.601f, 3.422212f, 0f, 0f, 5f, 15f, 42.26341f, 16f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iParam1->f_23[3], -5242.652f, -2908.386f, 5.742976f, 0f, 0f, 39.69689f, 87.08837f, 25f, 10.78486f);
		VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(iParam1->f_23[3], -5265.094f, -2938.326f, 2.317132f, 0f, 0f, 57f, 40f, 10f, 16f);
...
int func_447(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_530(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
bool func_544(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_371(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
struct<5> /*40*/ func_628(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_701(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_630(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_630(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_631(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_632(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_710(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
struct<4> /*32*/ func_702(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_632(923904168, func_700(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_704(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_632(271701509, func_700(bParam0), 12999093, 0) };
		}
...
bool func_714(struct<4> /*32*/ sParam0, int iParam4)
{
	struct<11> /*88*/ sVar0;
...
int func_718(struct<4> /*32*/ sParam0, struct<4> /*32*/ sParam4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	Var16.f_11 = iParam8;
	Var16.f_10 = bParam10;
	iVar33 = func_733(1168099063, &Var16, bParam9);
	if (iVar33 == -1)
	{
		return -1;
	}
...
int func_720(struct<4> /*32*/ sParam0, struct<4> /*32*/ sParam4, int iParam8, bool bParam9)
{
	...
	if (bParam9)
	{
		...
		{
			if (func_734(iVar62, 1168099063, &Var28) && func_734(iVar62, 1168099063, &Var45))
			{
	...
	{
		iVar62 = func_733(1168099063, &Var28, 0);
		iVar62 = func_733(1168099063, &Var45, 0);
	}
	return iVar62;
}
...
int func_730(struct<4> /*32*/ sParam0, int iParam4, bool bParam5)
{
	int iVar0;
	struct<11> /*88*/ sVar1;
	int iVar15;
	...
	{
		Var45 = { func_740(Param0, 1) };
		Var45.f_10 = iParam4;
		iVar0 = func_741(joaat("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var63 = { func_732(&Var1) };
		Var63.f_10 = iParam4;
		iVar0 = func_733(joaat("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
struct<29> /*232*/ func_738(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	Var29.f_9 = -1591664384;
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_710(bParam4), &uParam0, &Var29, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_732(&Var29) };
...
struct<18> /*144*/ func_740(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_710(bParam4), &uParam0, &Var18, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_732(&Var18) };
