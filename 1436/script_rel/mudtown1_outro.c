...
int func_25(var uParam0)
{
	...
	if (func_21(&uLocal_25, &cLocal_268, 1, 1))
	{
		...
		MISC::SET_WEATHER_TYPE(joaat("CLOUDS"), true, true, false, 0f, false);
...
int func_33(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_160(iParam0, 1248798204))
		{
			...
			if (iVar8 != 0)
			{
				func_33(iVar8, 1, 1, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
			}
		}
		switch (iParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER"):
				...
				if (func_196(&iVar9, 0))
				{
					func_170(iVar9, 0, 0, bParam4, 3, 0, joaat("ADD_REASON_DEFAULT"), 0);
				}
				break;
...
int func_127(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != Global_1946054.f_57[func_363(iParam3, 1) /*11*/])
			{
				func_366(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_367(32768) && iParam1 != Global_1946054.f_57[func_363(iParam3, 1) /*11*/])
			{
				func_368();
...
void func_217(int iParam0)
{
	...
	if ((iParam0 == joaat("CLOTHING_SP_OFFHAND_000") || iParam0 == -1515874150) || iParam0 == joaat("UPGRADE_OFFHAND_HOLSTER"))
	{
		...
		if (func_196(&iVar2, 0))
		{
			func_170(iVar2, 0, 0, 1, 3, 0, joaat("ADD_REASON_DEFAULT"), 0);
		}
	}
}
...
struct<2> /*16*/ func_220(int iParam0)
{
	struct<2> /*16*/ sVar0;
	struct<2> /*16*/ sVar2;
...
void func_222(int iParam0, char* sParam1)
{
	...
	func_516(MISC::VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_515(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
int func_293(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	if (iParam0 == Global_35)
	{
		func_170(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
struct<5> /*40*/ func_361(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_159(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_444(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_444(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_445(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
bool func_364(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_160(iParam0, 866047851) && func_672(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_367(32768) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
	...
	func_677(&(Global_1946054.f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946054.f_1378.f_1[iParam2 /*3*/] = iParam0;
	Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1 = func_678(iParam0, iParam2, iParam1, func_167() != -1);
	if (bParam4)
	{
...
struct<4> /*32*/ func_371(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
int func_372(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	var uVar4;
...
{
	return (Global_1946054.f_57[func_363(iParam0, 1) /*11*/].f_10 && iParam1) != 0;
}
...
bool func_416(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_409(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_445(iParam0, &Var4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_667(iParam0, 1))
			{
				if (!func_444(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_445(iParam0, &Var4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
int func_419(int iParam0, bool bParam1)
{
	...
	if (!func_735(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_494(iVar18);
		...
		case 24:
			...
			if (func_167() == -1)
			{
				if (!func_508(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) || func_771(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					...
					{
						func_216(iVar0, 1, joaat("ADD_REASON_DEFAULT"));
					}
...
bool func_454(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_160(iParam1, 866047851))
	{
		...
		if (func_672(&(Global_1946054.f_1497)) >= 2 && Global_1946054.f_1497.f_1[iVar5 /*3*/] != iVar8)
		{
	...
	switch (iVar4)
	{
		...
		case -1944638739:
			iVar5 = 35;
			if (Global_1946054.f_1497.f_1[iVar5 /*3*/] != Global_1946054.f_57[iVar5 /*11*/] && func_160(iParam1, -1638171711))
			{
		...
		case 1788623170:
			...
			else
			{
				...
				iVar9 = func_778(Global_1946054.f_1497.f_1[iVar5 /*3*/], iVar4, iVar2, bVar1);
    ...
    "" */
				...
				iVar5 = 36;
				iVar6 = 35;
				if (iParam1 != Global_1946054.f_57[iVar6 /*11*/] && func_160(Global_1946054.f_1497.f_1[iVar5 /*3*/], -1638171711))
				{
				...
				{
					if (iParam1 != Global_1946054.f_57[iVar6 /*11*/] && func_779(Global_1946054.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = joaat("MPC_ACTION_NOT_AVAILABLE_BOOTS_DO_NOT_SUPPORT_THIS");
						return false;
					}
...
int func_472()
{
	...
	while (iVar1 < 30)
	{
		if (func_786(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_635(bool bParam0, bool bParam1)
{
	if (!func_891(Global_43801))
	{
		Global_43801 = func_895("CUTSCENE_SKIP", joaat("INPUT_SKIP_CUTSCENE"), 5, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("LONG_TIMED_EVENT"), 0);
...
{
	return func_371(joaat("CHARACTER"), func_912(), -1591664384, bParam0);
}
...
struct<4> /*32*/ func_666(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_371(923904168, func_665(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_668(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_371(271701509, func_665(bParam0), 12999093, 0) };
		}
...
int func_672(var uParam0)
{
	...
	iVar0 = 0;
	iVar1 = 22;
	if (uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/] && func_160(uParam0->f_1[iVar1 /*3*/], 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_779(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_164(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
void func_679(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_376(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946054.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
{
	if (func_943(iParam0, joaat("DEFAULT")) == 0)
	{
		return false;
	}
	return true;
...
struct<18> /*144*/ func_733(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
int func_747()
{
	...
	while (iVar1 < 30)
	{
		if (func_955(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_778(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam0 == Global_1946054.f_57[func_363(iParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
...
int func_829(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_492("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_976(iParam1, 512) && func_773(Var4.f_4, &uVar19, &Var23, joaat("SLOTID_WEAPON_0"))) && !Var23.f_21)
			{
			}
...
int func_895(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	int iVar0;
	int iVar1;
	...
	if (iVar1 != 0)
	{
		func_1031(iVar1, iParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, bParam4, iParam5, bParam6, iParam7, iParam8, iParam9, 0, 0, iParam11, bParam12);
		return iVar1;
	}
	return 0;
}
...
void func_1068(int iParam0)
{
	...
	while (iVar0 < Global_1946054.f_2657.f_19)
	{
		...
		{
			func_1106(&(Global_1946054.f_2657.f_26.f_26), iVar2, iVar0);
		}
		if (func_1107(iVar2, 0))
		{
			func_128(iVar2, Global_1946054.f_1497.f_1[iVar1 /*3*/] == Global_1946054.f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_1069(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		case -2061583405:
			bVar1 = func_1109(iParam0, &(Global_1946054.f_2657.f_21), Global_1946054.f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_1109(iParam0, &(Global_1946054.f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_1109(iParam0, &(Global_1946054.f_2657.f_20), Global_1946054.f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_1109(iParam0, &(Global_1946054.f_2657.f_22), Global_1946054.f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_1109(iParam0, &(Global_1946054.f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_1109(iParam0, &(Global_1946054.f_2657.f_24), 1, bParam1);
			break;
...
bool func_1077(struct<4> /*32*/ sParam0, int iParam4)
{
	struct<11> /*88*/ sVar0;
...
void func_1104(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case -2061583405:
			bVar0 = func_1138(iParam0, &(Global_1946054.f_2657.f_21));
			break;
		case 81053684:
			bVar0 = func_1138(iParam0, &(Global_1946054.f_2657.f_23));
			break;
		case -999503751:
			bVar0 = func_1138(iParam0, &(Global_1946054.f_2657.f_20));
			break;
		case -525676072:
			bVar0 = func_1138(iParam0, &(Global_1946054.f_2657.f_22));
			break;
		case -1719060085:
			bVar0 = func_1138(iParam0, &(Global_1946054.f_2657.f_24));
			break;
		case -413129408:
			bVar0 = func_1138(iParam0, &(Global_1946054.f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
int func_1109(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	{
		func_1106(&(Global_1946054.f_2657.f_26.f_26), iParam0, Global_1946054.f_2657.f_19);
	}
...
int func_1127(struct<4> /*32*/ sParam0, int iParam4, bool bParam5)
{
	int iVar0;
	struct<11> /*88*/ sVar1;
	int iVar15;
