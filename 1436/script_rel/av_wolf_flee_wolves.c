					...
					if (ANIMSCENE::IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (!uParam0->f_469[3])
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("ENDSINRUN")))
									{
										...
										{
											TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 3, 256, -1082130432 /* Float: -1f */, -1, 0);
							...
							if (!uParam0->f_469[5])
							{
								...
								{
									TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[2 /*14*/], joaat("WORLD_ANIMAL_WOLF_EATING"), 70000, false, 0, -1f, false);
							...
							if (!uParam0->f_469[6])
							{
								...
								{
									TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[3 /*14*/], joaat("WORLD_ANIMAL_WOLF_EATING"), 70000, false, 0, -1f, false);
	...
	while (iVar0 <= 3)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			if (iVar0 == 0)
			{
				...
				{
					TASK::TASK_FLEE_PED(uParam0->f_20[iVar0 /*14*/], Global_35, 4, 256, -1082130432 /* Float: -1f */, -1, 0);
