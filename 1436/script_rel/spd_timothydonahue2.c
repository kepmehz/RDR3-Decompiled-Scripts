...
void main()
{
	...
	while (true)
	{
		...
		else
		{
			...
			if (VOLUME::DOES_VOLUME_EXIST(bLocal_179) && func_8(Global_35, bLocal_179, 1, 0))
			{
			...
			if (VOLUME::DOES_VOLUME_EXIST(bLocal_180))
			{
				...
				case 28:
					...
					if (func_19(iLocal_190, 2) && !func_19(iLocal_190, 4))
					{
						if (func_19(iLocal_190, 16))
						{
							...
							if (VOLUME::DOES_VOLUME_EXIST(bLocal_179))
							{
				...
				case 33:
					if (!ENTITY::IS_ENTITY_DEAD(uLocal_173[0]) && !ENTITY::IS_ENTITY_DEAD(Global_35))
					{
						...
						if (!func_19(iLocal_190, 128))
						{
							...
							{
								TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("spd_tmd_escape", false, 1065353216 /* Float: 1f */, 0.5f, 1);
								func_21(&iLocal_190, 128);
							}
							else
							{
								TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(uLocal_173[0], 2.1f, 0, -1082130432 /* Float: -1f */, 0);
								TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("spd_tmd_escape", true, 1065353216 /* Float: 1f */, 0.9f, 1);
							}
						}
						else
						{
							...
							{
								TASK::TASK_FLEE_PED(uLocal_173[0], Global_35, 3, 0, -1082130432 /* Float: -1f */, -1, false);
...
void func_1(bool bParam0, bool bParam1)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(bLocal_181))
	{
...
{
	if (VOLUME::DOES_VOLUME_EXIST(iParam0) && VOLUME::DOES_VOLUME_EXIST(bParam1))
	{
...
void func_30()
{
	...
	if (!VOLUME::DOES_VOLUME_EXIST(bLocal_184))
	{
...
bool func_147(bool bParam0, bool bParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
bool func_213(int iParam0, vector3 vParam1, bool bParam4)
{
...
bool func_214(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_218(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_220(bool bParam0, var uParam1)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_221(bool bParam0, bool bParam1, var uParam2)
{
	float fVar0;
	float fVar1;
...
bool func_222(bool bParam0, var uParam1)
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
bool func_225(var uParam0, bool bParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_226(var uParam0, bool bParam1, var uParam2)
{
	var uVar0;
...
bool func_227(var uParam0, bool bParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
bool func_229(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_236(var uParam0, bool bParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_313(iVar0, bParam1, vVar1))
		{
...
bool func_240(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_294(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_312(bVar0, bParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_313(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_437(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
	if (!bParam3)
	{
		return false;
