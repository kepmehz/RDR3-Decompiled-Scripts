...
int func_255(var uParam0, var uParam1, char* sParam2, bool bParam3)
{
	...
	if (TASK::IS_PED_ACTIVE_IN_SCENARIO(bVar35, 0) || ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(bVar35, -1))
	{
		ANIMSCENE::_0xBC781D24AA11F179(bVar35);
		PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(bVar35);
		TASK::CLEAR_PED_TASKS(bVar35, true, false);
	}
	PED::SET_PED_CAN_LEG_IK(bVar35, false);
	TASK::TASK_MOVE_NETWORK_BY_NAME_WITH_INIT_PARAMS(bVar35, "SCRIPT_MINI_GAME_DOMINOES", &Var1, 0.125f, false, 0, 128);
	...
	if (bParam3)
	{
		...
		{
			PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(bVar35, false, false);
		}
	}
	return 1;
}
