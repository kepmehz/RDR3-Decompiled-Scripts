				...
				if (!func_48(134))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_12[1], 242628503, true) == 8 || (TASK::GET_SCRIPT_TASK_STATUS(uLocal_12[1], 242628503, true) == 1 && func_49(uLocal_12[1], 675.2244f, -1246.993f, 42.726f, (0.25f * 6f), 1, 1)))
					{
						if (ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_3) && ANIMSCENE::IS_ANIM_SCENE_LOADED(iLocal_3, true, false))
						{
							...
							TASK::TASK_ENTER_ANIM_SCENE(uLocal_12[1], iLocal_3, "cs_hoseamatthews", "pbl_drop", 1.48f, true, 9, 20000, -1082130432 /* Float: -1f */);
							func_22(&iLocal_4, 16);
						}
					}
				}
...
int func_127(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_147(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
struct<5> /*40*/ func_154(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_165(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_156(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_156(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_157(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_166(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_158(923904168, func_164(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_168(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_158(271701509, func_164(bParam0), 12999093, 0) };
		}
