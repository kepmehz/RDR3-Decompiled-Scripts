		...
		case 0:
			...
			if (func_71(uParam0->f_20[0 /*14*/], 0))
			{
				...
				else
				{
					...
					TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[0 /*14*/], joaat("WORLD_HUMAN_CROUCH_INSPECT"), 0, false, 0, -1f, false);
		...
		case 1:
			if (func_75(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				if (func_71(uParam0->f_20[1 /*14*/], 0))
				{
					...
					{
						TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[1 /*14*/], joaat("WORLD_ANIMAL_DOG_GUARD_GROWL"), 0, true, 0, -1f, false);
					}
				}
				func_78(&uLocal_99);
				iLocal_11 = 3;
...
bool func_194(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_211(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
