...
bool func_6(var uParam0)
{
	...
	return (ENTITY::DOES_ENTITY_EXIST(bLocal_9) && HUD::TEXT_BLOCK_IS_LOADED("IND3AUD"));
}
...
int func_23(var uParam0)
{
	...
	TASK::TASK_USE_SCENARIO_POINT(bLocal_9, iLocal_10, 0, -1, false, true, 0, false, -1f, false);
...
bool func_66(bool bParam0, int iParam1, float fParam2, bool bParam3)
{
