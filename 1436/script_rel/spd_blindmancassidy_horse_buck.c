...
bool func_3(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_9()
{
	...
	TASK::TASK_FLEE_PED(bLocal_15, Global_35, 3, 0, -1f, -1, false);
	return false;
}
...
bool func_37(var uParam0, vector3 vParam1, bool bParam4)
{
...
bool func_38(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
