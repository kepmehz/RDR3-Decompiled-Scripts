...
{
	iLocal_65 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(func_172(uParam0, iLocal_17), joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER"), 0f, 0f, 0.5f, -180f, 0, 0, 0);
	iLocal_66 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(func_172(uParam0, iLocal_18), joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY"), 0f, 0f, 0.5f, -180f, 0, 0, 0);
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(bVar0, 0))
	{
		if (func_120(PED::_GET_RIDER_OF_MOUNT(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
bool func_372(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	bool bVar0;
...
void func_429(bool bParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_213(iParam1), bParam0, false);
...
int func_456(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_474(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
struct<5> /*40*/ func_481(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_493(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_483(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_483(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_484(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_494(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_485(923904168, func_492(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_496(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_485(271701509, func_492(bParam0), 12999093, 0) };
		}
