...
int func_275(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_408(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
void func_299()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(uLocal_15[iVar0], 0, 0))
		{
			...
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_15[iVar0], vVar3, 4f, 1, false, 0);
...
void func_301()
{
	...
	if (func_61(uLocal_15[0], 0, 1))
	{
		...
		PED::SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_15[0], vVar0, func_431(&Local_274, 0), 1, false, 0);
	}
	...
	if (func_61(uLocal_15[1], 0, 1))
	{
		...
		PED::SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_15[1], vVar0, func_431(&Local_274, 1), 1, false, 0);
	}
	if (func_61(uLocal_15[2], 0, 0))
	{
		PED::SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_15[2], func_429(&Local_274, 2), func_431(&Local_274, 2), 1, false, 0);
...
void func_325(int iParam0, float fParam1)
{
	...
	PED::SET_PED_SPHERE_DEFENSIVE_AREA(uLocal_15[iParam0], ENTITY::GET_ENTITY_COORDS(uLocal_15[iParam0], false, false), func_431(&Local_274, iParam0), 1, false, 0);
}
...
struct<4> /*32*/ func_547(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_466(923904168, func_545(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_549(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_466(271701509, func_545(bParam0), 12999093, 0) };
		}
...
bool func_722(struct<4> /*32*/ sParam0, int iParam4)
{
	struct<11> /*88*/ sVar0;
...
int func_737(struct<4> /*32*/ sParam0, int iParam4, bool bParam5)
{
	int iVar0;
	struct<11> /*88*/ sVar1;
	int iVar15;
