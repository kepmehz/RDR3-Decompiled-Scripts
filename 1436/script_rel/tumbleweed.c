...
bool func_11()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_215, -5486.887f, -2936.958f, -0.631974f, 0f, 0f, 37.50568f, 12.05108f, 6.394965f, 4.543615f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_215, -5479.758f, -2933.356f, -0.464321f, 0f, 0f, 37.59521f, 2.825781f, 2.131215f, 1.882721f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_226, -5529.713f, -2927.539f, -1.328089f, 0f, 0f, 24.83998f, 6.747131f, 6.870256f, 6.016601f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_226, -5534.146f, -2922.72f, -1.771596f, 0f, 0f, 24.83998f, 10.62026f, 7.054735f, 6.016601f);
...
void func_72()
{
	...
	{
		if (((!bLocal_233 && !func_165(iVar0, 0)) && AUDIO::_0xBE28DB99556FF8D9(bVar1) != 0) && PED::IS_PED_USING_SCENARIO_HASH(bVar1, joaat("PROP_HUMAN_PIANO")))
		{
		...
		else if (bLocal_233 && !PED::IS_PED_USING_SCENARIO_HASH(bVar1, joaat("PROP_HUMAN_PIANO")))
		{
			bLocal_233 = false;
		}
	}
