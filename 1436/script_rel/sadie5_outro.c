...
int func_21(var uParam0)
{
	...
	if (func_45(Global_1835011[72 /*74*/].f_1) == 0)
	{
		...
		PED::_SET_PED_PROMPT_NAME_FROM_GXT_ENTRY(bLocal_15, joaat("SAD5_FINLEY"));
	}
	return 1;
}
		...
		case 0:
			...
			if (func_99(PLAYER::PLAYER_ID(), bLocal_15))
			{
				if (!func_100(iLocal_117[0]))
				{
					...
					func_102(iLocal_117[0], bLocal_15, 0, 0, 1);
				}
				if (!func_100(iLocal_117[1]))
				{
					...
					func_102(iLocal_117[1], bLocal_15, 0, 0, 1);
				}
				if (iLocal_121 > 2)
				{
...
bool func_91(var uParam0, bool bParam1, char* sParam2)
{
	bool bVar0;
	int iVar1;
...
void func_92(bool bParam0, char* sParam1, float fParam2, int iParam3, float fParam4, int iParam5)
{
	int iVar0;
	bool bVar1;
	...
	if ((ENTITY::DOES_ENTITY_EXIST(bParam0) && !ENTITY::IS_ENTITY_DEAD(bParam0)) && fParam2 > 0f)
	{
		...
		MISC::REGISTER_INTERACTION_LOCKON_PROMPT(bParam0, sParam1, fParam2, fParam4, iParam5, 0f, 0f, 0, false, -1);
	}
}
...
bool func_95(int iParam0, bool bParam1, float fParam2, bool bParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return false;
...
bool func_99(int iParam0, bool bParam1)
{
	...
	{
		if (((PLAYER::GET_PLAYER_INTERACTION_TARGET_ENTITY(iParam0, &bVar0, false, false) && ENTITY::DOES_ENTITY_EXIST(bVar0)) && bVar0 == bParam1) || ((PLAYER::_0xBEA3A6E5F5F79A6F(iParam0, &bVar0) && ENTITY::DOES_ENTITY_EXIST(bVar0)) && bVar0 == bParam1))
		{
			return true;
		}
	}
...
void func_102(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	HUD::_UIPROMPT_SET_GROUP(Global_1945188[iVar0 /*18*/].f_3, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(bParam1), iParam2);
}
...
bool func_103(int iParam0)
{
	...
	iVar0 = func_151(iParam0);
	return !HUD::_UIPROMPT_IS_ENABLED(Global_1945188[iVar0 /*18*/].f_3);
}
...
int func_140(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_181(iVar0, iParam9, bParam2, bParam5, bParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
int func_181(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> /*32*/ sVar0;
	int iVar5;
	struct<10> /*80*/ sVar6;
...
struct<5> /*40*/ func_192(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_203(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_194(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_194(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_195(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_204(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_196(923904168, func_202(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_206(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_196(271701509, func_202(bParam0), 12999093, 0) };
		}
...
int func_210(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	var uVar4;
