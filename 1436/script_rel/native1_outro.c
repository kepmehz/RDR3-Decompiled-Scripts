...
{
	bLocal_14 = func_43(joaat("CS_RAINSFALL"), 1584.673f, 1460.016f, 145.623f, 240.1411f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_14, joaat("REL_GANG_DUTCHS"));
	PED::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT(bLocal_14, false);
	func_44(1);
	return 1;
}
