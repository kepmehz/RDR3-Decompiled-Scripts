...
bool func_94(var uParam0)
{
	...
	if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_95))
	{
		...
		{
			iLocal_95 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(func_50(uParam0, iLocal_39), joaat("PROP_PLAYER_SEAT_CHAIR_GENERIC"), 0f, 0f, 0.5f, -180f, 0, 0, 0);
...
bool func_437(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	bool bVar0;
...
int func_521(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_539(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
struct<4> /*32*/ func_559(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_550(923904168, func_557(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_561(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_550(271701509, func_557(bParam0), 12999093, 0) };
		}
