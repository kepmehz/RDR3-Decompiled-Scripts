#region Local Variables
	...
	int iLocal_23 = 0;
	int iLocal_24 = 0;
	bool bLocal_25[5] = { false, false, false, false, false };
...
int func_48()
{
	...
	switch (iLocal_22)
	{
		...
		case 2:
			...
			while (iVar0 < 5)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(bLocal_25[iVar0]))
				{
					bLocal_25[iVar0] = func_84(iLocal_49[iVar0], vLocal_61[iVar0 /*3*/], 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
					PED::_SET_PED_SCALE(bLocal_25[iVar0], 1f);
					ENTITY::SET_ENTITY_COORDS(bLocal_25[iVar0], vLocal_61[iVar0 /*3*/], false, false, true, true);
					ENTITY::FREEZE_ENTITY_POSITION(bLocal_25[iVar0], true);
					return 0;
				}
				iVar0++;
			}
		...
		case 3:
			...
			while (iVar0 < 5)
			{
				if (!ENTITY::IS_ENTITY_DEAD(bLocal_25[iVar0]))
				{
					return 0;
				}
				iVar0++;
		...
		case 5:
			...
			while (iVar0 < 5)
			{
				if (ENTITY::DOES_ENTITY_EXIST(bLocal_25[iVar0]) && !MISC::_IS_PED_DECOMPOSED(bLocal_25[iVar0]))
				{
					if (ENTITY::IS_ENTITY_DEAD(bLocal_25[iVar0]))
					{
						PED::APPLY_PED_DAMAGE_PACK(bLocal_25[iVar0], sLocal_55[iVar0], 0f, 1f);
						MISC::SET_PED_DECOMPOSED(bLocal_25[iVar0], true);
					}
					else
					{
						bVar2 = false;
...
void func_78(int iParam0)
{
	...
	if (func_20() == -1)
	{
		...
		while (iVar0 < 5)
		{
			if (ENTITY::DOES_ENTITY_EXIST(bLocal_25[iVar0]))
			{
				PED::DELETE_PED(&(bLocal_25[iVar0]));
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_37[iVar0]))
			{
...
int func_86(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_37[iParam0]))
	{
		if (ENTITY::DOES_ENTITY_HAVE_PHYSICS(iLocal_43[iParam0]))
		{
			...
			ENTITY::ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(iLocal_43[iParam0], bLocal_25[iParam0], 4, PED::GET_PED_BONE_INDEX(bLocal_25[iParam0], iVar9), vVar3, vVar6, vVar0, -1f, 0, 1, 0, 0, 0, 1, 1065353216 /* Float: 1f */, 1065353216 /* Float: 1f */);
			iLocal_31[iParam0] = PHYSICS::_ADD_ROPE_2(vLocal_77[iParam0 /*3*/], 0f, 0f, 0f, fLocal_93[iParam0], 1, false, 1, -1f);
			ENTITY::FREEZE_ENTITY_POSITION(bLocal_25[iParam0], false);
			...
			PED::SET_PED_TO_RAGDOLL(bLocal_25[iParam0], 1000, 60000, 0, false, true, false);
			return 1;
		}
	}
	return 0;
