...
void func_34(int iParam0, bool bParam1)
{
	if (MAP::DOES_BLIP_EXIST(iParam0->f_41))
	{
		if (bParam1)
		{
			MAP::BLIP_ADD_MODIFIER(iParam0->f_41, 724623647);
		}
		else
		{
			MAP::BLIP_REMOVE_MODIFIER(iParam0->f_41, 724623647);
			MAP::REMOVE_BLIP(&(iParam0->f_41));
		}
	}
}
...
void func_38(int iParam0, vector3 vParam1, bool bParam4)
{
	...
	if (!MAP::DOES_BLIP_EXIST(iParam0->f_41))
	{
		...
		if (bParam4)
		{
			MAP::BLIP_ADD_MODIFIER(iParam0->f_41, -401963276);
		}
	}
	else
	{
			...
			if (iVar65 != -1)
			{
				...
				while (iVar66 < iVar64)
				{
					...
					if (func_159(iVar67, 0) && iVar67 != iParam0)
					{
						if (bParam4)
						{
							iVar53 = (iVar53 + func_53(iVar67, -915411861, 1, 0, 0));
						}
						else
						{
							Var35 = iVar67;
...
int func_83(int iParam0)
{
	...
	switch (iLocal_301)
	{
		...
		case 7:
			...
			{
				if (ANIMSCENE::GET_ANIM_SCENE_PHASE(iParam0->f_69) > 0f && ANIMSCENE::IS_ANIM_SCENE_RUNNING(iParam0->f_69, false))
				{
					if (iLocal_28 == 0)
					{
...
bool func_95(int iParam0, int iParam1)
{
	...
	func_220(&(Global_1946054.f_964), iVar0, iParam0, -897569541, 1, iParam1);
...
int func_214(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if ((bParam3 && func_319(iParam1, 4096)) && Global_1946054.f_1497 == iParam4)
	{
		return 1;
	}
...
void func_233(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_9(32768) && Global_1946054.f_1378.f_1[10 /*3*/] != Global_1946054.f_57[10 /*11*/])
	{
		func_11();
	}
...
int func_327(int iParam0)
{
	...
	func_220(&(Global_1946054.f_964), iVar0, -367421157, 1409451727, 1, iParam0);
	DATAFILE::_0x91DED5DD64BB2691(&(Global_1946054.f_964));
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_401(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_398(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_333(iVar3, 6) || uParam0->f_1[iVar1 /*3*/] == Global_1946054.f_57[iVar1 /*11*/]) || uParam0->f_1[iVar1 /*3*/].f_1 == 289238755)
				{
