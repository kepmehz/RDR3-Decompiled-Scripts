...
bool func_179(var uParam0)
{
	...
	{
		func_180(bVar0, func_164(uParam0, 0), func_165(uParam0, 0), 2, 1073741824 /* Float: 2f */);
...
int func_372(int iParam0, bool bParam1)
{
	...
	if (!func_430(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_371(iVar18);
...
struct<4> /*32*/ func_428(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_479(923904168, func_478(bParam0), -740156546, 0) };
		}
...
bool func_480(struct<4> /*32*/ sParam0, int iParam4)
{
	struct<11> /*88*/ sVar0;
...
int func_504(struct<4> /*32*/ sParam0, int iParam4, bool bParam5)
{
	int iVar0;
	struct<11> /*88*/ sVar1;
	int iVar15;
	...
	if (iVar15 == joaat("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_516(joaat("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == joaat("CLOTHING"))
	{
		...
		Var45.f_10 = iParam4;
		iVar0 = func_518(joaat("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var63 = { func_507(&Var1) };
		Var63.f_10 = iParam4;
		iVar0 = func_508(joaat("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
