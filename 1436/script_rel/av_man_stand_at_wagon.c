	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], joaat("WEAPON_REPEATER_CARBINE"), 500, true, false, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), true, 0f, false);
		...
		case 1:
			...
			break;
		case 2:
			IK::_0x66F9EB44342BB4C5(uParam0->f_20[0 /*14*/], &Local_39);
			break;
	}
	return 0;
}
...
bool func_177(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_194(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
