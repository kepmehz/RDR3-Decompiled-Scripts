		...
		if (!Global_1879534)
		{
			...
			switch (iLocal_14)
			{
				...
				case 4:
					...
					break;
				case 5:
					if ((!TASK::DOES_SCENARIO_POINT_EXIST(uParam1->f_9) || !PED::IS_PED_USING_THIS_SCENARIO(uParam1->f_6, uParam1->f_9)) || func_50(Global_35, uParam1->f_6, 1, 1) > 50f)
					{
						func_2(uParam1, uParam0->f_2);
					}
					break;
...
void func_16(var uParam0, var uParam1)
{
	...
	if (iLocal_14 >= 1 && iLocal_144 < 4)
	{
		...
		if (iLocal_14 >= 2)
		{
			...
			{
				if ((((PED::IS_PED_DEAD_OR_DYING(uParam0->f_6, true) || func_70(uParam0->f_6, Global_35)) || PED::IS_PED_LASSOED(uParam0->f_6)) || func_71(PLAYER::PLAYER_ID(), 0, 0, 1)) || PED::_0x331550B212014B92(uParam0->f_6, Global_35))
				{
					func_31(4);
				}
...
void func_35(var uParam0, var uParam1)
{
	if (uParam0->f_2)
	{
		if (!TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_4))
		{
			uParam0->f_4 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_PLAYER_INSPECT_POSTER_144CM_W32_2_H48_2_FOLD_VH_P_CS_WANTEDALIVE01X"), func_28(uParam1->f_1), func_97(uParam1->f_1), 1f, 0, 1);
			if (func_29())
			{
				TASK::_SET_SCENARIO_POINT_ACTIVE(uParam0->f_4, false);
			}
	...
	if (func_143(uParam0))
	{
		if (func_144(uParam0, uParam1))
		{
			if (!TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_9))
			{
				...
				if (*uParam1 == 12)
				{
					uParam0->f_9 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_HUMAN_SHOPKEEPER"), 2510.472f, -1308.54f, 47.954f, 275.9725f, 0f, 0, 1);
				}
				else if (func_146(uParam1))
				{
					uParam0->f_9 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(uParam0->f_7, joaat("SC_BOUNTY_HUNTER_SHERIFF"), 0.0086562f, 0.0409636f, 0.5f, 179.9999f, 0, 0, 1);
				}
				else
				{
					uParam0->f_9 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("SC_BOUNTY_HUNTER_SHERIFF"), func_147(), func_148(), 0f, 0, 0);
				}
	...
	switch (iParam0)
	{
		...
		case 38:
			*uParam1 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Blackwater Sheriff Office");
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(*uParam1, -763.0246f, -1269.283f, 43.6176f, 0f, 0f, 0f, 12.03637f, 8.528987f, 5.107259f);
			VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(*uParam1, -764.7173f, -1263.493f, 43.76242f, 0f, 0f, 0f, 7.664316f, 3.774002f, 5.107259f);
			break;
		case 115:
...
void func_155(var uParam0)
{
	if (!PED::IS_PED_USING_THIS_SCENARIO(uParam0->f_6, uParam0->f_9))
	{
		...
		TASK::TASK_POLICE(uParam0->f_6, true);
		TASK::TASK_USE_SCENARIO_POINT(uParam0->f_6, uParam0->f_9, func_226(&Local_136, 10), -1, false, true, 0, false, -1f, false);
...
bool func_165(var uParam0, var uParam1)
{
	...
	if (!TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_9))
	{
		iVar0 = TASK::FIND_SCENARIO_OF_TYPE_HASH(func_95(uParam1), joaat("WORLD_HUMAN_SHOPKEEPER"), 1f, 0, true);
		uParam0->f_9 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_HUMAN_SHOPKEEPER"), TASK::_GET_SCENARIO_POINT_COORDS(iVar0, true), TASK::_GET_SCENARIO_POINT_HEADING(iVar0, true), 0f, -1f, 0);
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(uParam0->f_6, false, true);
	}
	if (TASK::DOES_SCENARIO_POINT_EXIST(uParam0->f_9))
	{
		if (!PED::IS_PED_USING_THIS_SCENARIO(uParam0->f_6, uParam0->f_9))
		{
			TASK::TASK_USE_SCENARIO_POINT(uParam0->f_6, uParam0->f_9, func_226(uParam1, 10), -1, false, true, 0, false, -1f, false);
			return true;
		}
		else
		{
...
int func_201(int iParam0, bool bParam1)
{
	...
	if (!func_299(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_300(iVar18);
...
struct<4> /*32*/ func_297(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_397(923904168, func_396(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_397(923904168, func_396(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_397(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::INVENTORY_GET_GUID_FROM_ITEMID(func_202(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
