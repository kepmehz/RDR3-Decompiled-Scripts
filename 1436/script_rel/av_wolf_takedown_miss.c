							...
							if (!uParam0->f_469[6])
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
								{
									if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
									{
										...
										TASK::TASK_FLEE_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 3, 256, -1082130432 /* Float: -1f */, -1, 0);
							...
							if (!uParam0->f_469[5])
							{
								if (ANIMSCENE::IS_ENTITY_EXITING_ANIM_SCENE_THIS_FRAME(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
									{
										...
										TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 0f, 5f, 0f, 2f, 7500, 1036831949 /* Float: 0.1f */, 1, 1, 0, 1, 1, 0);
...
void func_70(var uParam0)
{
	if (*uParam0 == 247)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		{
			...
			{
				TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, 4, 256, -1082130432 /* Float: -1f */, -1, 0);
				func_56(&(uParam0->f_20[0 /*14*/]), 0, 1);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
			}
		}
