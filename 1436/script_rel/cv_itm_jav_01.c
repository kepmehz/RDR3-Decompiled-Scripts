...
bool func_97(var uParam0)
{
	...
	{
		PED::GIVE_PED_HASH_SCENARIO_PROP(func_9(uParam0, iLocal_14), func_209(uParam0, iLocal_18), "p_Javierknife_temp_PH_R_HAND", joaat("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", 1);
		PED::GIVE_PED_HASH_SCENARIO_PROP(func_9(uParam0, iLocal_14), iLocal_34, "p_cs_rag01x_PH_L_HAND", joaat("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", 1);
	}
	return true;
}
...
bool func_395(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	bool bVar0;
...
struct<4> /*32*/ func_471(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_515(923904168, func_514(bParam0), -740156546, 0) };
		}
...
bool func_487(int iParam0, bool bParam1, bool bParam2)
{
	int iVar0;
...
void func_488(bool bParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_238(iParam1), bParam0, false);
...
int func_513(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_535(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
struct<4> /*32*/ func_554(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_515(271701509, func_514(bParam0), 12999093, 0) };
		}
