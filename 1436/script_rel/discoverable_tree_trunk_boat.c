...
void func_142(bool bParam0, vector3 vParam1, float fParam4, int iParam5, float fParam6)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (func_39(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		...
		if (PED::IS_PED_ON_VEHICLE(iVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0) && !ENTITY::IS_ENTITY_DEAD(bVar0))
			{
				...
				func_142(bVar0, vParam1, fParam4, iParam5, fParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(iVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_142(bVar2, vParam1, fParam4, iParam5, fParam6);
			}
			return;
		}
	}
...
int func_190(int iParam0, bool bParam1)
{
	...
	if (!func_199(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_189(iVar18);
...
struct<4> /*32*/ func_197(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_203(923904168, func_202(bParam0), -740156546, 0) };
		}
