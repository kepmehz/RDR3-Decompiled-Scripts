#region Local Variables
	...
	var uLocal_41 = 0;
	var uLocal_42 = 0;
	bool bLocal_43[7] = { false, false, false, false, false, false, false };
	bool bLocal_51[7] = { false, false, false, false, false, false, false };
	int iLocal_59 = 0;
...
void func_1(bool bParam0)
{
	...
	iLocal_30 = 0;
	iVar0 = 0;
	while (iVar0 < bLocal_43)
	{
		if (func_8(bLocal_43[iVar0], 0))
		{
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(bLocal_43[iVar0], -1728.259f, -2578.3f, 64.1206f, 1.75f, 20000, 0.25f, 4, 40000f);
			if (bParam0)
			{
				func_9(&(bLocal_43[iVar0]), 1, 1, 1);
				func_9(&(bLocal_51[iVar0]), 1, 1, 1);
			}
			else
			{
				if ((func_10(Global_35, bLocal_43[iVar0], 1, 1) > 20f && (!ENTITY::IS_ENTITY_ON_SCREEN(bLocal_43[iVar0]) || ENTITY::IS_ENTITY_OCCLUDED(bLocal_43[iVar0]))) || CAM::IS_SCREEN_FADED_OUT())
				{
					func_11(&(bLocal_43[iVar0]));
				}
				else
				{
					func_9(&(bLocal_43[iVar0]), 1, 1, 1);
				}
				if ((func_10(Global_35, bLocal_51[iVar0], 1, 1) > 20f && (!ENTITY::IS_ENTITY_ON_SCREEN(bLocal_51[iVar0]) || ENTITY::IS_ENTITY_OCCLUDED(bLocal_51[iVar0]))) || CAM::IS_SCREEN_FADED_OUT())
				{
					func_11(&(bLocal_51[iVar0]));
				}
				else
				{
					func_9(&(bLocal_51[iVar0]), 1, 1, 1);
...
void func_7()
{
	...
	switch (iLocal_14)
	{
		...
		case 2:
			...
			if (((((STREAMING::HAS_MODEL_LOADED(bLocal_34) && STREAMING::HAS_MODEL_LOADED(iLocal_35[0])) && STREAMING::HAS_MODEL_LOADED(iLocal_35[1])) && STREAMING::HAS_MODEL_LOADED(iLocal_35[2])) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY()) && func_29(&uLocal_40) > IntToFloat(iLocal_31))
			{
				if (func_30(13))
				{
		...
		case 4:
			...
			{
				iVar11 = 0;
				while (iVar11 < bLocal_43)
				{
					func_39(iVar11);
					func_40(bLocal_43[iVar11], bLocal_51[iVar11], 0, -1, 1);
					bVar12 = false;
					if (iVar11 == 0)
					{
					...
					if (func_8(bLocal_43[iVar11], 0))
					{
						if (func_29(&uLocal_40) < fLocal_28 || bVar0)
						{
							...
							TASK::TASK_POLICE(bLocal_43[iVar11], true);
							TASK::TASK_PERFORM_SEQUENCE(bLocal_43[iVar11], iVar10);
						}
						else if (func_8(Global_35, 0))
						{
							TASK::TASK_COMBAT_PED(bLocal_43[iVar11], Global_35, 0, 0);
						}
						func_43(&(bLocal_43[iVar11]), &iLocal_59, bVar12, 1, 1, 1, 0);
					}
					iVar11++;
				}
				iLocal_14 = 5;
		...
		case 5:
			iVar22 = 0;
			while (iVar22 < bLocal_43)
			{
				if (func_8(bLocal_43[iVar22], 0))
				{
					if (func_10(Global_35, bLocal_43[iVar22], 1, 1) > (fLocal_27 + 20f))
					{
						iVar20++;
					}
					else
					{
						iVar21 = bLocal_43[iVar22];
					}
				}
				iVar22++;
			}
...
void func_37()
{
	...
	{
		bLocal_43[iLocal_30] = func_69(bLocal_34, vLocal_24, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		iLocal_30++;
...
void func_38(int iParam0)
{
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_24, 5f))
	{
		bLocal_51[iLocal_30] = func_69(iLocal_35[iParam0], vLocal_24, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		TASK::_SET_PED_PATH_MAY_ENTER_DEEP_WATER(bLocal_51[iLocal_30], false);
		iLocal_30++;
		if (iLocal_30 >= iLocal_29)
		{
			bLocal_33 = true;
...
{
	if (!func_8(bLocal_43[iParam0], 0))
	{
		return;
	}
	PED::SET_PED_CONFIG_FLAG(bLocal_43[iParam0], 188, true);
	PED::SET_PED_CONFIG_FLAG(bLocal_43[iParam0], 527, true);
	TASK::_SET_PED_PATH_MAY_ENTER_DEEP_WATER(bLocal_43[iParam0], false);
	LAW::_0x819ADD5EF1742F47(bLocal_43[iParam0], 1);
	PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_43[iParam0], 27, true);
	PED::_0x712B2C2B2471B493(bLocal_43[iParam0], joaat("DISABLED"));
	WEAPON::SET_PED_DROPS_WEAPONS_WHEN_DEAD(bLocal_43[iParam0], false);
	WEAPON::GIVE_WEAPON_TO_PED(bLocal_43[iParam0], joaat("GROUP_SNIPER"), 100, true, false, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
}
