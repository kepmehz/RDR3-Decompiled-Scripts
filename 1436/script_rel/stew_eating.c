			...
			case 2:
				...
				if (iVar182 == joaat("EAT_STEW_BOWL_BASE") || iVar182 == joaat("EAT_STEW_BOWL_CHAIR_BASE"))
				{
					...
					if (!func_9(-1))
					{
						...
						{
							TASK::_0xB35370D5353995CB(Global_35, joaat("EAT_STEW_BOWL_EAT_FINISH_DISCARD_AUTO"), 1048576000 /* Float: 0.25f */);
						}
						else
						{
							TASK::_0xB35370D5353995CB(Global_35, joaat("EAT_STEW_BOWL_CHAIR_EAT_FINISH_DISCARD_AUTO"), 1048576000 /* Float: 0.25f */);
						}
						func_8(&Var0, 3);
					}
				}
