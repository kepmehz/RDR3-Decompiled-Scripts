...
void func_6()
{
	...
	switch (iLocal_5)
	{
		case 0:
			...
			bLocal_79 = PERSCHAR::_IS_PERSISTENT_CHARACTER_VALID(PERSCHAR::_0x32A1E3B83D501096(iLocal_72));
			if (!bLocal_79)
			{
			...
			while (iVar1 < 5)
			{
				...
				else
				{
					if (!TASK::DOES_SCENARIO_POINT_EXIST(Local_6[iVar1 /*13*/]))
					{
						...
						Local_6[iVar1 /*13*/] = TASK::CREATE_SCENARIO_POINT_HASH(Local_6[iVar1 /*13*/].f_1, Local_6[iVar1 /*13*/].f_7, Local_6[iVar1 /*13*/].f_11, 0f, 0, 0);
		...
		case 6:
			...
			if (!bLocal_79)
			{
				if (!func_20(iLocal_72, -76381094))
				{
					...
					TASK::TASK_USE_SCENARIO_POINT(iLocal_72, uLocal_80[0], 0, 0, true, false, 0, false, -1f, false);
