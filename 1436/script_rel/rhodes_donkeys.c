...
void func_1()
{
	...
	iVar0 = 0;
	while (iVar0 < bLocal_7)
	{
		if (VOLUME::DOES_VOLUME_EXIST(iLocal_58[iVar0]))
		{
			VOLUME::_DELETE_VOLUME(iLocal_58[iVar0]);
		}
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_7[iVar0]))
		{
			ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(bLocal_7[iVar0]));
		}
	...
	if (VOLUME::DOES_VOLUME_EXIST(bLocal_61))
	{
...
bool func_11()
{
	if (!STREAMING::HAS_MODEL_LOADED(bLocal_10) || !STREAMING::HAS_MODEL_LOADED(iLocal_22))
	{
		return false;
	}
...
int func_13()
{
	...
	while (iVar0 < 2)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(bLocal_7[iVar0]))
		{
			bLocal_7[iVar0] = func_42(bLocal_10, vLocal_11[iVar0 /*3*/], 95f, 1, 1, 0, 1, 0, 0, 0, 0, 0, 0);
			if (!ENTITY::IS_ENTITY_DEAD(bLocal_7[iVar0]))
			{
				PED::_SET_PED_SCALE(bLocal_7[iVar0], 0.67f);
				PED::SET_PED_CONFIG_FLAG(bLocal_7[iVar0], 136, true);
				PED::SET_PED_CONFIG_FLAG(bLocal_7[iVar0], 441, true);
				PED::SET_PED_CONFIG_FLAG(bLocal_7[iVar0], 297, true);
				PED::SET_PED_CONFIG_FLAG(bLocal_7[iVar0], 407, true);
				PED::SET_PED_CONFIG_FLAG(bLocal_7[iVar0], 419, true);
				PED::SET_PED_LASSO_HOGTIE_FLAG(bLocal_7[iVar0], 0, false);
				TASK::TASK_STAND_STILL(bLocal_7[iVar0], -1);
				PED::_SET_PED_BODY_COMPONENT(bLocal_7[iVar0], -937613161);
				PED::_UPDATE_PED_VARIATION(bLocal_7[iVar0], false, true, true, true, false);
				if (!VOLUME::DOES_VOLUME_EXIST(iLocal_58[iVar0]))
				{
					iLocal_58[iVar0] = VOLUME::_0x0EB78C2B156635B1(joaat("VOLCYLINDER"), vLocal_11[iVar0 /*3*/], 0f, 0f, 0f, 1.5f, 1.5f, 1f);
					PED::_0x7C00CFC48A782DC0(iLocal_58[iVar0], bLocal_7[iVar0], 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
				}
			}
			return 0;
		}
...
void func_16()
{
	...
	while (iVar0 < 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(bLocal_7[iVar0]))
		{
			func_47(bLocal_7[iVar0], VOLUME::_GET_VOLUME_COORDS(iLocal_57) + Vector(0f, 0f, (IntToFloat(iVar0) * 1f)), MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 360f), 2, 1073741824 /* Float: 2f */);
			TASK::TASK_WANDER_IN_VOLUME(bLocal_7[iVar0], iLocal_57, 1f, 3f, 1);
		}
		iVar0++;
	}
}
...
bool func_17()
{
	...
	while (iVar0 < 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(bLocal_7[iVar0]))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_6, sLocal_2[iVar0], bLocal_7[iVar0], 0);
		}
		iVar0++;
	}
...
bool func_18()
{
	...
	if ((!ENTITY::IS_ENTITY_DEAD(bLocal_21) && !ENTITY::IS_ENTITY_DEAD(bLocal_7[0])) && !ENTITY::IS_ENTITY_DEAD(bLocal_7[1]))
	{
		iVar0 = 0;
		while (iVar0 < 2)
		{
			if (!PHYSICS::DOES_ROPE_EXIST(iLocal_18[iVar0]))
			{
				iLocal_18[iVar0] = PHYSICS::_ADD_ROPE_2(ENTITY::GET_ENTITY_COORDS(bLocal_7[iVar0], true, false), 0f, 0f, 0f, 1f, 6, true, -1, -1f);
		...
		PHYSICS::_0x462FF2A432733A44(iLocal_18[0], bLocal_7[0], bLocal_21, 0f, 0f, 0f, 0f, 0f, 0f, "PH_Harness", "donkeyRopeConnect1");
		PHYSICS::_0x462FF2A432733A44(iLocal_18[1], bLocal_7[1], bLocal_21, 0f, 0f, 0f, 0f, 0f, 0f, "PH_Harness", "donkeyRopeConnect2");
		return true;
	}
	return false;
}
...
bool func_19()
{
	...
	{
		if (func_48(bLocal_7[iLocal_56], 0, &uLocal_28, &uVar0, 0, 0))
		{
			return true;
		}
		if (PED::IS_PED_RESPONDING_TO_THREAT(bLocal_7[iLocal_56]))
		{
			return true;
		}
		iLocal_56++;
...
void func_24()
{
	...
	while (iVar0 < 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(bLocal_7[iVar0]))
		{
			ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(iLocal_6, sLocal_2[iVar0], bLocal_7[iVar0]);
			TASK::TASK_STAND_STILL(bLocal_7[iVar0], -1);
		}
		iVar0++;
	}
...
bool func_25()
{
	...
	iVar1 = ENTITY::GET_MATCHING_ENTITIES(bLocal_61, iVar0, 2, 1, false, 0);
...
void func_26()
{
	...
	while (iVar1 < 2)
	{
		if (func_49(bLocal_7[iVar1], 0))
		{
			ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(iLocal_6, sLocal_2[iVar1], bLocal_7[iVar1]);
			if (PHYSICS::DOES_ROPE_EXIST(iLocal_18[iVar1]))
			{
				PHYSICS::DETACH_ROPE_FROM_ENTITY(iLocal_18[iVar1], bLocal_7[iVar1]);
			}
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			TASK::TASK_HORSE_ACTION(0, 1, false, 0);
			TASK::TASK_FLEE_COORD(false, Global_36, 3, 256, 10000f, 10000, 0);
			TASK::CLOSE_SEQUENCE_TASK(iVar0);
			TASK::SET_PED_DESIRED_MOVE_BLEND_RATIO(bLocal_7[iVar1], 3f);
			TASK::TASK_PERFORM_SEQUENCE(bLocal_7[iVar1], iVar0);
			PED::SET_PED_KEEP_TASK(bLocal_7[iVar1], true);
...
void func_47(bool bParam0, vector3 vParam1, float fParam4, int iParam5, float fParam6)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (func_68(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		...
		if (PED::IS_PED_ON_VEHICLE(iVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0) && !ENTITY::IS_ENTITY_DEAD(bVar0))
			{
				...
				func_47(bVar0, vParam1, fParam4, iParam5, fParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(iVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_47(bVar2, vParam1, fParam4, iParam5, fParam6);
			}
			return;
		}
	}
...
bool func_48(bool bParam0, bool bParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
bool func_70(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_74(bool bParam0, var uParam1)
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
bool func_77(var uParam0, bool bParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_78(var uParam0, bool bParam1, var uParam2)
{
	var uVar0;
...
bool func_79(var uParam0, bool bParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
bool func_80(bool bParam0, var uParam1)
{
	int iVar0;
	float fVar1;
	vector3 vVar2[2];
...
bool func_81(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_85(var uParam0, bool bParam1)
{
	if (func_135(uParam0))
	{
		return true;
...
bool func_88(var uParam0, bool bParam1)
{
	int iVar0;
	vector3 vVar1;
	int iVar4;
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_137(iVar0, bParam1, vVar1))
		{
			uParam0->f_9 = func_89();
			return true;
		}
...
bool func_91(var uParam0, bool bParam1)
{
	float fVar0;
	int iVar1;
	int iVar2;
...
bool func_93(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_112(bool bParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_118(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_136(bVar0, bParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_120(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_122(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
...
bool func_127(bool bParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_130(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_131(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_132(var uParam0, bool bParam1, float fParam2, int iParam3)
{
	float fVar0;
...
bool func_137(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_143(bool bParam0, var uParam1, bool bParam2)
{
	bool bVar0;
	bool bVar1;
...
bool func_144(var uParam0, bool bParam1)
{
	int iVar0;
...
bool func_163(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
