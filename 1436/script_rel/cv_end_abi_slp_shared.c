...
int func_115(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_128(bVar0, 0))
	{
		if (func_128(PED::_GET_RIDER_OF_MOUNT(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
int func_198(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	...
	if ((bParam3 && func_312(iParam1, 4096)) && Global_1946054.f_1497 == iParam4)
	{
		return 1;
	}
...
void func_216(bool bParam0, bool bParam1)
{
	...
	func_333(bParam0, &(Global_1946054.f_1735), bParam1, 0, 1, 1);
}
...
bool func_313(int iParam0, int iParam1)
{
	...
	func_381(&(Global_1946054.f_964), iVar0, iParam0, -897569541, 1, iParam1);
...
void func_319(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	{
		func_388(&(Global_1946054.f_1497), bParam1, 1, -1, 1, 1, 1);
	}
}
...
int func_485(int iParam0)
{
	...
	func_381(&(Global_1946054.f_964), iVar0, -367421157, 1409451727, 1, iParam0);
	DATAFILE::_0x91DED5DD64BB2691(&(Global_1946054.f_964));
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_539(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_536(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
bool func_511(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_547(iParam0));
...
void func_512(bool bParam0, int iParam1)
{
	...
	func_431(bParam0, func_548(iParam1));
...
struct<5> /*40*/ func_567(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_579(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_569(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_569(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_570(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_580(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_571(923904168, func_578(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_582(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_571(271701509, func_578(bParam0), 12999093, 0) };
		}
