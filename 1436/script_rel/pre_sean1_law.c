...
bool func_6()
{
	...
	while (iVar0 < 4)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(bLocal_5[iVar0]) && bVar5)
		{
			...
			ENTITY::_SET_ENTITY_CLEANUP_BY_ENGINE(bLocal_5[iVar0], true);
			return false;
		}
		else if (!ENTITY::DOES_ENTITY_EXIST(bLocal_0[iVar0]) && bVar5)
		{
			...
			ENTITY::_SET_ENTITY_CLEANUP_BY_ENGINE(bLocal_0[iVar0], true);
			...
			WEAPON::GIVE_WEAPON_TO_PED(bLocal_0[iVar0], func_20(4194304, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */), 500, true, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
