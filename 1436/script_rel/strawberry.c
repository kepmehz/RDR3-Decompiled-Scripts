...
bool func_11()
{
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_390, -1791.951f, -386.005f, 161.147f, 0f, 0f, -34.984f, 9.1f, 6.4f, 3.7f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_390, -1793.558f, -394.3542f, 160.6098f, 0f, 0f, -34.79824f, 2f, 4.25f, 2.559283f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_401, -1763.516f, -378.3214f, 158.2782f, 0f, 0f, -34.984f, 4.345877f, 2.597463f, 3.059408f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_401, -1766.218f, -379.3755f, 158.2782f, 0f, 0f, -34.984f, 3.121531f, 2.179444f, 3.059408f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_401, -1762.194f, -384.4291f, 158.2782f, 0f, 0f, -34.984f, 3.429085f, 5.790822f, 3.059408f);
	...
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_395, -1812.852f, -352.8134f, 163.3997f, 0f, 0f, 65.01599f, 6.286466f, 5.825926f, 7.256f);
	VOLUME::_ADD_BOX_VOLUME_TO_VOLUME_AGGREGATE(bLocal_395, -1810.468f, -349.3962f, 163.3997f, 0f, 0f, 65.01599f, 6.286466f, 7.111871f, 7.151284f);
...
void func_88(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (*iParam4)
		{
			...
			iVar1 = ENTITY::GET_MATCHING_ENTITIES(bParam2, iVar3, 1, 1, false, 0);
			iVar4 = 0;
			while (iVar4 < iVar1)
			{
				iVar5 = ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(iVar4, iVar3);
				bVar6 = MISC::_GET_PED_FROM_INDEXED_ITEM(iVar5);
				if (!func_212(bVar6))
				{
				}
...
void func_229(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_212(bParam0))
	{
		if (func_376(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
			PHYSICS::_0x0348469DAA17576C(bParam0);
		}
	}
	if (func_366(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		iVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
	...
	if (func_366(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_366(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_366(iParam5, 32), true);
	...
	else if (func_366(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_366(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_366(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
...
int func_388(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_429(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_504(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_460(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_223(bVar0, 0))
	{
		if (func_223(PED::_GET_RIDER_OF_MOUNT(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_457(iParam0)) || func_458(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_429(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
...
bool func_484(var uParam0, bool bParam1)
{
	...
	if (!func_543(bVar0, func_426(uParam0, 2048)))
	{
		return false;
	}
	if (uParam0->f_30 == 0)
...
bool func_489(var uParam0, int iParam1)
{
	...
	if (func_426(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			...
			if (func_223(bVar1, 0) && func_545(bVar1, iParam1, 1, 1) <= 4f)
			{
				uParam0->f_21 = iVar0;
				return true;
			}
...
float func_545(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
...
struct<4> /*32*/ func_566(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_528(923904168, func_564(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_528(923904168, func_564(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_568(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_528(271701509, func_564(bParam0), 12999093, 0) };
		}
...
int func_572(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	var uVar4;
