	...
	if (func_15(3))
	{
		...
		switch (iLocal_11)
		{
			...
			case 4:
				...
				{
					TASK::OPEN_SEQUENCE_TASK(&iLocal_3);
					TASK::TASK_LEAVE_VEHICLE(0, bLocal_22, 0, 0);
		...
		switch (iLocal_11)
		{
			...
			case 4:
				if (!func_86(uLocal_7[1], 242628503))
				{
					...
					TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(0, bLocal_22, sLocal_26, 524295, 1, 9218, -1, -1082130432 /* Float: -1f */, 0, 1073741824 /* Float: 2f */, 0);
					TASK::TASK_LEAVE_VEHICLE(0, bLocal_22, 0, 0);
...
void func_90(bool bParam0)
{
	...
	{
		if ((VEHICLE::IS_DRAFT_VEHICLE(bParam0) || func_134(bParam0)) && !ENTITY::IS_ENTITY_DEAD(bParam0))
		{
...
void func_155(bool bParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_76(iParam1), bParam0, false);
...
int func_171(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_193(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
struct<5> /*40*/ func_206(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_223(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_208(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_208(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_209(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_224(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_210(923904168, func_222(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_226(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_210(271701509, func_222(bParam0), 12999093, 0) };
		}
