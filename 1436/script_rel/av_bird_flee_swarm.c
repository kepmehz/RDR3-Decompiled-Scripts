		...
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iLocal_41 /*14*/]))
			{
				if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_12[iLocal_41]))
				{
					...
					TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[iLocal_41 /*14*/], iLocal_12[iLocal_41], 0, 0, false, bVar2, 0, false, -1f, false);
						...
						while (iVar1 < iLocal_43)
						{
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar1 /*14*/]))
							{
								...
								if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[iLocal_41 /*14*/]))
								{
									...
									{
										TASK::TASK_FLEE_PED(uParam0->f_20[iLocal_41 /*14*/], Global_35, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
