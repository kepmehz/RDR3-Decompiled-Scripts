					...
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar1 /*14*/]))
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[iLocal_42 /*14*/]))
						{
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iLocal_42 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(Global_35))
							{
								...
								TASK::TASK_FLEE_PED(uParam0->f_20[iLocal_42 /*14*/], Global_35, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
...
bool func_168(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_185(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
