...
int func_31(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		{
			IK::_0x66F9EB44342BB4C5(uParam0->f_20[0 /*14*/], &Local_63);
		}
		if (bLocal_88)
		{
	...
	switch (iLocal_25)
	{
		case 0:
			...
			WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[0 /*14*/], joaat("WEAPON_REVOLVER_CATTLEMAN"), 999, false, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
		...
		case 6:
			...
			if (func_85(128))
			{
				...
				{
					TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[0 /*14*/], joaat("WORLD_CAMP_FIRE_SIT_GROUND_RECLINE"), 0, true, 0, -1f, false);
				}
				if (!bLocal_90)
				{
				...
				{
					TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[1 /*14*/], joaat("WORLD_ANIMAL_DOG_SLEEPING"), 0, true, 0, -1f, false);
				}
		...
		case 7:
			...
			{
				TASK::CLEAR_PED_TASKS(uParam0->f_20[0 /*14*/], true, false);
				TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[0 /*14*/], joaat("WORLD_HUMAN_STARE_STOIC"), 0, true, 0, -1f, false);
				TASK::CLEAR_PED_TASKS(uParam0->f_20[1 /*14*/], true, false);
				TASK::TASK_START_SCENARIO_IN_PLACE_HASH(uParam0->f_20[1 /*14*/], joaat("WORLD_ANIMAL_DOG_SITTING"), 0, true, 0, -1f, false);
				func_86(uParam0);
				iLocal_25 = 6;
			}
			break;
...
void func_69(var uParam0)
{
	...
	while (iVar0 <= 14)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			...
			TASK::TASK_FLEE_PED(uParam0->f_20[iVar0 /*14*/], Global_35, 3, 256, -1082130432 /* Float: -1f */, -1, 0);
		}
		iVar0++;
	}
}
...
bool func_78(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		if (func_128(Global_35))
		{
			...
			if (PED::_GET_PED_CURRENT_MOVEMENT_SPEED(iVar2, &fVar3, &fVar4))
			{
		...
		else
		{
			fVar5 = 1f;
			fVar6 = 1f;
			PED::_GET_PED_CURRENT_MOVEMENT_SPEED(Global_35, &fVar5, &fVar6);
	...
	while (iVar0 <= 14)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			if (func_85(128))
			{
				...
				TASK::TASK_START_SCENARIO_IN_PLACE_HASH(0, iVar2, 0, true, 0, -1f, false);
...
bool func_205(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_222(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
