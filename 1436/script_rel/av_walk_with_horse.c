			...
			if (!func_60(uParam0->f_20[0 /*14*/], 985146578))
			{
				if (iLocal_74 < Local_51)
				{
					if (!func_7(Local_51[iLocal_74 /*11*/].f_1))
					{
						TASK::CLEAR_PED_TASKS(uParam0->f_20[0 /*14*/], true, false);
						TASK::CLEAR_PED_TASKS(uParam0->f_20[1 /*14*/], true, false);
						TASK::TASK_LEAD_AND_CONVERSE(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], &(Local_51[iLocal_74 /*11*/]), 1, 5f, 2.5f, 1.6f, 1092616192 /* Float: 10f */, 1f);
						TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0, 0, -1082130432 /* Float: -1f */, -1f, 32, 1.5f, -0.5f, 1069547520 /* Float: 1.5f */, 1073741824 /* Float: 2f */);
						iLocal_74++;
						return 0;
					}
				}
