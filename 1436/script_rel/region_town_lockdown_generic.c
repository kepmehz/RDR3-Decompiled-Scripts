...
void func_4()
{
	...
	switch (iLocal_42)
	{
		...
		case 2:
			...
			if (STREAMING::HAS_MODEL_LOADED(bLocal_43) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
			{
				iLocal_42 = 3;
			}
			break;
	...
	if (iLocal_145 < 13)
	{
		if (!func_47(Local_65[iLocal_145 /*6*/]))
		{
			...
			if (func_8(Local_65[iLocal_145 /*6*/].f_5, 0))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(Local_65[iLocal_145 /*6*/].f_5, joaat("WEAPON_REPEATER_CARBINE"), 100, true, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
...
bool func_23()
{
	...
	if (iLocal_145 < 3)
	{
		...
		else if ((iLocal_145 % 3) == 0)
		{
			...
			{
				WEAPON::GIVE_WEAPON_TO_PED(Local_44[iLocal_144 /*5*/][iLocal_145], joaat("WEAPON_MELEE_TORCH"), 100, true, false, 1, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
			}
		}
		else
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_44[iLocal_144 /*5*/][iLocal_145], joaat("WEAPON_REPEATER_CARBINE"), 100, true, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
		}
		iLocal_145++;
	}
	else
			...
			while (iVar1 < 3)
			{
				if (func_8(Local_44[iVar0 /*5*/][iVar1], 0))
				{
					if (iVar1 == 0)
					{
						...
						{
							TASK::TASK_WANDER_IN_AREA(Local_44[iVar0 /*5*/][iVar1], ENTITY::GET_ENTITY_COORDS(Local_44[iVar0 /*5*/][iVar1], true, false), 100f, 1077936128 /* Float: 3f */, 1086324736 /* Float: 6f */, false);
						}
					}
					else
					{
						...
						{
							TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(Local_44[iVar0 /*5*/][iVar1], Local_44[iVar0 /*5*/][0], 0, 0, -1082130432 /* Float: -1f */, -1f, 8, 0f, 0f, 1069547520 /* Float: 1.5f */, 1073741824 /* Float: 2f */);
						}
						else
						{
							TASK::TASK_WANDER_IN_AREA(Local_44[iVar0 /*5*/][iVar1], ENTITY::GET_ENTITY_COORDS(Local_44[iVar0 /*5*/][iVar1], true, false), 100f, 1077936128 /* Float: 3f */, 1086324736 /* Float: 6f */, false);
...
bool func_51(int iParam0, var uParam1, bool bParam2, int iParam3)
{
	bool bVar0;
	int iVar1;
