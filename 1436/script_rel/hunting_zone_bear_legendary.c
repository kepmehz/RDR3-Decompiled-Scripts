...
bool func_5(var uParam0)
{
	...
	if (uParam0->f_11 > 0)
	{
		...
		if ((SCRIPTS::IS_THREAD_EXIT_REQUESTED() && SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("HUNTING1")) == 0) && !func_34(15))
		{
			bVar0 = true;
		}
...
bool func_78(int iParam0, int iParam1, int iParam2)
{
	...
	Var1 = { func_130(0) };
	if (!func_139(iParam0, &uVar6, &Var1, iParam2, joaat("ADD_REASON_DEFAULT"), 1))
	{
		return false;
	}
	return true;
...
bool func_197(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_228(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			Var0 = { func_229(0) };
			Var4.f_9 = -1591664384;
			if (!func_230(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
			{
				return false;
			}
			else if (func_231(iParam0, &Var4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_232(iParam0, 1))
			{
				if (!func_230(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_231(iParam0, &Var4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
struct<4> /*32*/ func_229(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_132(923904168, func_130(bParam0), -740156546, 0) };
		}
	...
	switch (func_245(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_232(iParam0, 1))
			{
				...
				else if (!func_230(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_231(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_252(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_132(271701509, func_130(bParam0), 12999093, 0) };
		}
