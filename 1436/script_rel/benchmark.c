...
void main()
{
	...
	if (func_7())
	{
		...
		func_4(&Local_14);
		while (MISC::_GET_STATUS_OF_SAVEGAME_OPERATION(0) == 1 && func_5(&Local_14) < 10f)
		{
			BUILTIN::WAIT(0);
		}
		if (func_5(&Local_14) >= 10f)
...
void func_1(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		MISC::SET_WEATHER_TYPE(joaat("HIGHPRESSURE"), true, false, false, 0f, false);
...
bool func_19(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if ((bParam3 && func_96(iParam1, 4096)) && Global_1946054.f_1497 == iParam4)
	{
		return true;
	}
...
bool func_97(int iParam0, int iParam1)
{
	...
	func_217(&(Global_1946054.f_964), iVar0, iParam0, -897569541, 1, iParam1);
...
void func_104(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_218(32768) && Global_1946054.f_1378.f_1[10 /*3*/] != Global_1946054.f_57[10 /*11*/])
	{
		func_224();
	}
...
bool func_121(var uParam0)
{
	...
	func_259();
	MISC::SET_WEATHER_TYPE(func_260(uParam0), true, true, false, 0f, false);
	MISC::SET_WIND_SPEED(-1f);
	MISC::SET_WIND_DIRECTION(-1f);
	MISC::_SET_SNOW_LEVEL(-1f);
...
bool func_127(var uParam0)
{
	...
	switch (func_283(uParam0))
	{
		...
		case 1:
			SCRIPTS::SHUTDOWN_LOADING_SCREEN();
			if ((((((((((TASK::GET_IS_WAYPOINT_RECORDING_LOADED(func_280(0)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(func_280(1))) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(func_280(2))) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(func_280(3))) && STREAMING::HAS_MODEL_LOADED(joaat("A_C_HORSE_KENTUCKYSADDLE_BLACK"))) && STREAMING::HAS_MODEL_LOADED(joaat("P_CS_BILLSINGLE01BX"))) && STREAMING::HAS_MODEL_LOADED(joaat("POLICEWAGON01X"))) && STREAMING::HAS_MODEL_LOADED(joaat("S_M_M_AMBIENTSDPOLICE_01"))) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY()) && !SCRIPTS::IS_LOADING_SCREEN_VISIBLE()) && AICOVERPOINT::_0x8CBE916CFC64AD5C(uParam0->f_16))
			{
		...
		case 3:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_31))
			{
				...
				if (PED::_HAS_PED_EMOTIONAL_PRESET_LOADED(uParam0->f_31, "TaskIntimidated_OnFoot"))
				{
					...
					func_296(&iVar3, 0);
					func_297(iVar3);
					MISC::SET_WEATHER_TYPE(joaat("HIGHPRESSURE"), true, true, false, 0f, false);
		...
		case 5:
			...
			{
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_16, uParam0->f_38, 0, 0, true, false, 0, false, -1f, false);
		...
		case 6:
			...
			Var4.f_14 = 1000;
			Var4.f_15 = 1000;
			IK::_0x66F9EB44342BB4C5(uParam0->f_31, &Var4);
...
int func_130(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	int iVar0;
	int iVar1;
	...
	if (iVar1 != 0)
	{
		func_309(iVar1, iParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, bParam4, iParam5, bParam6, iParam7, iParam8, iParam9, 0, 0, iParam11, bParam12);
		return iVar1;
	}
	return 0;
}
	...
	if (!MAP::DOES_BLIP_EXIST(Global_1835011[iParam0 /*74*/].f_27))
	{
		...
		if (func_188(iParam0, iVar0) && !bVar3)
		{
			if (bParam3 || func_77(&(Global_1835011[iParam0 /*74*/]), 2))
			{
				if (func_354(iParam0))
				{
					Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_358(iParam0));
					bVar2 = true;
				}
				else
				{
					Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_233(iParam0));
				}
			}
			...
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_RADIUS(1673015813, func_361(iParam0), func_362(iParam0));
			}
		}
		else if (bVar3)
		{
			if (!func_354(iParam0))
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_363(iParam0));
			}
			else
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_358(iParam0));
		...
		else if (func_364(iParam0))
		{
			if (iParam0 == 7)
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(-1337945352, func_233(iParam0));
			}
			else
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::BLIP_ADD_FOR_COORDS(1673015813, func_233(iParam0));
...
void func_292(var uParam0)
{
	...
	uParam0->f_38 = TASK::CREATE_SCENARIO_POINT_HASH_ATTACHED_TO_ENTITY(uParam0->f_35, joaat("PROP_PLAYER_CASH_REGISTER_CLERK_OPENED_BENCHMARK_TEST"), 0f, 0f, 0f, 0f, 0, 0, 1);
...
int func_293(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_463(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
	...
	switch (func_477(uParam0))
	{
		...
		case 3:
			...
			if (!PED::IS_PED_ON_MOUNT(uParam0->f_16))
			{
				...
				{
					TASK::TASK_FLEE_PED(uParam0->f_18, uParam0->f_16, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
				}
		...
		case 4:
			...
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(uParam0->f_16, func_482(0), 2f, 1, false, 0);
			AICOVERPOINT::_0x1A7A802B2301EDC0(uParam0->f_16);
			func_481(uParam0, 5);
			break;
		case 5:
		...
		case 11:
			...
			WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_16, joaat("WEAPON_THROWN_DYNAMITE"), 5, false, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
			func_481(uParam0, 12);
			break;
		case 12:
...
{
	Global_1946054.f_57[func_536(iParam0, 1) /*11*/].f_10 = (Global_1946054.f_57[func_536(iParam0, 1) /*11*/].f_10 - (Global_1946054.f_57[func_536(iParam0, 1) /*11*/].f_10 && iParam1));
}
	...
	if (!bParam17)
	{
		if (Param0.f_15)
		{
			if (bParam18)
			{
				...
				func_577(&(Global_1058888.f_43130), Var0);
				return;
			}
		}
	}
...
void func_523(int iParam0)
{
	if (!func_376(iParam0, 2))
	{
		if (!func_625())
		{
			if (MAP::DOES_BLIP_EXIST(Global_1392626[iParam0 /*32*/]))
			{
				MAP::BLIP_ADD_MODIFIER(Global_1392626[iParam0 /*32*/], 580546400);
			}
		}
		func_626(iParam0, 2);
	}
...
int func_537(int iParam0)
{
	...
	func_217(&(Global_1946054.f_964), iVar0, -367421157, 1409451727, 1, iParam0);
	DATAFILE::_0x91DED5DD64BB2691(&(Global_1946054.f_964));
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_631(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_494(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
struct<5> /*40*/ func_599(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_675(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_601(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_601(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_602(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
int func_641(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_493(bParam2), iParam0, 0);
	return iVar2;
}
...
struct<4> /*32*/ func_676(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1223200 = { func_603(923904168, func_674(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_603(923904168, func_674(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_678(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_603(271701509, func_674(bParam0), 12999093, 0) };
		}
...
int func_691(int iParam0, bool bParam1)
{
	...
	if (!func_709(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_710(iVar18);
