	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], iLocal_15[0], 0, 0, false, true, 0, false, -1f, false);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[1 /*14*/], iLocal_15[1], 0, 0, false, true, 0, false, -1f, false);
		...
		case 3:
			if (func_71(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 1) < 16f && func_72(&uLocal_18, 2f))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					TASK::TASK_FLEE_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 0, 256, -1082130432 /* Float: -1f */, -1, 0);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, uParam0->f_20[0 /*14*/], 0f, 3.5f, 0f, 1.2f, iLocal_14, 1036831949 /* Float: 0.1f */, 1, 1, 1, 1, 1, 0);
