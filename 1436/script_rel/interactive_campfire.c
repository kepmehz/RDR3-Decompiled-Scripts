...
bool func_43(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_152))
	{
		if (func_16(uParam0->f_150, 512))
		{
			...
			(*uParam0)[0] = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_PLAYER_CAMP_FIRE_KNEEL1"), vVar0, fVar3, 0f, 0, 0);
		}
		if (func_16(uParam0->f_150, 1024))
		{
			...
			(*uParam0)[1] = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_PLAYER_CAMP_FIRE_KNEEL2"), vVar0, fVar3, 0f, 0, 0);
		}
		if (func_16(uParam0->f_150, 2048))
		{
			...
			(*uParam0)[2] = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_PLAYER_CAMP_FIRE_KNEEL3"), vVar0, fVar3, 0f, 0, 0);
		}
		if (func_16(uParam0->f_150, 4096))
		{
			...
			(*uParam0)[3] = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_PLAYER_CAMP_FIRE_KNEEL4"), vVar0, fVar3, 0f, 0, 0);
		}
		if (func_16(uParam0->f_150, 2))
		{
			...
			(*uParam0)[4] = TASK::CREATE_SCENARIO_POINT_HASH(joaat("PROP_PLAYER_SEAT_CHAIR_PLAYER_CAMP"), vVar0, fVar3, 0f, 0, 0);
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_122(iParam0) == joaat("EMOTE"))
	{
		...
		Var0.f_1 = iParam0;
		Var0.f_2 = 0;
		Var0 = func_198(Global_1058888.f_49051.f_4.f_31);
		Var10 = { Var0 };
	...
	else if (PED::IS_PED_HUMAN(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iVar0)))
	{
		...
		while (iVar25 < 10)
		{
			...
			if (func_121(iVar26, 0))
			{
				...
				{
					func_228(iVar26, Var2.f_12[iVar25], bParam2, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
				}
			}
			iVar25++;
		}
...
int func_210(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_405(32768) && iParam1 != Global_1946054.f_57[func_413(iParam3, 1) /*11*/])
			{
				func_406();
...
int func_228(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
		...
		else if (func_190(iParam0, 1192444843))
		{
			switch (iParam0)
			{
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_LAKE"):
					...
					{
						func_228(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_RIVER"):
					if (!func_25(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
						func_228(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP"):
					if (!func_25(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
						func_228(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_LAKE"):
					if (!func_25(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1, 0))
					{
						func_228(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_RIVER"):
					if (!func_25(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1, 0))
					{
						func_228(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_SWAMP"):
					if (!func_25(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1, 0))
					{
						func_228(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
			}
		}
	...
	else if (iVar2 != 0)
	{
		if (func_98(0))
		{
			...
			while (iVar34 < Var11)
			{
				func_228(Var11.f_1[iVar34], Var11.f_12[iVar34], 0, 0, 0, joaat("ADD_REASON_LOOTED"), 0, 0, 0, 0);
				iVar34++;
			}
		}
		else
...
void func_234(float fParam0)
{
	...
	{
		iVar0 = 8;
		PED::_CHANGE_PED_STAMINA(Global_35, (fParam0 * IntToFloat(iVar0)));
	}
}
...
bool func_255(int iParam0, bool bParam1)
{
	...
	Var10 = { func_566() };
	Var10.f_4 = uVar9;
	if (func_567(iParam0, &uVar15, &Var10, 1, joaat("ADD_REASON_DEFAULT"), 0))
	{
		if (bParam1)
		{
...
int func_257(int iParam0, int iParam1, int iParam2)
{
	...
	Var1 = { func_583(0) };
	if (!func_567(iParam0, &uVar6, &Var1, iParam2, joaat("ADD_REASON_DEFAULT"), 1))
	{
		return 0;
	}
	return 1;
...
int func_288(int iParam0, bool bParam1)
{
	...
	if (!func_610(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_287(iVar18);
...
struct<5> /*40*/ func_296(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_122(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_613(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_613(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_614(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
bool func_297(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_619(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_614(iParam0, &Var4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_612(iParam0, 1))
			{
				if (!func_613(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_614(iParam0, &Var4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
bool func_349(var uParam0, bool bParam1, bool bParam2, int iParam3)
{
	func_667(bParam1);
	if (!uParam0->f_1)
	{
...
bool func_414(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_190(iParam0, 866047851) && func_592(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_405(32768) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
	...
	if (!bParam17)
	{
		if (Param0.f_15)
		{
			if (bParam18)
			{
				...
				func_752(&(Global_1058888.f_43130), Var0);
				return;
			}
		}
	}
...
bool func_437(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar39 < iVar19)
	{
		...
		{
			if (!func_285(&Var20, iVar39, iVar18, iVar19))
			{
			}
			else
			{
				Var34.f_4 = Var20.f_9;
				Var34 = { Var20.f_5 };
				if (func_347(iParam0, &Var20, &Var34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
void func_475(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_23() == -1)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam2))
		{
			...
			{
				func_466(0, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), iVar0);
				return;
			}
		}
	}
	switch (iParam0)
	{
		case joaat("MONEY_ONE_DOLLAR"):
			func_466(joaat("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_FIVE_DOLLARS"):
			func_466(joaat("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_TEN_DOLLARS"):
			func_466(joaat("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD"):
			func_466(joaat("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLFOLD_SML"):
			func_466(joaat("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_BILLSTACK"):
			func_466(joaat("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COIN"):
			func_466(joaat("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINPURSE"):
			func_466(joaat("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSACK"):
			func_466(joaat("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINSTACK"):
			func_466(joaat("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYCLIP"):
			func_466(joaat("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK"):
			func_466(joaat("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_MONEYSTACK_LARGE"):
			if (!func_801())
			{
				func_466(joaat("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			}
			break;
		case joaat("MONEY_COINCUP_SM"):
			func_466(joaat("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
		case joaat("MONEY_COINCUP_LG"):
			func_466(joaat("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == joaat("ADD_REASON_LOOTED"), -1);
			break;
...
int func_592(var uParam0)
{
	...
	iVar0 = 0;
	iVar1 = 22;
	if (uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/] && func_190(uParam0->f_1[iVar1 /*3*/], 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
...
struct<4> /*32*/ func_608(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_346(923904168, func_583(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_615(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_346(271701509, func_583(bParam0), 12999093, 0) };
		}
...
bool func_709(bool bParam0)
{
	...
	if (func_1006(Global_35, bParam0, 0, 1) < 2f && PED::IS_ANIMAL_INTERACTION_POSSIBLE(Global_35, bParam0))
	{
		return true;
	}
	return false;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_595(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_199(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
void func_856(int iParam0, int iParam1)
{
	...
	if (((iVar0 == 1108822547 && func_405(32768)) || Global_1946054.f_1497.f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && iParam0 != Global_1946054.f_1497.f_1[iVar1 /*3*/])
	{
...
void func_882(char* sParam0, int iParam1)
{
	int iVar0;
...
bool func_896(struct<4> /*32*/ sParam0, int iParam4)
{
	struct<11> /*88*/ sVar0;
...
bool func_901(int iParam0, var uParam1, bool bParam2)
{
	...
	if (func_610(&Var2, &iVar0, &iVar1, 0))
	{
		...
		while (iVar34 < iVar1)
		{
			if (func_285(&Var20, iVar34, iVar0, iVar1))
			{
				if (func_121(Var20.f_4, 0) && !Var20.f_10)
				{
					if (bParam2 && func_900(Var20.f_4))
					{
					}
					else
					{
...
bool func_962(bool bParam0, bool bParam1)
{
	bool bVar0;
	bool bVar1;
...
float func_1006(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
int func_1118(struct<4> /*32*/ sParam0, int iParam4, bool bParam5)
{
	int iVar0;
	struct<11> /*88*/ sVar1;
	int iVar15;
...
void func_1158(int iParam0, int iParam1)
{
	...
	func_950(bVar0, iParam0, iParam1);
}
...
float func_1161(bool bParam0, bool bParam1, bool bParam2)
{
	if (bParam2 && ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		return -1f;
	}
	return func_1006(Global_35, bParam0, bParam1, bParam2);
}
