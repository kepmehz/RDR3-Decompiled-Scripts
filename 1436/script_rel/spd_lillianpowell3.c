		...
		if (!func_5(iLocal_272, 1) && iLocal_14 > 2)
		{
			...
			else
			{
				...
				if (!func_5(iLocal_272, 1))
				{
					...
					else if (ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_260, true, 0) && iLocal_14 < 78)
					{
				...
				switch (iLocal_14)
				{
					case 0:
						...
						iLocal_306 = func_31(bLocal_262, 0, 0, 0);
					...
					case 1:
						...
						if (((((((HUD::TEXT_BLOCK_IS_LOADED("SPDEF") && HUD::TEXT_BLOCK_IS_LOADED("SPLPAUD")) && HUD::TEXT_BLOCK_IS_LOADED("STDRGAU")) && STREAMING::HAS_MODEL_LOADED(bLocal_249)) && STREAMING::HAS_MODEL_LOADED(iLocal_251)) && STREAMING::HAS_MODEL_LOADED(iLocal_250)) && STREAMING::HAS_MODEL_LOADED(iLocal_252)) && PED::_GET_NUM_RESERVED_AMBIENT_PEDS_READY() == 1)
						{
							func_10(2);
						}
					...
					case 82:
						...
						if (VOLUME::DOES_VOLUME_EXIST(bLocal_265))
						{
...
void func_1()
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(bLocal_263))
	{
		VOLUME::_DELETE_VOLUME(bLocal_263);
	}
	if (VOLUME::DOES_VOLUME_EXIST(bLocal_262))
	{
		func_176(&iLocal_306, bLocal_262, 0);
		VOLUME::_DELETE_VOLUME(bLocal_262);
	}
	if (VOLUME::DOES_VOLUME_EXIST(bLocal_260))
	{
	...
	if (VOLUME::DOES_VOLUME_EXIST(bLocal_264))
	{
...
bool func_180(bool bParam0, bool bParam1, var uParam2, int iParam3, int iParam4, float fParam5)
{
	int iVar0;
...
bool func_294(bool bParam0, bool bParam1, var uParam2)
{
	float fVar0;
	float fVar1;
...
bool func_298(var uParam0, bool bParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_322(var uParam0, vector3 vParam1, bool bParam4)
{
...
bool func_323(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_331()
{
	if (((((((((ENTITY::DOES_ENTITY_EXIST(Global_35) && !Global_1935630.f_12) && VOLUME::DOES_VOLUME_EXIST(bLocal_260)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_260, true, 0)) && func_177(Global_35, bLocal_253, 1060437492 /* Float: 0.707f */) != 1) && ((((iLocal_309 >= 11 && ANIMSCENE::DOES_ANIM_SCENE_EXIST(iLocal_316)) && ANIMSCENE::GET_ANIM_SCENE_PHASE(iLocal_316) >= func_454(iLocal_14)) && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bLocal_253)) || func_455())) && iLocal_14 != 80) && iLocal_14 != 6) && !func_5(iLocal_272, 2)) && !func_456())
	{
		func_457(0, 1);
		return true;
	}
...
bool func_413(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
...
bool func_427(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_501(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
