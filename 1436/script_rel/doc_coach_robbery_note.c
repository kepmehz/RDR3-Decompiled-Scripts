...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_309(32768) && iParam1 != Global_1946054.f_57[func_305(iParam3, 1) /*11*/])
			{
				func_310();
...
struct<5> /*40*/ func_220(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_109(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_255(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_255(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_256(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
bool func_224(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_216(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_256(iParam0, &Var4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_369(iParam0, 1))
			{
				if (!func_255(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_256(iParam0, &Var4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
int func_226(int iParam0, bool bParam1)
{
	...
	if (!func_379(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_9(iVar18);
...
int func_285()
{
	...
	while (iVar1 < 30)
	{
		if (func_441(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_306(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_31(iParam0, 866047851) && func_430(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_309(32768) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
...
bool func_344(int iParam0, int iParam1)
{
	switch (func_68(iParam1, -949239683))
	{
		...
		case 1712126263:
		case 1894156335:
			if (Global_1935689.f_9439 != 1061777683 || func_68(iParam0, 1224357681) == func_68(iParam1, 1224357681))
			{
				return true;
			}
			break;
...
{
	return func_257(joaat("CHARACTER"), func_535(), -1591664384, bParam0);
}
...
struct<4> /*32*/ func_368(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_257(923904168, func_367(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_370(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_257(271701509, func_367(bParam0), 12999093, 0) };
		}
...
int func_396()
{
	...
	while (iVar1 < 30)
	{
		if (func_548(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_433(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_113(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
bool func_727(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar39 < iVar19)
	{
		...
		{
			if (!func_315(&Var20, iVar39, iVar18, iVar19))
			{
			}
			else
			{
				Var34.f_4 = Var20.f_9;
				Var34 = { Var20.f_5 };
				if (func_258(iParam0, &Var20, &Var34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
int func_732(int iParam0, bool bParam1)
{
	...
	Var3.f_1 = 1084182731;
	iVar35 = func_740(0);
	if (ENTITY::DOES_ENTITY_EXIST(iVar35) && func_741(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar35), &Var3, &iVar0, &iVar1))
	{
		iVar2 = 0;
		iVar2 = 0;
		while (iVar2 < iVar1)
		{
			if (func_315(&Var21, iVar2, iVar0, iVar1))
			{
				if (iParam0 == Var21.f_4)
				{
					...
					{
						iVar36 = 1;
						func_742(&iVar35, iParam0, &iVar36, 1, -142743235);
					}
					func_9(iVar0);
					return 1;
				}
