...
void main()
{
	...
	while (true)
	{
		...
		if (func_15())
		{
			func_16(Global_1935689.f_9445, &(Var3.f_3), &uVar0);
			func_4();
			func_17(0);
			func_18(0);
		...
		while (UIEVENTS::EVENTS_UI_IS_PENDING(iScriptParam_0))
		{
			if (UIEVENTS::EVENTS_UI_PEEK_MESSAGE(iScriptParam_0, &Var3))
			{
				...
				{
					case -1740156697:
						Global_1935689.f_9445 = Var3.f_1;
						switch (Var3.f_2)
						{
							case -1287062382:
...
void func_1(var uParam0, bool bParam1, bool bParam2)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void func_4()
{
	...
	{
		ATTRIBUTE::STOP_ITEM_PREVIEW();
		INVENTORY::_0x75CFAC49301E134F(Global_1935689.f_9461, 0, 0);
...
int func_7()
{
	...
	switch (iVar0)
	{
		...
		case 1:
			...
			break;
		case 2:
			fVar3 = (BUILTIN::TO_FLOAT(func_79(Global_1935689.f_9440, 0)) / 100f);
...
void func_13(int iParam0)
{
	...
	Var0 = { Global_1935689.f_9431[Global_1935689.f_9437 /*2*/] };
	Var2.f_9 = -1591664384;
	...
	else
	{
		...
		if ((Global_1935689.f_9439 == -182626652 && ((Global_1914319.f_16855 == 10 || Global_1914319.f_16855 == 19) || Global_1914319.f_16855 == 18)) || (Global_1935689.f_9439 == -693134279 && Global_1914319.f_16855 == 2))
		{
			if (func_84())
			{
				Var0 = { Global_1935689.f_9431[1 /*2*/] };
				func_94(&Var0, &Var2, iParam0);
			}
		}
		func_95();
...
bool func_25(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_119(iParam0) == joaat("EMOTE"))
	{
		...
		Var0.f_1 = iParam0;
		Var0.f_2 = 0;
		Var0 = func_120(Global_1058888.f_49051.f_4.f_31);
		Var10 = { Var0 };
...
void func_28()
{
	...
	{
		Var1 = { func_153(Global_1935689.f_9440, 0, 0) };
		Var6 = { func_154(Global_1935689.f_9440, Var1, Var1.f_4, 0) };
		func_155(Var6, 1);
	...
	{
		iVar10 = func_160(Global_1935689.f_9440);
...
bool func_42(var uParam0, bool bParam1, bool bParam2, int iParam3)
{
	func_31(bParam1);
	if (!uParam0->f_1)
	{
...
int func_64(var uParam0)
{
	...
	bVar1 = func_68();
	bVar2 = false;
	if (((!bVar0 && !bVar1) && Global_1935689.f_9439 != -156634416) && Global_1935689.f_9439 != 1061777683)
	{
		bVar2 = true;
	}
	...
	*uParam0 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER_FROM_PATH("", "Satchel");
	...
	Global_1935689.f_9461 = INVENTORY::_0x9D21B185ABC2DBC4(iVar3, "effects", 0, 0);
...
void func_77(int iParam0, var uParam1)
{
	...
	if (func_220(iParam0))
	{
		...
		else
		{
			...
			if (PED::_IS_METAPED_USING_COMPONENT(bVar21, 43391475) || ENTITY::_IS_ENTITY_FULLY_LOOTED(iVar5))
			{
				iVar17 = 0;
			}
			else
...
void func_83(var uParam0, int iParam1)
{
	...
	while (iVar14 >= 0)
	{
		if (!func_233(&Var0, iVar14, func_82(Global_1935689.f_9439), *uParam0))
		{
		}
...
bool func_84()
{
	...
	else
	{
		...
		{
			bVar0 = PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::GET_PLAYER_INDEX());
		}
		if ((!ENTITY::DOES_ENTITY_EXIST(bVar0) || ENTITY::IS_ENTITY_DEAD(bVar0)) || PED::IS_PED_INJURED(bVar0))
		{
			return false;
...
void func_98()
{
	...
	else if ((((func_259(Global_1935689.f_9440, 1224357681) != 0 && Global_1935689.f_9439 != 0) && Global_1935689.f_9439 != -2074770370) && !func_27(0)) && !func_23())
	{
...
void func_100(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_161(iParam0, 0))
	{
		...
		DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING(Global_1935689.f_9454, func_266(iParam0));
		DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING(Global_1935689.f_9455, func_267(iParam0));
	...
	{
		INVENTORY::_0x75CFAC49301E134F(Global_1935689.f_9461, iParam0, 0);
	}
	func_90(iParam0);
}
...
void func_112(int iParam0, struct<11> /*88*/ sParam1, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, struct<2> /*16*/ sParam17, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, int iParam27, bool bParam28, int iParam29)
{
	switch (iParam0)
	{
...
void func_114(int iParam0, struct<11> /*88*/ sParam1, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16)
{
	switch (iParam0)
	{
...
int func_130(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != Global_1946054.f_57[func_334(iParam3, 1) /*11*/])
			{
				func_127(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_327(32768) && iParam1 != Global_1946054.f_57[func_334(iParam3, 1) /*11*/])
			{
				func_328();
...
int func_152(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_111(iParam0, 1192444843))
		{
			switch (iParam0)
			{
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_LAKE"):
					...
					{
						func_152(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_RIVER"):
					if (!func_257(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
						func_152(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP"):
					if (!func_257(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
						func_152(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_LAKE"):
					if (!func_257(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1, 0))
					{
						func_152(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_RIVER"):
					if (!func_257(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1, 0))
					{
						func_152(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_SWAMP"):
					if (!func_257(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1, 0))
					{
						func_152(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1, 0, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
					}
					break;
			}
		}
		...
		else if (func_111(iParam0, 1248798204))
		{
			...
			if (iVar8 != 0)
			{
				func_152(iVar8, 1, 1, 0, 0, joaat("ADD_REASON_DEFAULT"), 0, 0, 0, 0);
			}
		}
		switch (iParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER"):
				...
				if (func_414(&iVar9, 0))
				{
					func_390(iVar9, 0, 0, bParam4, 3, 0, joaat("ADD_REASON_DEFAULT"), 0);
				}
				break;
	...
	else if (iVar2 != 0)
	{
		if (func_156(0))
		{
			...
			while (iVar34 < Var11)
			{
				func_152(Var11.f_1[iVar34], Var11.f_12[iVar34], 0, 0, 0, joaat("ADD_REASON_LOOTED"), 0, 0, 0, 0);
				iVar34++;
			}
		}
		else
...
struct<5> /*40*/ func_153(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> /*40*/ sVar0;
	struct<10> /*80*/ sVar5;
	struct<10> /*80*/ sVar27;
	...
	switch (func_119(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_442(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_442(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_443(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_154(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
bool func_155(struct<4> /*32*/ sParam0, int iParam4)
{
	struct<11> /*88*/ sVar0;
...
bool func_178(bool bParam0, bool bParam1)
{
	...
	else if (PLAYER::GET_PLAYER_INTERACTION_TARGET_ENTITY(PLAYER::GET_PLAYER_INDEX(), &bVar0, false, false))
	{
		if (!func_181(bVar0))
		{
			if (bParam1)
		...
		if (!PED::IS_ANIMAL_INTERACTION_POSSIBLE(Global_35, ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bVar0)))
		{
			if (bParam1)
			{
				func_123("ITEM_UNUSABLE_NOT_NEAR_HORSE", 10000, 0, 0, 0, 1);
	...
	if (!PED::IS_ANIMAL_INTERACTION_POSSIBLE(Global_35, bVar1))
	{
		if (bParam1)
		{
			func_123("ITEM_UNUSABLE_NOT_NEAR_HORSE", 10000, 0, 0, 0, 1);
...
void func_205()
{
	...
	DATAFILE::_DATAFILE_REGISTER_QUERY(Global_1935689.f_9475, 0, "satchel_elements/name(id=%x):texture0");
	DATAFILE::_DATAFILE_REGISTER_QUERY(Global_1935689.f_9475, 1, "satchel_elements/name(id=%x):texturedictionary0");
	DATAFILE::_DATAFILE_REGISTER_QUERY(Global_1935689.f_9475, 2, "satchel_elements/name(id=%x):name0");
	DATAFILE::_DATAFILE_REGISTER_QUERY(Global_1935689.f_9475, 3, "satchel_elements/name(id=%x):description0");
}
...
{
	return (func_512(iParam0, uParam1) || func_513(iParam0, uParam1));
}
...
int func_225(bool bParam0, var uParam1)
{
	...
	func_514(bParam0, &iVar1, &uVar2, &iVar0, &uVar3);
	uVar4 = PED::_0x6B89FAA36FC909A3(uParam1, bParam0, iVar0, iVar1);
	return uVar4;
}
...
float func_237(bool bParam0, bool bParam1, bool bParam2)
{
	...
	return func_521(Global_35, bParam0, bParam1, bParam2);
}
...
bool func_238(bool bParam0)
{
	...
	if (func_358() == 3)
	{
		...
		fVar3 = (func_523() + 7f);
		if (func_524(ENTITY::GET_ENTITY_COORDS(bParam0, true, false), vVar0, fVar3, 0))
		{
			return true;
		}
	}
	else if (func_525(bParam0))
	{
		return true;
	}
	return false;
...
void func_330(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		case -2061583405:
			bVar1 = func_608(iParam0, &(Global_1946054.f_2657.f_21), Global_1946054.f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_608(iParam0, &(Global_1946054.f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_608(iParam0, &(Global_1946054.f_2657.f_20), Global_1946054.f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_608(iParam0, &(Global_1946054.f_2657.f_22), Global_1946054.f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_608(iParam0, &(Global_1946054.f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_608(iParam0, &(Global_1946054.f_2657.f_24), 1, bParam1);
			break;
...
bool func_335(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_111(iParam0, 866047851) && func_616(&(Global_1946054.f_1378)) >= 2)
	{
		return false;
	}
	if ((func_327(32768) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
	...
	func_621(&(Global_1946054.f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946054.f_1378.f_1[iParam2 /*3*/] = iParam0;
	Global_1946054.f_1378.f_1[iParam2 /*3*/].f_1 = func_622(iParam0, iParam2, iParam1, func_62() != -1);
	if (bParam4)
	{
...
int func_340(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	var uVar4;
	...
	if (!bParam17)
	{
		if (Param0.f_15)
		{
			if (bParam18)
			{
				...
				func_631(&(Global_1058888.f_43130), Var0);
				return;
			}
		}
	}
...
struct<2> /*16*/ func_361(int iParam0)
{
	struct<2> /*16*/ sVar0;
	struct<2> /*16*/ sVar2;
...
bool func_362(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if (!func_489(&Var0, &iVar18, &iVar19, 0))
	{
		return false;
	}
	...
	while (iVar39 < iVar19)
	{
		...
		{
			if (!func_233(&Var20, iVar39, iVar18, iVar19))
			{
			}
			else
			{
				Var34.f_4 = Var20.f_9;
				Var34 = { Var20.f_5 };
				if (func_274(iParam0, &Var20, &Var34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
void func_434(int iParam0)
{
	...
	if ((iParam0 == joaat("CLOTHING_SP_OFFHAND_000") || iParam0 == -1515874150) || iParam0 == joaat("UPGRADE_OFFHAND_HOLSTER"))
	{
		...
		if (func_414(&iVar2, 0))
		{
			func_390(iVar2, 0, 0, 1, 3, 0, joaat("ADD_REASON_DEFAULT"), 0);
		}
	}
}
...
struct<4> /*32*/ func_440(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_154(923904168, func_439(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_444(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_154(271701509, func_439(bParam0), 12999093, 0) };
		}
...
int func_447(struct<4> /*32*/ sParam0, int iParam4, bool bParam5)
{
	int iVar0;
	struct<11> /*88*/ sVar1;
	int iVar15;
...
struct<18> /*144*/ func_488(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
void func_504(var uParam0, int iParam1, char* sParam2, char* sParam3)
{
	...
	iVar0 = DATABINDING::_DATABINDING_GET_DATA_CONTAINER_FROM_CHILD_INDEX(uParam0, Global_1935689.f_9416);
...
void func_514(bool bParam0, int iParam1, var uParam2, int iParam3, var uParam4)
{
...
int func_516(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_111(iParam0, -5284486))
	{
		...
		Var54.f_7 = -1;
		Var54.f_8 = -1;
		iVar68 = func_259(iParam0, 862142561);
		if (iVar68 != 0)
		{
			Var54.f_8 = iVar68;
			...
			if (iVar65 != -1)
			{
				...
				while (iVar66 < iVar64)
				{
					iVar67 = func_452(iVar66, iVar65);
					if (func_161(iVar67, 0) && iVar67 != iParam0)
					{
						if (bParam4)
						{
							iVar53 = (iVar53 + func_516(iVar67, -915411861, 1, 0, 0));
						}
						else
						{
							Var35 = iVar67;
...
float func_521(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
int func_529(bool bParam0)
{
	...
	func_514(bVar0, &uVar2, &uVar3, &iVar1, &uVar4);
...
void func_535(int iParam0, var uParam1, bool bParam2)
{
	...
	if (func_782(iVar21, &Var0, &iVar18, &iVar19))
	{
		iVar20 = 0;
		iVar20 = 0;
		while (iVar20 < iVar19)
		{
			if (func_233(&Var22, iVar20, iVar18, iVar19))
			{
				if (func_161(Var22.f_4, 0) && Var22.f_4 != joaat("CUSTOM_SATCHEL"))
				{
					*uParam1++;
					if (bParam2 && func_249(Var22.f_4))
					{
						func_255(Var22, 0);
					}
				}
...
void func_541(int iParam0, char* sParam1, int iParam2, bool bParam3, char* sParam4, bool bParam5, char* sParam6, char* sParam7)
{
	...
	iVar1 = iVar0;
	DATABINDING::_DATABINDING_WRITE_DATA_SCRIPT_VARIABLES(0, iVar1, sParam1, iParam2->f_1, *iParam2, sParam4, bParam3, bParam5, sParam6, sParam7);
...
int func_557(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		...
		iVar0 = (iVar0 + func_797(bVar2, iParam0));
		iVar1++;
	}
	return iVar0;
}
...
bool func_558(int iParam0)
{
	...
	while (iVar3 < 4)
	{
		...
		func_798(bVar1, iParam0, &iVar4, &iVar5, &uVar2);
		iVar6 = (iVar4 + iVar5);
		switch (iVar0)
		{
			case 0:
...
bool func_590(bool bParam0)
{
	...
	if (func_521(Global_35, bParam0, 0, 1) < 2f && PED::IS_ANIMAL_INTERACTION_POSSIBLE(Global_35, bParam0))
	{
		return true;
	}
	return false;
...
int func_608(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (func_121(iParam0) != -999503751)
	{
		func_846(&(Global_1946054.f_2657.f_26.f_26), iParam0, Global_1946054.f_2657.f_19);
	}
...
int func_616(var uParam0)
{
	...
	iVar0 = 0;
	iVar1 = 22;
	if (uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/] && func_111(uParam0->f_1[iVar1 /*3*/], 866047851))
	{
		iVar0++;
	}
	iVar1 = 37;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_853(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946054.f_57[iVar1 /*11*/]) && -923693316 == func_121(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946054.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
bool func_653(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_647(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_443(iParam0, &Var4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_441(iParam0, 1))
			{
				if (!func_442(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_443(iParam0, &Var4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
		...
		case 24:
			...
			if (func_62() == -1)
			{
				if (!func_713(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) || func_892(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					...
					{
						func_433(iVar0, 1, joaat("ADD_REASON_DEFAULT"));
					}
...
bool func_675(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_111(iParam1, 866047851))
	{
		...
		if (func_616(&(Global_1946054.f_1497)) >= 2 && Global_1946054.f_1497.f_1[iVar5 /*3*/] != iVar8)
		{
	...
	switch (iVar4)
	{
		...
		case -1944638739:
			iVar5 = 35;
			if (Global_1946054.f_1497.f_1[iVar5 /*3*/] != Global_1946054.f_57[iVar5 /*11*/] && func_111(iParam1, -1638171711))
			{
		...
		case 1788623170:
			...
			else
			{
				...
				iVar9 = func_858(Global_1946054.f_1497.f_1[iVar5 /*3*/], iVar4, iVar2, bVar1);
    ...
    "" */
				...
				iVar5 = 36;
				iVar6 = 35;
				if (iParam1 != Global_1946054.f_57[iVar6 /*11*/] && func_111(Global_1946054.f_1497.f_1[iVar5 /*3*/], -1638171711))
				{
				...
				{
					if (iParam1 != Global_1946054.f_57[iVar6 /*11*/] && func_853(Global_1946054.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = joaat("MPC_ACTION_NOT_AVAILABLE_BOOTS_DO_NOT_SUPPORT_THIS");
						return false;
					}
		...
		else
		{
			...
			else
			{
				if (ENTITY::IS_ENTITY_A_PED(bVar2))
				{
					...
					func_514(bVar9, &uVar6, &uVar7, &iVar5, &uVar8);
					func_767(&iVar0, bVar9, iVar5, uVar6);
					if (!func_161(iVar0, 0))
					{
						iVar0 = func_530(bVar2);
					}
				}
				else
				{
				...
				if (iVar0 == iParam1)
				{
					PED::DETACH_CARRIABLE_ENTITY(bVar2, false, false);
					if (bParam3)
					{
						func_938(bVar2);
						ENTITY::_DELETE_CARRIABLE(&bVar2);
					}
					iParam2 = (iParam2 - 1);
				}
			}
...
struct<4> /*32*/ func_733(int iParam0, int iParam1)
{
	struct<5> /*40*/ sVar0;
...
void func_749(int iParam0, var uParam1, bool bParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, bool bParam19, bool bParam20)
{
	...
	if (func_489(&uParam1, &iVar0, &iVar1, bParam20))
	{
		...
		while (iVar2 < iVar1)
		{
			if (func_233(&Var3, iVar2, iVar0, iVar1))
			{
				func_491(iParam0, Var3.f_4, bParam19);
			}
			iVar2++;
		}
	}
...
void func_780(int iParam0, var uParam1)
{
	...
	if (func_782(iVar22, &Var1, &iVar19, &iVar20))
	{
		iVar21 = 0;
		iVar21 = 0;
		while (iVar21 < iVar20)
		{
			if (func_233(&Var23, iVar21, iVar19, iVar20))
			{
				if (func_161(Var23.f_4, 0) && Var23.f_4 != joaat("CUSTOM_SATCHEL"))
				{
					if (func_249(Var23.f_4))
					{
						iVar0 = 0;
						while (iVar0 < 999)
						{
							if ((*uParam1)[iVar0] == Var23.f_4 || !func_161((*uParam1)[iVar0], 0))
							{
							}
							else
							{
...
int func_797(bool bParam0, int iParam1)
{
	...
	func_798(bParam0, iParam1, &uVar0, &uVar1, &uVar2);
	return uVar0;
}

void func_798(bool bParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	struct<4> /*32*/ sVar0;
	int iVar4;
	int iVar5;
	...
	if (func_968(bParam0))
	{
		...
		while (iVar5 < 3)
		{
			...
			if (!PED::GET_CARRIED_ATTACHED_INFO_FOR_SLOT(&Var0, bParam0, iVar4, 0))
			{
			}
			else
			{
				...
				{
					if (ENTITY::_IS_ENTITY_FULLY_LOOTED(bVar6))
					{
						if (iVar5 == 0 || iVar5 == 2)
						{
							*uParam4 = 1;
...
void func_848(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case -2061583405:
			bVar0 = func_1007(iParam0, &(Global_1946054.f_2657.f_21));
			break;
		case 81053684:
			bVar0 = func_1007(iParam0, &(Global_1946054.f_2657.f_23));
			break;
		case -999503751:
			bVar0 = func_1007(iParam0, &(Global_1946054.f_2657.f_20));
			break;
		case -525676072:
			bVar0 = func_1007(iParam0, &(Global_1946054.f_2657.f_22));
			break;
		case -1719060085:
			bVar0 = func_1007(iParam0, &(Global_1946054.f_2657.f_24));
			break;
		case -413129408:
			bVar0 = func_1007(iParam0, &(Global_1946054.f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
{
	return (Global_1946054.f_57[func_334(iParam0, 1) /*11*/].f_10 && iParam1) != 0;
}
...
int func_858(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam0 == Global_1946054.f_57[func_334(iParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_945(int iParam0, int iParam1)
{
	...
	{
		bVar0 = PLAYER::GET_MOUNT_OWNED_BY_PLAYER(PLAYER::PLAYER_ID());
	}
	func_731(bVar0, iParam0, iParam1);
}
...
struct<4> /*32*/ func_948(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> /*32*/ sVar0;
	...
	if (PED::IS_PED_CARRYING_SOMETHING(Global_35))
	{
		...
		if (ITEMSET::IS_ITEMSET_VALID(iVar14))
		{
			...
			while (iVar16 < iVar15)
			{
				...
				else if (ENTITY::GET_IS_ANIMAL(bVar0) || ENTITY::_GET_IS_BIRD(bVar0))
				{
					bVar21 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bVar0);
					iVar1 = func_225(bVar21, &uVar2);
					iVar23 = func_529(bVar0);
					if (iVar23 == iParam0)
					{
						if (bParam1)
						{
							Global_1901328.f_94 = 1;
							ENTITY::_DELETE_CARRIABLE(&bVar0);
				...
				else
				{
					...
					func_514(bVar24, &iVar18, &uVar19, &iVar17, &uVar20);
...
int func_1065(int iParam0, bool bParam1)
{
	...
	Var3.f_1 = 1084182731;
	iVar35 = func_165(0);
	if (ENTITY::DOES_ENTITY_EXIST(iVar35) && func_782(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar35), &Var3, &iVar0, &iVar1))
	{
		iVar2 = 0;
		iVar2 = 0;
		while (iVar2 < iVar1)
		{
			if (func_233(&Var21, iVar2, iVar0, iVar1))
			{
				if (iParam0 == Var21.f_4)
				{
					...
					{
						iVar36 = 1;
						func_456(&iVar35, iParam0, &iVar36, 1, -142743235);
					}
					func_244(iVar0);
					return 1;
				}
...
void func_1067(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar0))
	{
		func_514(bVar0, &(iParam1->f_5), &(iParam1->f_6), &(iParam1->f_7), &(iParam1->f_4));
...
void func_1113(int iParam0)
{
	...
	while (iVar0 < Global_1946054.f_2657.f_19)
	{
		...
		{
			func_846(&(Global_1946054.f_2657.f_26.f_26), iVar2, iVar0);
		}
		if (func_845(iVar2, 0))
		{
			func_131(iVar2, Global_1946054.f_1497.f_1[iVar1 /*3*/] == Global_1946054.f_2657[iVar0]);
		}
		iVar0++;
	}
}
