...
void func_1()
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(bLocal_43))
	{
...
void func_5()
{
	switch (iLocal_41)
	{
		...
		case 2:
			...
			if (STREAMING::HAS_MODEL_LOADED(bLocal_44) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
			{
				iLocal_41 = 4;
			}
			break;
...
void func_16()
{
	...
	WEAPON::GIVE_WEAPON_TO_PED(bLocal_42, joaat("WEAPON_SNIPERRIFLE_CARCANO"), 999, true, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), false, 0f, false);
	PED::SET_PED_DEFENSIVE_AREA_VOLUME(bLocal_42, bLocal_43, 0, false, 0);
	...
	ENTITY::SET_ENTITY_HEALTH(bLocal_42, iVar0, 0);
	func_26(bLocal_42);
}
