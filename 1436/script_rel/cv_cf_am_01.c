...
bool func_105(var uParam0)
{
	if (func_208(iLocal_29, 1))
	{
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 0))
		{
			...
			TASK::TASK_ENTER_ANIM_SCENE(Global_35, uParam0->f_1984[iLocal_22], "Arthur", &(uParam0->f_2051[iLocal_24 /*6*/].f_1), 1069379748 /* Float: 1.48f */, false, 0, 20000, -1082130432 /* Float: -1f */);
...
int func_131(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_58(bVar0, 0))
	{
		if (func_58(PED::_GET_RIDER_OF_MOUNT(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
void func_437(bool bParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_125(iParam1), bParam0, false);
...
int func_464(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_484(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
struct<5> /*40*/ func_491(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_503(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_493(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_493(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_494(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_504(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_495(923904168, func_502(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_506(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_495(271701509, func_502(bParam0), 12999093, 0) };
		}
