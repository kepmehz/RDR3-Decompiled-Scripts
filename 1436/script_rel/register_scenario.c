...
int func_124(int iParam0, bool bParam1)
{
	...
	if (!func_132(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_123(iVar18);
...
struct<18> /*144*/ func_129(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
struct<4> /*32*/ func_130(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_134(923904168, func_133(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_134(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
