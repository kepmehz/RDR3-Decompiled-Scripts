...
bool func_79(var uParam0)
{
	...
	if (!bLocal_16)
	{
		if (!CAM::IS_SPHERE_VISIBLE(vLocal_18, 1.4f))
		{
			...
			iLocal_21 = PROPSET::_CREATE_PROP_SET_2(joaat("PG_SCENARIO_MOLOTOVMAKE"), vVar0, 0, fVar3, 1200f, false, true);
			bLocal_16 = true;
		}
	}
	return bLocal_16;
...
int func_418(int iParam0, bool bParam1)
{
	...
	if (!func_469(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_470(iVar18);
...
struct<4> /*32*/ func_467(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_511(923904168, func_510(bParam0), -740156546, 0) };
		}
...
void func_484(bool bParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_241(iParam1), bParam0, false);
...
int func_509(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_531(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, joaat("ADD_REASON_DEFAULT"), 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
struct<4> /*32*/ func_550(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_511(271701509, func_510(bParam0), 12999093, 0) };
		}
