#region Local Variables
	...
	var uLocal_31 = 0;
	var uLocal_32 = 0;
	bool bLocal_33[5] = { false, false, false, false, false };
	bool bLocal_39[5] = { false, false, false, false, false };
	int iLocal_45 = 0;
	int iLocal_46 = 0;
	int iLocal_47 = 0;
...
void func_1()
{
	...
	iVar0 = 0;
	while (iVar0 < bLocal_33)
	{
		if (func_12(bLocal_33[iVar0], 0))
		{
			func_13(&(bLocal_33[iVar0]), 1, 1, 1);
			func_13(&(bLocal_39[iVar0]), 1, 1, 1);
		}
		iVar0++;
	}
	func_14(iLocal_46);
...
void func_10()
{
	...
	switch (iLocal_14)
	{
		...
		case 2:
			...
			if ((STREAMING::HAS_MODEL_LOADED(bLocal_28) && STREAMING::HAS_MODEL_LOADED(bLocal_29)) && PED::_ARE_ALL_AMBIENT_PED_RESERVATIONS_READY())
			{
				iLocal_14 = 3;
			}
			break;
		...
		case 4:
			...
			{
				iVar4 = 0;
				while (iVar4 < bLocal_33)
				{
					func_38(bLocal_33[iVar4], bLocal_39[iVar4], 0, -1, 1);
					bVar5 = false;
					if (iVar4 == 0)
					{
					...
					if (func_12(bLocal_33[iVar4], 0))
					{
						...
						TASK::TASK_POLICE(bLocal_33[iVar4], true);
						TASK::TASK_PERFORM_SEQUENCE(bLocal_33[iVar4], iVar3);
						func_41(&(bLocal_33[iVar4]), &iLocal_45, bVar5, 1, 1, 1, 0);
					}
					iVar4++;
				}
				iLocal_14 = 5;
		...
		case 5:
			iVar9 = 0;
			while (iVar9 < bLocal_33)
			{
				if (func_12(bLocal_33[iVar9], 0) && func_12(Global_35, 0))
				{
					if (func_42(Global_35, bLocal_33[iVar9], 1, 1) > 220f)
					{
						iLocal_14 = 6;
						return;
					}
...
void func_36()
{
	bLocal_33[iLocal_25] = func_66(bLocal_28, Local_15.f_3, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
	func_67(bLocal_33[iLocal_25]);
	iLocal_25++;
...
void func_37()
{
	bLocal_39[iLocal_25] = func_66(bLocal_29, Local_15.f_3, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
	iLocal_25++;
	if (iLocal_25 >= iLocal_24)
	{
		bLocal_27 = true;
