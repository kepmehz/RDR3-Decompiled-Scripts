...
void func_417(bool bParam0, int iParam1)
{
	...
	{
		PED::SET_PED_OWNS_ANIMAL(func_227(iParam1), bParam0, false);
...
struct<5> /*40*/ func_469(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_481(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_471(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_471(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_472(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
struct<4> /*32*/ func_482(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_473(923904168, func_480(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_484(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_473(271701509, func_480(bParam0), 12999093, 0) };
		}
