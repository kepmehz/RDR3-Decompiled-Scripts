#region Local Variables
	bool bLocal_0[12] = { false, false, false, false, false, false, false, false, false, false, false, false };
	int iLocal_13 = 0;
	int iLocal_14 = 0;
	int iLocal_15 = 0;
	int iLocal_16 = 0;
	...
	while (!bVar0)
	{
		...
		switch (iLocal_13)
		{
			...
			case 4:
				...
				while (iVar1 < 12)
				{
					if (!PED::IS_PED_INJURED(bLocal_0[iVar1]))
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_0[iVar1], -708058584, true) == 8 || iLocal_18[iVar1])
						{
							iVar2 = 0;
							switch (iVar2)
							{
							...
							{
								TASK::TASK_FLY_TO_COORD(bLocal_0[iVar1], 3f, func_4(iLocal_16), 0, 1);
								iLocal_18[iVar1] = 0;
							}
						}
					}
				...
				if (!PED::IS_PED_INJURED(bLocal_0[0]))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(bLocal_0[0], func_4(iLocal_16), 20f, 20f, 20f, false, false, 0))
					{
						iLocal_13 = 5;
					}
				}
			...
			case 5:
				...
				while (iVar1 < 12)
				{
					if (!PED::IS_PED_INJURED(bLocal_0[iVar1]))
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_0[iVar1], 475934052, true) != 8)
						{
						}
						else
						{
							TASK::TASK_FLYING_CIRCLE(bLocal_0[iVar1], 2f, func_4(iLocal_16), 2f, 10f);
						}
					}
					iVar1++;
				}
		...
		if (iLocal_13 >= 3)
		{
			bVar6 = false;
			bVar7 = false;
			if (PED::IS_PED_INJURED(bLocal_0[iLocal_17]))
			{
				bVar7 = true;
			}
			else if (ENTITY::IS_ENTITY_AT_ENTITY(Global_35, bLocal_0[iLocal_17], 250f, 250f, 250f, false, false, 0))
			{
				bVar6 = true;
			}
			iLocal_17++;
...
bool func_3()
{
	...
	while (iVar0 < 12)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(bLocal_0[iVar0]))
		{
			switch (iVar0)
			{
				case 0:
			...
			bLocal_0[iVar0] = func_11(func_2(), vVar1, fVar4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
void func_6()
{
	...
	while (iVar0 < 12)
	{
		if (!PED::IS_PED_INJURED(bLocal_0[iVar0]))
		{
			TASK::TASK_FLY_AWAY(bLocal_0[iVar0], Global_35);
		}
		iVar0++;
	}
}
