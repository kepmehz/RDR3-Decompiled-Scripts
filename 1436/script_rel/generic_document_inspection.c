...
int func_144(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_310(32768) && iParam1 != Global_1946054.f_57[func_306(iParam3, 1) /*11*/])
			{
				func_311();
...
struct<5> /*40*/ func_220(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_109(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_256(iParam0, &Var0, joaat("SLOTID_WEAPON_0"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else if (!func_256(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_1");
				}
				else if (func_257(iParam0, &Var5, joaat("SLOTID_WEAPON_0")))
				{
					Var0.f_4 = joaat("SLOTID_WEAPON_0");
				}
				else
...
bool func_224(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_216(iParam0) && WEAPON::IS_WEAPON_A_GUN(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_257(iParam0, &Var4, joaat("SLOTID_WEAPON_0")))
			{
				return false;
			}
			if (func_369(iParam0, 1))
			{
				if (!func_256(iParam0, &Var0, joaat("SLOTID_WEAPON_1"), 0))
				{
					return false;
				}
				else if (func_257(iParam0, &Var4, joaat("SLOTID_WEAPON_1")))
				{
					return false;
				}
			}
...
bool func_307(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((func_310(32768) && iParam2 == 10) && iParam0 != Global_1946054.f_57[iParam2 /*11*/])
	{
...
{
	return func_258(joaat("CHARACTER"), func_536(), -1591664384, bParam0);
}
...
struct<4> /*32*/ func_368(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_258(923904168, func_367(bParam0), -740156546, 0) };
		}
...
struct<4> /*32*/ func_370(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1223204 = { func_258(271701509, func_367(bParam0), 12999093, 0) };
		}
...
int func_396()
{
	...
	while (iVar1 < 30)
	{
		if (func_549(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_729(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar39 < iVar19)
	{
		...
		{
			if (!func_316(&Var20, iVar39, iVar18, iVar19))
			{
			}
			else
			{
				Var34.f_4 = Var20.f_9;
				Var34 = { Var20.f_5 };
				if (func_259(iParam0, &Var20, &Var34, 1, iParam3, 0, 0))
				{
					iVar40++;
				}
			}
...
int func_734(int iParam0, bool bParam1)
{
	...
	Var3.f_1 = 1084182731;
	iVar35 = func_742(0);
	if (ENTITY::DOES_ENTITY_EXIST(iVar35) && func_743(INVENTORY::_INVENTORY_GET_INVENTORY_ID_FROM_PED(iVar35), &Var3, &iVar0, &iVar1))
	{
		iVar2 = 0;
		iVar2 = 0;
		while (iVar2 < iVar1)
		{
			if (func_316(&Var21, iVar2, iVar0, iVar1))
			{
				if (iParam0 == Var21.f_4)
				{
					...
					{
						iVar36 = 1;
						func_744(&iVar35, iParam0, &iVar36, 1, -142743235);
					}
					func_9(iVar0);
					return 1;
				}
...
struct<5> /*40*/ func_770(int iParam0)
{
	...
	Var0 = { func_771(iParam0, joaat("CHARACTER"), func_536(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}
