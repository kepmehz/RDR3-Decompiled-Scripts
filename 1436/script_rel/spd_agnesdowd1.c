...
void func_5()
{
	...
	if (iLocal_146 < 1)
	{
		...
		if (iVar0 != 0 && func_33(iVar0, 0))
		{
			...
			{
				TASK::TASK_HORSE_ACTION(iVar0, 4, false, 0);
				iLocal_146++;
			}
		}
	}
		...
		if (!bLocal_153)
		{
			if (func_10(iLocal_139, 2048) && !func_10(iLocal_139, 4096))
			{
				...
				if (iVar1 != 0 && func_33(iVar1, 0))
				{
					...
					TASK::TASK_HORSE_ACTION(iVar1, 5, false, 0);
...
bool func_91(bool bParam0, bool bParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
bool func_155(bool bParam0, bool bParam1, var uParam2)
{
	float fVar0;
	float fVar1;
...
bool func_187(var uParam0, vector3 vParam1, bool bParam4)
{
...
bool func_188(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_218(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_92(bVar0, bParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_222(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
...
bool func_267(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
