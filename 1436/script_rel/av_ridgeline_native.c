	...
	if (!bParam1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iParam2 /*14*/]))
		{
			if (!func_104(uParam0->f_20[iParam2 /*14*/], -76381094))
			{
				...
				WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_20[iParam2 /*14*/], joaat("WEAPON_BOW"), 500, false, true, 0, false, 0.5f, 1f, joaat("ADD_REASON_DEFAULT"), true, 0f, false);
...
void func_71(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		TASK::TASK_FLEE_PED(0, Global_35, 1, 524288, -1082130432 /* Float: -1f */, -1, 0);
