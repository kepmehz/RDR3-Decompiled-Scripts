	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], iLocal_12[0], 0, 0, false, true, 0, false, -1f, false);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[1 /*14*/], iLocal_12[1], 0, 0, false, true, 0, false, -1f, false);
		...
		case 1:
			if (func_65(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
				{
					...
					TASK::TASK_FLEE_PED(0, uParam0->f_20[0 /*14*/], 3, 256, -1082130432 /* Float: -1f */, -1, 0);
				...
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					func_64(&(uParam0->f_20[0 /*14*/]), 1, 1);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, uParam0->f_20[1 /*14*/], 0f, 5f, 0f, 2f, 12000, 1036831949 /* Float: 0.1f */, 1, 1, 0, 1, 1, 0);
...
bool func_178(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_195(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
