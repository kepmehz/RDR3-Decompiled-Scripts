...
void func_3()
{
	...
	if (func_11() == 6)
	{
		...
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(bLocal_34, 2361.296f, 1344.457f, 123.1171f, 0f, 0f, 22f, 38f, 52f, 35f);
		VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(bLocal_34, 2326.496f, 1326.393f, 125.5935f, 0f, 0f, 0f, 9f, 7f, 35f);
	...
	switch (iLocal_24)
	{
		...
		case 1:
			if (STREAMING::HAS_MODEL_LOADED(joaat("WAGON02X")))
			{
				...
				VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(bLocal_45, false);
				ENTITY::SET_ENTITY_PROOFS(bLocal_45, 6, true);
				iLocal_24 = 2;
			}
			break;
		case 2:
			VEHICLE::GET_DRAFT_ANIMAL_COUNT(bLocal_45, &uVar0, &iVar1);
			if (iVar1 >= VEHICLE::_0x5B1A26BB18E7D451(joaat("WAGON02X")))
			{
				...
				while (iVar14 < 6)
				{
					iVar15 = VEHICLE::_GET_PED_IN_DRAFT_HARNESS(bLocal_45, iVar14);
				...
				PATHFIND::_ADD_NAVMESH_BLOCKING_VOLUME(bLocal_41, 7);
				iLocal_24 = 3;
			}
			break;
		case 3:
...
void func_29()
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(bLocal_41))
	{
		PATHFIND::_REMOVE_NAVMESH_BLOCKING_VOLUME(bLocal_41);
