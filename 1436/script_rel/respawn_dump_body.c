	...
	while (true)
	{
		...
		switch (iLocal_29)
		{
			case 0:
				...
				{
					STREAMING::LOAD_SCENE_START(Local_32.f_39.f_1, func_14(Local_32.f_39.f_4), 500f, 1);
				}
			...
			case 1:
				if (func_24())
				{
					...
					VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(bLocal_140, Local_32.f_30, 0f, 0f, 0f, 15f, 15f, 20f);
					VOLUME::_ADD_CYLINDER_VOLUME_TO_VOLUME_AGGREGATE(bLocal_140, Local_32.f_34, 0f, 0f, 0f, 15f, 15f, 20f);
			...
			case 6:
				...
				if (func_45(func_44()))
				{
					MISC::SET_WEATHER_TYPE(joaat("OVERCASTDARK"), true, false, false, 0f, true);
				}
...
void func_1(bool bParam0)
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(bLocal_142))
	{
...
bool func_24()
{
	...
	if (!PED::_0x0EE3F0D7FECCC54F() || !VEHICLE::_HAS_FILLED_VEHICLE_POPULATION())
	{
		return false;
	}
...
void func_46()
{
	...
	if ((!PED::IS_PED_INJURED(Local_32.f_98) && !TASK::IS_PED_IN_WRITHE(Local_32.f_98)) && !func_116(Local_32.f_34))
	{
		...
		if (!Local_32.f_59)
		{
			if (Local_32.f_38)
			{
				if (TASK::DOES_SCENARIO_OF_TYPE_EXIST_IN_AREA_HASH(Local_32.f_34, joaat("PROP_HITCHINGPOST"), 1f, false))
				{
					iVar2 = TASK::FIND_SCENARIO_OF_TYPE_HASH(Local_32.f_34, joaat("PROP_HITCHINGPOST"), 1f, 0, false);
...
bool func_251(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	float fVar0;
...
int func_533(int iParam0, bool bParam1)
{
	...
	if (!func_598(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_532(iVar18);
...
struct<18> /*144*/ func_595(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
struct<4> /*32*/ func_596(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_610(923904168, func_613(bParam0), -740156546, 0) };
		}
...
bool func_598(var uParam0, var uParam1, int* iParam2, bool bParam3)
{
	*uParam1 = INVENTORY::_INVENTORY_CREATE_ITEM_COLLECTION_WITH_FILTER(func_534(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return true;
	}
...
struct<4> /*32*/ func_610(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
bool func_611(struct<4> /*32*/ sParam0, int iParam4)
{
	struct<11> /*88*/ sVar0;
...
bool func_614(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4, var uParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
int func_636(struct<4> /*32*/ sParam0, int iParam4, bool bParam5)
{
	int iVar0;
	struct<11> /*88*/ sVar1;
	int iVar15;
	...
	if (iVar15 == joaat("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_651(joaat("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == joaat("CLOTHING"))
	{
		...
		Var45.f_10 = iParam4;
		iVar0 = func_653(joaat("UPDATE"), &Var45, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var63 = { func_640(&Var1) };
		Var63.f_10 = iParam4;
		iVar0 = func_641(joaat("UPDATE"), &Var63, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
{
	return INVENTORY::INVENTORY_GET_CHILDREN_IN_SLOT_COUNT(func_534(bParam2), uParam0, bParam1);
}
...
int func_639(int iParam0, struct<4> /*32*/ sParam1, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
	var uVar4;
