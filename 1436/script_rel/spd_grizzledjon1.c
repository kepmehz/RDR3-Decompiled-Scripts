...
void func_1()
{
	...
	if (VOLUME::DOES_VOLUME_EXIST(bLocal_261))
	{
...
void func_11()
{
	...
	if (!func_8(iLocal_182, 256))
	{
		if (iLocal_175 < 8 && iLocal_175 > 2)
		{
			...
			else if ((iLocal_175 == 6 && func_8(iLocal_182, 65536)) && !ANIMSCENE::IS_ENTITY_PLAYING_ANIM_SCENE(bLocal_255, iLocal_189))
			{
				func_7(&iLocal_182, 256);
			}
		}
...
void func_19()
{
	...
	if ((((((HUD::TEXT_BLOCK_IS_LOADED("SPGJAU") && HUD::TEXT_BLOCK_IS_LOADED("SPGJ")) && STREAMING::HAS_MODEL_LOADED(bLocal_17)) && STREAMING::HAS_MODEL_LOADED(iLocal_18)) && STREAMING::HAS_MODEL_LOADED(iLocal_19)) && (iLocal_176 != 1 || STREAMING::HAS_MODEL_LOADED(iLocal_20))) && PED::_GET_NUM_RESERVED_AMBIENT_PEDS_READY() == 1)
	{
		if (iLocal_176 == 1)
		{
			if (iLocal_279 == 0)
		...
		if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_277))
		{
			switch (iLocal_176)
			{
				...
				case 0:
					if (!TASK::DOES_SCENARIO_POINT_EXIST(iLocal_277))
					{
						iLocal_277 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("SPECIAL_PED_GJ02_STAND_BAR_DRINKING"), -313.1921f, 809.0455f, 117.978f, -170f, 0f, 0, 1);
						TASK::_SET_SCENARIO_POINT_FLAG(iLocal_277, 16, true);
						TASK::_SET_SCENARIO_POINT_FLAG(iLocal_277, 18, true);
						bVar0 = true;
					}
...
void func_20()
{
	if ((func_104(&bLocal_255, bLocal_17, func_103(), 119.5846f, 1, 0, 1) && func_106(&iLocal_257, iLocal_18, func_105(iLocal_18))) && func_106(&iLocal_258, iLocal_19, func_105(iLocal_19)))
	{
		if (func_36(bLocal_255, 0))
		{
			...
			{
				case 1:
					TASK::TASK_USE_SCENARIO_POINT(bLocal_255, iLocal_277, "SP_GJ01_SEAT_CHAIR_TABLE_DRINKING", 0, true, true, 0, false, -1f, false);
					break;
				case 0:
					TASK::TASK_USE_SCENARIO_POINT(bLocal_255, iLocal_277, "SP_GJ02_STAND_BAR_DRINKING", 0, true, true, 0, false, -1f, false);
					break;
			}
			iLocal_177 = 0;
...
void func_25()
{
	...
	PED::_0x406CCF555B04FAD3(bLocal_255, 1, 1f);
	if (!func_8(iLocal_182, 131072))
	{
		...
		iLocal_278 = TASK::CREATE_SCENARIO_POINT_HASH(joaat("WORLD_HUMAN_DRUNK_PASSED_OUT_FLOOR"), -316.4402f, 805.7891f, 116.855f, -170f, 0f, 0, 0);
	...
	else if (!func_8(iLocal_182, 524288))
	{
		...
		if (TASK::GET_SCRIPT_TASK_STATUS(bLocal_255, 713668775, true) == 8 && MISC::GET_GAME_TIMER() >= iLocal_184)
		{
			func_120();
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_255, true);
			TASK::TASK_USE_SCENARIO_POINT(bLocal_255, iLocal_278, 0, -1, true, false, 0, false, -1f, false);
...
void func_27()
{
	...
	if (!PED::IS_PED_FLEEING(bLocal_255))
	{
		...
		TASK::TASK_FLEE_PED(bLocal_255, Global_35, 6, 128, -1082130432 /* Float: -1f */, -1, false);
	}
...
bool func_59(bool bParam0, bool bParam1, var uParam2, int iParam3, int iParam4, float fParam5)
{
	int iVar0;
...
void func_109(bool bParam0, int iParam1)
{
	...
	if (!PED::IS_PED_INJURED(bParam0))
	{
		...
		ENTITY::SET_ENTITY_HEALTH(bParam0, BUILTIN::ROUND((((fVar0 / 100f) * (BUILTIN::TO_FLOAT(PED::GET_PED_MAX_HEALTH(bParam0)) - 100f)) + 100f)), 0);
	}
}
...
bool func_253(var uParam0, vector3 vParam1, bool bParam4)
{
...
bool func_254(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_302(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::IS_PED_ARMED(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_37(bVar0, bParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_306(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
...
bool func_320(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_383(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
