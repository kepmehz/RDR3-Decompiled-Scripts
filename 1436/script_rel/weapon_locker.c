...
struct<4> /*32*/ func_65(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_66(923904168, func_96(bParam0), -740156546, 0) };
		}
...
bool func_102(var uParam0, int iParam1, bool bParam2)
{
	...
	Var22.f_7 = joaat("ADD_REASON_DEFAULT");
...
{
	func_144(iParam0, iParam1, cParam2, Param10);
	iParam0->f_11 = DATABINDING::_DATABINDING_ADD_DATA_STRING(*iParam0, func_120(15), &(Param10.f_10));
	iParam0->f_12 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*iParam0, func_120(21), Param10.f_18);
	iParam0->f_13 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*iParam0, func_120(22), Param10.f_19);
	iParam0->f_14 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(*iParam0, func_120(23), Param10.f_20);
}
...
void func_144(int iParam0, int iParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, struct<10> /*80*/ sParam10)
{
	*iParam0 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(iParam1, &cParam2);
	iParam0->f_1 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(*iParam0, func_120(0), Param10);
	iParam0->f_2 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(*iParam0, func_120(1), Param10.f_1);
	iParam0->f_3 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*iParam0, func_120(2), Param10.f_2);
	iParam0->f_4 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*iParam0, func_120(53), Param10.f_3);
	iParam0->f_5 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*iParam0, func_120(54), Param10.f_4);
	iParam0->f_6 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*iParam0, func_120(56), Param10.f_5);
	iParam0->f_7 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*iParam0, func_120(55), Param10.f_6);
	if (Param10.f_7 == 0)
	{
		Param10.f_7 = joaat("IB_SELECT");
	}
	iParam0->f_8 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*iParam0, func_120(57), Param10.f_7);
	iParam0->f_9 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(*iParam0, func_120(58), Param10.f_8);
	iParam0->f_10 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(*iParam0, func_120(59), Param10.f_9);
}
