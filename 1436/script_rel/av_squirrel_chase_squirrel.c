	...
	switch (iLocal_12)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], iLocal_13[0], 0, 0, false, true, 0, false, -1f, false);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				TASK::TASK_USE_SCENARIO_POINT(uParam0->f_20[1 /*14*/], iLocal_13[1], 0, 0, false, true, 0, false, -1f, false);
		...
		case 1:
			if (func_58(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
				{
					...
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, uParam0->f_20[0 /*14*/], 0f, -1f, 0f, fLocal_9, -1, 1036831949 /* Float: 0.1f */, 1, 1, 0, 0, 1, 0);
					TASK::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, false);
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
					func_57(&(uParam0->f_20[1 /*14*/]), 1, 1);
