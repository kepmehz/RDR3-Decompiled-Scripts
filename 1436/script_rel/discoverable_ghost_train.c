...
bool func_62(var uParam0, float fParam1, float fParam2)
{
	...
	fVar2 = (fVar1 / fParam2);
	uParam0->f_9 = BUILTIN::FLOOR(func_117(0f, fParam1, fVar2));
	if (IntToFloat(uParam0->f_9) < fParam1)
	{
		iVar0 = 0;
		while (iVar0 <= 3)
		{
...
bool func_65(var uParam0, float fParam1, float fParam2)
{
	...
	fVar3 = (fParam2 - fVar1);
	fVar2 = (fVar3 / fParam2);
	uParam0->f_9 = BUILTIN::FLOOR(func_117(fParam1, 200f, fVar2));
	if (IntToFloat(uParam0->f_9) > fParam1)
	{
		iVar0 = 0;
		while (iVar0 <= 3)
...
struct<4> /*32*/ func_212(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_218(923904168, func_217(bParam0), -740156546, 0) };
		}
