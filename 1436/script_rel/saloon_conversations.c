...
bool func_173(bool bParam0, bool bParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
int func_237(int iParam0, bool bParam1)
{
	...
	if (!func_313(&Var0, &iVar18, &iVar19, 0))
	{
		return 0;
	}
	func_236(iVar18);
...
int func_240(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_234("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_315(iParam1, 512) && func_316(Var4.f_4, &uVar19, &Var23, joaat("SLOTID_WEAPON_0"))) && !Var23.f_21)
			{
			}
...
bool func_255(bool bParam0, bool bParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_338(bParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
...
bool func_267(bool bParam0, bool bParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam1))
	{
		...
		if (func_351(bParam0, bParam1, 1, 1) < 4f)
		{
...
struct<18> /*144*/ func_310(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<18> /*144*/ sVar0;
...
struct<4> /*32*/ func_311(bool bParam0)
{
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1223208 = { func_386(923904168, func_385(bParam0), -740156546, 0) };
		}
...
float func_329(bool bParam0, bool bParam1)
{
	return func_351(bParam0, bParam1, 1, 1);
}
...
bool func_338(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_393(bVar0, 0)))
		{
			if (func_395(ENTITY::GET_ENTITY_COORDS(bParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return true;
			}
		}
...
bool func_349(bool bParam0, bool bParam1)
{
	...
	if (func_399(bParam0, 1, 0, 0) != joaat("WEAPON_LASSO"))
	{
		return false;
	}
...
struct<4> /*32*/ func_386(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> /*32*/ sVar0;
...
bool func_397(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_399(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
